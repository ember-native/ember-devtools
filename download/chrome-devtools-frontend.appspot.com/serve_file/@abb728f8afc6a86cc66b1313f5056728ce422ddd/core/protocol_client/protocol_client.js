...
import *as t from '../host/host.js';

class n {
  static patch(i) {
    !function i(o, r) {
      o.url && n.isPlatformPath(o.url, t.Platform.isWin()) && (o.url = e.ParsedURL.ParsedURL.rawPathToUrlString(o.url));
      for (const e of Object.entries(o)) {
        const t = e[0], n = e[1], o = r + '.' + t;
        '.result.result.value' !== o && null !== n && 'object' == typeof n && i(n, o)
      }
    }(i, '')
  }

  static isPlatformPath(e, t) {
    if (t) {
      return /^([a-z]:[\/\\]|\\\\)/i.test(e)
    }
    return !!e.length && '/' === e[0]
...
var i = Object.freeze({ __proto__: null, NodeURL: n });
const o = -32015, r = -32e3, a = -32001, s = e => {
  const [t, n] = e.split('.');
  return [t, n]
}, p = (e, t) => `${e}.${t}`;
...
class l {
  ...
  getOrCreateEventParameterNamesForDomain(e) {
    let t = this.#t.get(e);
    return t || (t = new Map, this.#t.set(e, t)), t
  }

  getOrCreateEventParameterNamesForDomainForTesting(e) {
    return this.getOrCreateEventParameterNamesForDomain(e)
  }
  ...
  static reportProtocolError(e, t) {
    console.error(e + ': ' + JSON.stringify(t))
  }

  static reportProtocolWarning(e, t) {
    console.warn(e + ': ' + JSON.stringify(t))
  }
  ...
  agentPrototype(e) {
    let t = this.agentPrototypes.get(e);
    return t || (t = new y(e), this.agentPrototypes.set(e, t)), t
  }

  registerCommand(e, t, n, i) {
    const [o, r] = s(e);
    this.agentPrototype(o).registerCommand(r, t, n, i), this.#e = !0
  }

  registerEnum(e, t) {
    const [n, i] = s(e);
    globalThis.Protocol[n] || (globalThis.Protocol[n] = {}), globalThis.Protocol[n][i] = t, this.enumMap.set(e, t), this.#e = !0
  }

  registerType(e, t) {
    this.typeMap.set(e, t), this.#e = !0
  }

  registerEvent(e, t) {
    const n = e.split('.')[0];
    this.getOrCreateEventParameterNamesForDomain(n).set(e, t), this.#e = !0
  }
}
...
const c = {
  ...
  sendRawMessage: null,
  suppressRequestErrors: !1,
  onMessageSent: null,
  onMessageReceived: null
}, u = new Set(['CSS.takeComputedStyleUpdates']);
...
class m {
  ...
  constructor(e) {
    this.#n = e, this.#i = 1, this.#o = 0, this.#r = new Set, this.#a = new Map, this.#s = [], c.deprecatedRunAfterPendingDispatches = this.deprecatedRunAfterPendingDispatches.bind(this), c.sendRawMessage = this.sendRawMessageForTesting.bind(this), this.#n.setOnMessage(this.onMessage.bind(this)), this.#n.setOnDisconnect((e => {
      const t = this.#a.get('');
      t && t.target.dispose(e)
    }))
  }

  registerSession(e, t, n) {
    if (n) for (const e of this.#a.values()) if (e.proxyConnection) {
      console.error('Multiple simultaneous proxy connections are currently unsupported');
      break
    }
    this.#a.set(t, { target: e, callbacks: new Map, proxyConnection: n })
  }

  unregisterSession(e) {
    const t = this.#a.get(e);
    if (t) {
      for (const e of t.callbacks.values()) m.dispatchUnregisterSessionError(e);
      this.#a.delete(e)
    }
  }

  getTargetBySessionId(e) {
    const t = this.#a.get(e || '');
  ...
  sendMessage(e, t, n, i, o) {
    const r = this.nextMessageId(), a = { id: r, method: n };
    if (i && (a.params = i), e && (a.sessionId = e), c.dumpProtocol && c.dumpProtocol('frontend: ' + JSON.stringify(a)), c.onMessageSent) {
      const o = JSON.parse(JSON.stringify(i || {}));
      c.onMessageSent({ domain: t, method: n, params: o, id: r, sessionId: e }, this.getTargetBySessionId(e))
    }
    ++this.#o, u.has(n) && this.#r.add(r);
    const s = this.#a.get(e);
    s && (s.callbacks.set(r, { callback: o, method: n }), this.#n.sendRawMessage(JSON.stringify(a)))
  }

  sendRawMessageForTesting(e, t, n, i = '') {
    const o = e.split('.')[0];
    this.sendMessage(i, o, e, t, n || (() => {
    }))
  }

  onMessage(e) {
    if (c.dumpProtocol && c.dumpProtocol('backend: ' + ('string' == typeof e ? e : JSON.stringify(e))), c.onMessageReceived) {
      const t = JSON.parse('string' == typeof e ? e : JSON.stringify(e));
      c.onMessageReceived(t, this.getTargetBySessionId(t.sessionId))
    }
    const t = 'string' == typeof e ? JSON.parse(e) : e;
    let i = !1;
    for (const e of this.#a.values()) e.proxyConnection && (e.proxyConnection.onMessage ? (e.proxyConnection.onMessage(t), i = !0) : l.reportProtocolError('Protocol Error: the session has a proxyConnection with no _onMessage', t));
    const o = t.sessionId || '', r = this.#a.get(o);
    if (r) {
      if (!r.proxyConnection) if (r.target.getNeedsNodeJSPatching() && n.patch(t), void 0 !== t.id) {
        const e = r.callbacks.get(t.id);
        if (r.callbacks.delete(t.id), !e) {
          if (t.error?.code === a) return;
          return void (i || l.reportProtocolError('Protocol Error: the message with wrong id', t))
        }
        e.callback(t.error || null, t.result || null), --this.#o, this.#r.delete(t.id), this.#s.length && !this.hasOutstandingNonLongPollingRequests() && this.deprecatedRunAfterPendingDispatches()
      } else {
        if (void 0 === t.method) return void l.reportProtocolError('Protocol Error: the message without method', t);
        const e = t;
        r.target.dispatch(e)
      }
    } else i || l.reportProtocolError('Protocol Error: the message with wrong session id', t)
  }
  ...
  deprecatedRunAfterPendingDispatches(e) {
    e && this.#s.push(e), window.setTimeout((() => {
      this.hasOutstandingNonLongPollingRequests() ? this.deprecatedRunAfterPendingDispatches() : this.executeAfterPendingDispatches()
    }), 0)
  }
  ...
  static dispatchConnectionError(e, t) {
    const n = { message: `Connection is closed, can't dispatch pending call to ${t}`, code: a, data: null };
    window.setTimeout((() => e(n, null)), 0)
  }

  static dispatchUnregisterSessionError({ callback: e, method: t }) {
    const n = { message: `Session is unregistering, can't dispatch pending call to ${t}`, code: a, data: null };
    window.setTimeout((() => e(n, null)), 0)
  }
}
...
class y {
  ...
  constructor(e) {
    this.replyArgs = {}, this.domain = e, this.metadata = {}
  }

  registerCommand(e, t, n, i) {
    const o = p(this.domain, e);
    this[e] = function (...e) {
      return y.prototype.sendMessageToBackendPromise.call(this, o, t, e)
    }, this.metadata[o] = { parameters: t, description: i, replyArgs: n }, this['invoke_' + e] = function (e = {}) {
      return this.invoke(o, e)
    }, this.replyArgs[o] = n
  }

  prepareParameters(e, t, n, i) {
    const o = {};
    let r = !1;
    for (const a of t) {
      const s = a.name, p = a.type, l = a.optional;
      if (!n.length && !l) return i(`Protocol Error: Invalid number of arguments for method '${e}' call. It must have the following arguments ${JSON.stringify(t)}'.`), null;
      const d = n.shift();
      if (l && void 0 === d) continue;
      if (typeof d !== ('array' === p ? 'object' : p)) return i(`Protocol Error: Invalid type of argument '${s}' for method '${e}' call. It must be '${p}' but it is '${typeof d}'.`), null;
      o[s] = d, r = !0
    }
    return n.length ? (i(`Protocol Error: Extra ${n.length} arguments in a call to method '${e}'.`), null) : r ? o : null
  }

  sendMessageToBackendPromise(e, t, n) {
    let i;
    const s = this.prepareParameters(e, t, n, (function (e) {
      console.error(e), i = e
    }));
    return i ? Promise.resolve(null) : new Promise((t => {
      const n = (n, i) => {
        if (n) return c.suppressRequestErrors || n.code === o || n.code === r || n.code === a || console.error('Request ' + e + ' failed. ' + JSON.stringify(n)), void t(null);
        const s = this.replyArgs[e];
        t(i && s.length ? i[s[0]] : void 0)
      }, i = this.target.router();
      i ? i.sendMessage(this.target.sessionId, this.domain, e, s, n) : m.dispatchConnectionError(n, e)
    }))
  }
  ...
  invoke(e, t) {
    return new Promise((n => {
      const i = (t, i) => {
        t && !c.suppressRequestErrors && t.code !== o && t.code !== r && t.code !== a && console.error('Request ' + e + ' failed. ' + JSON.stringify(t));
        const s = t?.message;
        n({ ...i, getError: () => s })
      }, s = this.target.router();
      s ? s.sendMessage(this.target.sessionId, this.domain, e, t, i) : m.dispatchConnectionError(i, e)
    }))
  }
}
...
class g {
  ...
  addDomainDispatcher(e) {
    this.#l.push(e)
  }

  removeDomainDispatcher(e) {
    const t = this.#l.indexOf(e);
    -1 !== t && this.#l.splice(t, 1)
  }

  dispatch(e, t) {
    if (!this.#l.length) return;
    if (!this.#p.has(t.method)) return void l.reportProtocolWarning(`Protocol Warning: Attempted to dispatch an unspecified event '${t.method}'`, t);
    const n = { ...t.params };
...
var h = Object.freeze({
  ...
  TargetBase: class {
    ...
    constructor(e, t, n, i) {
      if (this.needsNodeJSPatching = e, this.sessionId = n, !t && i || !t && n || i && n) throw new Error('Either connection or sessionId (but not both) must be supplied for a child target');
      let o;
      o = n && t && t.routerInternal ? t.routerInternal : new m(i || d()), this.routerInternal = o, o.registerSession(this, this.sessionId);
      for (const [e, t] of f.agentPrototypes) {
        const n = Object.create(t);
        n.target = this, this.#d.set(e, n)
      }
      for (const [e, t] of f.getEventParameterNames().entries()) this.#l.set(e, new g(t))
    }

    dispatch(e) {
      const [t, n] = s(e.method), i = this.#l.get(t);
      i ? i.dispatch(n, e) : l.reportProtocolError(`Protocol Error: the message ${e.method} is for non-existing domain '${t}'`, e)
    }

    dispose(e) {
      this.routerInternal && (this.routerInternal.unregisterSession(this.sessionId), this.routerInternal = null)
    }
    ...
    getAgent(e) {
      ...
      if (!t) throw new Error('Accessing undefined agent');
      return t
    }
    ...
    registerDispatcher(e, t) {
      const n = this.#l.get(e);
      n && n.addDomainDispatcher(t)
    }

    unregisterDispatcher(e, t) {
      const n = this.#l.get(e);
      n && n.removeDomainDispatcher(t)
    }

    registerAccessibilityDispatcher(e) {
      this.registerDispatcher('Accessibility', e)
    }

    registerAutofillDispatcher(e) {
      this.registerDispatcher('Autofill', e)
    }

    registerAnimationDispatcher(e) {
      this.registerDispatcher('Animation', e)
    }

    registerAuditsDispatcher(e) {
      this.registerDispatcher('Audits', e)
    }

    registerCSSDispatcher(e) {
      this.registerDispatcher('CSS', e)
    }

    registerDatabaseDispatcher(e) {
      this.registerDispatcher('Database', e)
    }

    registerBackgroundServiceDispatcher(e) {
      this.registerDispatcher('BackgroundService', e)
    }

    registerDebuggerDispatcher(e) {
      this.registerDispatcher('Debugger', e)
    }

    unregisterDebuggerDispatcher(e) {
      this.unregisterDispatcher('Debugger', e)
    }

    registerDOMDispatcher(e) {
      this.registerDispatcher('DOM', e)
    }

    registerDOMStorageDispatcher(e) {
      this.registerDispatcher('DOMStorage', e)
    }

    registerFetchDispatcher(e) {
      this.registerDispatcher('Fetch', e)
    }

    registerHeapProfilerDispatcher(e) {
      this.registerDispatcher('HeapProfiler', e)
    }

    registerInspectorDispatcher(e) {
      this.registerDispatcher('Inspector', e)
    }

    registerLayerTreeDispatcher(e) {
      this.registerDispatcher('LayerTree', e)
    }

    registerLogDispatcher(e) {
      this.registerDispatcher('Log', e)
    }

    registerMediaDispatcher(e) {
      this.registerDispatcher('Media', e)
    }

    registerNetworkDispatcher(e) {
      this.registerDispatcher('Network', e)
    }

    registerOverlayDispatcher(e) {
      this.registerDispatcher('Overlay', e)
    }

    registerPageDispatcher(e) {
      this.registerDispatcher('Page', e)
    }

    registerPreloadDispatcher(e) {
      this.registerDispatcher('Preload', e)
    }

    registerProfilerDispatcher(e) {
      this.registerDispatcher('Profiler', e)
    }

    registerRuntimeDispatcher(e) {
      this.registerDispatcher('Runtime', e)
    }

    registerSecurityDispatcher(e) {
      this.registerDispatcher('Security', e)
    }

    registerServiceWorkerDispatcher(e) {
      this.registerDispatcher('ServiceWorker', e)
    }

    registerStorageDispatcher(e) {
      this.registerDispatcher('Storage', e)
    }

    registerTargetDispatcher(e) {
      this.registerDispatcher('Target', e)
    }

    registerTracingDispatcher(e) {
      this.registerDispatcher('Tracing', e)
    }

    registerWebAudioDispatcher(e) {
      this.registerDispatcher('WebAudio', e)
    }

    registerWebAuthnDispatcher(e) {
      this.registerDispatcher('WebAuthn', e)
    }
...
self.Protocol = self.Protocol || {}, function (e) {
  e.registerEnum('Accessibility.AXValueType', {
    Boolean: 'boolean',
    Tristate: 'tristate',
  ...
  }), e.registerEnum('Accessibility.AXValueSourceType', {
    Attribute: 'attribute',
    Implicit: 'implicit',
    Style: 'style',
    Contents: 'contents',
  ...
  }), e.registerEnum('Accessibility.AXValueNativeSourceType', {
    ...
    Title: 'title',
    Other: 'other'
  }), e.registerEnum('Accessibility.AXPropertyName', {
    Busy: 'busy',
    Disabled: 'disabled',
    Editable: 'editable',
    Focusable: 'focusable',
    ...
    Owns: 'owns',
    Url: 'url'
  }), e.registerEvent('Accessibility.loadComplete', ['root']), e.registerEvent('Accessibility.nodesUpdated', ['nodes']), e.registerCommand('Accessibility.disable', [], [], 'Disables the accessibility domain.'), e.registerCommand('Accessibility.enable', [], [], 'Enables the accessibility domain which causes `AXNodeId`s to remain consistent between method calls. This turns on accessibility for the page, which can impact performance until accessibility is disabled.'), e.registerCommand('Accessibility.getPartialAXTree', [{
    name: 'nodeId',
    type: 'number',
    optional: !0,
    ...
    typeRef: null
  }], ['nodes'], 'Fetches the accessibility node and partial accessibility tree for this DOM node, if it exists.'), e.registerCommand('Accessibility.getFullAXTree', [{
    name: 'depth',
    type: 'number',
    optional: !0,
    ...
    type: 'string',
    optional: !0,
    description: 'The frame for whose document the AX tree should be retrieved. If omitted, the root frame is used.',
    typeRef: 'Page.FrameId'
  }], ['nodes'], 'Fetches the entire accessibility tree for the root Document'), e.registerCommand('Accessibility.getRootAXNode', [{
    name: 'frameId',
    type: 'string',
    optional: !0,
    description: 'The frame in whose document the node resides. If omitted, the root frame is used.',
    typeRef: 'Page.FrameId'
  }], ['node'], 'Fetches the root node. Requires `enable()` to have been called previously.'), e.registerCommand('Accessibility.getAXNodeAndAncestors', [{
    name: 'nodeId',
    type: 'number',
    optional: !0,
    ...
    typeRef: 'Runtime.RemoteObjectId'
  }], ['nodes'], 'Fetches a node and all ancestors up to and including the root. Requires `enable()` to have been called previously.'), e.registerCommand('Accessibility.getChildAXNodes', [{
    name: 'id',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Accessibility.AXNodeId'
  }, {
    name: 'frameId',
    type: 'string',
    optional: !0,
    description: 'The frame in whose document the node resides. If omitted, the root frame is used.',
    typeRef: 'Page.FrameId'
  }], ['nodes'], 'Fetches a particular accessibility node by AXNodeId. Requires `enable()` to have been called previously.'), e.registerCommand('Accessibility.queryAXTree', [{
    name: 'nodeId',
    type: 'number',
    optional: !0,
    ...
    typeRef: null
  }]), e.registerType('Accessibility.AXRelatedNode', [{
    ...
    typeRef: null
  }]), e.registerType('Accessibility.AXProperty', [{
    name: 'name',
    type: 'string',
    optional: !1,
    description: 'The name of this property.',
    typeRef: 'Accessibility.AXPropertyName'
  }, {
    name: 'value',
    type: 'object',
    optional: !1,
    ...
    typeRef: 'Accessibility.AXValue'
  }]), e.registerType('Accessibility.AXValue', [{
    name: 'type',
    type: 'string',
    optional: !1,
    description: 'The type of this value.',
    typeRef: 'Accessibility.AXValueType'
  }, {
    name: 'value',
    type: 'any',
    optional: !0,
    ...
    typeRef: 'Accessibility.AXRelatedNode'
  }, {
    name: 'sources',
    type: 'array',
    optional: !0,
    description: 'The sources which contributed to the computation of this property.',
    typeRef: 'Accessibility.AXValueSource'
  }]), e.registerType('Accessibility.AXNode', [{
    name: 'nodeId',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Accessibility.AXProperty'
  }, {
    name: 'role',
    type: 'object',
    optional: !0,
    ...
    typeRef: 'Page.FrameId'
  }]), e.registerEnum('Animation.AnimationType', {
    CSSTransition: 'CSSTransition',
    CSSAnimation: 'CSSAnimation',
    WebAnimation: 'WebAnimation'
  }), e.registerEvent('Animation.animationCanceled', ['id']), e.registerEvent('Animation.animationCreated', ['id']), e.registerEvent('Animation.animationStarted', ['animation']), e.registerEvent('Animation.animationUpdated', ['animation']), e.registerCommand('Animation.disable', [], [], 'Disables animation domain notifications.'), e.registerCommand('Animation.enable', [], [], 'Enables animation domain notifications.'), e.registerCommand('Animation.getCurrentTime', [{
    name: 'id',
    type: 'string',
    optional: !1,
    description: 'Id of animation.',
    typeRef: null
  }], ['currentTime'], 'Returns the current time of the an animation.'), e.registerCommand('Animation.getPlaybackRate', [], ['playbackRate'], 'Gets the playback rate of the document timeline.'), e.registerCommand('Animation.releaseAnimations', [{
    name: 'animations',
    type: 'array',
    optional: !1,
    description: 'List of animation ids to seek.',
    typeRef: 'string'
  }], [], 'Releases a set of animations to no longer be manipulated.'), e.registerCommand('Animation.resolveAnimation', [{
    name: 'animationId',
    type: 'string',
    optional: !1,
    description: 'Animation id.',
    typeRef: null
  }], ['remoteObject'], 'Gets the remote object of the Animation.'), e.registerCommand('Animation.seekAnimations', [{
    name: 'animations',
    type: 'array',
    optional: !1,
    description: 'List of animation ids to seek.',
    ...
    typeRef: null
  }], [], 'Seek a set of animations to a particular time within each animation.'), e.registerCommand('Animation.setPaused', [{
    name: 'animations',
    type: 'array',
    optional: !1,
    ...
    typeRef: null
  }], [], 'Sets the paused state of a set of animations.'), e.registerCommand('Animation.setPlaybackRate', [{
    name: 'playbackRate',
    type: 'number',
    optional: !1,
    description: 'Playback rate for animations on page',
    typeRef: null
  }], [], 'Sets the playback rate of the document timeline.'), e.registerCommand('Animation.setTiming', [{
    name: 'animationId',
    type: 'string',
    optional: !1,
    description: 'Animation id.',
    ...
    typeRef: null
  }], [], 'Sets the timing of an animation node.'), e.registerType('Animation.Animation', [{
    name: 'id',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Animation.AnimationEffect'
  }, {
    name: 'cssId',
    type: 'string',
    optional: !0,
    ...
    typeRef: 'Animation.ViewOrScrollTimeline'
    ...
    typeRef: 'DOM.ScrollOrientation'
  }]), e.registerType('Animation.AnimationEffect', [{
    name: 'delay',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'Animation.KeyframesRule'
  }, {
    name: 'easing',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]), e.registerType('Animation.KeyframesRule', [{
    name: 'name',
    type: 'string',
    optional: !0,
    ...
    typeRef: 'Animation.KeyframeStyle'
  }]), e.registerType('Animation.KeyframeStyle', [{
    name: 'offset',
    type: 'string',
    optional: !1,
    ...
    description: '`AnimationEffect`\'s timing function.',
    typeRef: null
  }]), e.registerEnum('Audits.CookieExclusionReason', {
  ...
  }), e.registerEnum('Audits.CookieWarningReason', {
  ...
  }), e.registerEnum('Audits.CookieOperation', {
    SetCookie: 'SetCookie',
    ReadCookie: 'ReadCookie'
  }), e.registerEnum('Audits.MixedContentResolutionStatus', {
    MixedContentBlocked: 'MixedContentBlocked',
    MixedContentAutomaticallyUpgraded: 'MixedContentAutomaticallyUpgraded',
    MixedContentWarning: 'MixedContentWarning'
  }), e.registerEnum('Audits.MixedContentResourceType', {
    ...
    XSLT: 'XSLT'
  }), e.registerEnum('Audits.BlockedByResponseReason', {
  ...
  }), e.registerEnum('Audits.HeavyAdReason', {
    NetworkTotalLimit: 'NetworkTotalLimit',
    CpuTotalLimit: 'CpuTotalLimit',
    CpuPeakLimit: 'CpuPeakLimit'
  }), e.registerEnum('Audits.ContentSecurityPolicyViolationType', {
  ...
  }), e.registerEnum('Audits.SharedArrayBufferIssueType', {
    TransferIssue: 'TransferIssue',
    CreationIssue: 'CreationIssue'
  }), e.registerEnum('Audits.AttributionReportingIssueType', {
  ...
  }), e.registerEnum('Audits.SharedDictionaryError', {
  ...
  }), e.registerEnum('Audits.GenericIssueErrorType', {
  ...
  }), e.registerEnum('Audits.FederatedAuthUserInfoRequestIssueReason', {
  ...
  }), e.registerEnum('Audits.StyleSheetLoadingIssueReason', {
    LateImportRule: 'LateImportRule',
    RequestFailed: 'RequestFailed'
  }), e.registerEnum('Audits.PropertyRuleIssueReason', {
    InvalidSyntax: 'InvalidSyntax',
    InvalidInitialValue: 'InvalidInitialValue',
    InvalidInherits: 'InvalidInherits',
    InvalidName: 'InvalidName'
  }), e.registerEnum('Audits.InspectorIssueCode', {
  ...
  }), e.registerEvent('Audits.issueAdded', ['issue']), e.registerEnum('Audits.GetEncodedResponseRequestEncoding', {
    Webp: 'webp',
    Jpeg: 'jpeg',
    Png: 'png'
  }), e.registerCommand('Audits.getEncodedResponse', [{
    name: 'requestId',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Audits.GetEncodedResponseRequestEncoding'
  }, {
    name: 'quality',
    type: 'number',
    optional: !0,
    ...
    typeRef: null
  }], ['body', 'originalSize', 'encodedSize'], 'Returns the response body and size if it were re-encoded with the specified settings. Only applies to images.'), e.registerCommand('Audits.disable', [], [], 'Disables issues domain, prevents further issues from being reported to the client.'), e.registerCommand('Audits.enable', [], [], 'Enables issues domain, sends the issues collected so far to the client by means of the `issueAdded` event.'), e.registerCommand('Audits.checkContrast', [{
    name: 'reportAAA',
    type: 'boolean',
    optional: !0,
    description: 'Whether to report WCAG AAA level issues. Default is false.',
    typeRef: null
  }], [], 'Runs the contrast check for the target page. Found issues are reported using Audits.issueAdded event.'), e.registerCommand('Audits.checkFormsIssues', [], ['formIssues'], 'Runs the form issues check for the target page. Found issues are reported using Audits.issueAdded event.'), e.registerType('Audits.AffectedCookie', [{
    name: 'name',
    type: 'string',
    optional: !1,
    description: 'The following three properties uniquely identify a cookie',
    typeRef: null
  }, { name: 'path', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'domain',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }]), e.registerType('Audits.AffectedRequest', [{
    name: 'requestId',
    type: 'string',
    optional: !1,
    ...
    description: '',
    typeRef: 'Page.FrameId'
  }]), e.registerType('Audits.CookieIssueDetails', [{
    name: 'cookie',
    type: 'object',
    optional: !0,
    ...
    optional: !1,
    description: '',
    typeRef: 'Audits.CookieWarningReason'
  }, {
    name: 'cookieExclusionReasons',
    type: 'array',
    optional: !1,
    description: '',
    typeRef: 'Audits.CookieExclusionReason'
  }, {
    name: 'operation',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Audits.CookieOperation'
  }, { name: 'siteForCookies', type: 'string', optional: !0, description: '', typeRef: null }, {
    name: 'cookieUrl',
    type: 'string',
    optional: !0,
    description: '',
    ...
    optional: !0,
    description: '',
    typeRef: 'Audits.AffectedRequest'
  }]), e.registerType('Audits.MixedContentIssueDetails', [{
    name: 'resourceType',
    type: 'string',
    optional: !0,
    ...
    typeRef: 'Audits.MixedContentResourceType'
  }, {
    name: 'resolutionStatus',
    type: 'string',
    optional: !1,
    description: 'The way the mixed content issue is being resolved.',
    typeRef: 'Audits.MixedContentResolutionStatus'
  }, {
    name: 'insecureURL',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Audits.AffectedFrame'
  }]), e.registerType('Audits.BlockedByResponseIssueDetails', [{
    name: 'request',
    type: 'object',
    optional: !1,
    description: '',
    ...
    typeRef: 'Audits.AffectedFrame'
  }]), e.registerType('Audits.SourceCodeLocation', [{
    name: 'scriptId',
    type: 'string',
    optional: !0,
    description: '',
    typeRef: 'Runtime.ScriptId'
  }, { name: 'url', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'lineNumber',
    type: 'number',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }]), e.registerType('Audits.ContentSecurityPolicyIssueDetails', [{
    name: 'blockedURL',
    type: 'string',
    optional: !0,
    ...
    optional: !1,
    description: '',
    typeRef: 'Audits.ContentSecurityPolicyViolationType'
  }, {
    name: 'frameAncestor',
    type: 'object',
    optional: !0,
    ...
    optional: !0,
    description: '',
    typeRef: 'Audits.SourceCodeLocation'
  }, {
    ...
    description: '',
    typeRef: 'DOM.BackendNodeId'
  }]), e.registerType('Audits.SharedArrayBufferIssueDetails', [{
    name: 'sourceCodeLocation',
    type: 'object',
    optional: !1,
    description: '',
    typeRef: 'Audits.SourceCodeLocation'
  }, { name: 'isWarning', type: 'boolean', optional: !1, description: '', typeRef: null }, {
    name: 'type',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Audits.SharedArrayBufferIssueType'
  }]), e.registerType('Audits.LowTextContrastIssueDetails', [{
    name: 'violatingNodeId',
    type: 'number',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }]), e.registerType('Audits.CorsIssueDetails', [{
    name: 'corsErrorStatus',
    type: 'object',
    optional: !1,
    description: '',
    typeRef: 'Network.CorsErrorStatus'
  }, { name: 'isWarning', type: 'boolean', optional: !1, description: '', typeRef: null }, {
    name: 'request',
    type: 'object',
    optional: !1,
    ...
    optional: !0,
    description: '',
    typeRef: 'Network.IPAddressSpace'
  }, {
    name: 'clientSecurityState',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Network.ClientSecurityState'
  }]), e.registerType('Audits.AttributionReportingIssueDetails', [{
    name: 'violationType',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Audits.AttributionReportingIssueType'
  }, {
    name: 'request',
    type: 'object',
    optional: !0,
    ...
    description: '',
    typeRef: null
  }]), e.registerType('Audits.QuirksModeIssueDetails', [{
    ...
    optional: !1,
    description: '',
    typeRef: 'Network.LoaderId'
  }]), e.registerType('Audits.NavigatorUserAgentIssueDetails', [{
    name: 'url',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: 'Audits.SourceCodeLocation'
  }]), e.registerType('Audits.SharedDictionaryIssueDetails', [{
    name: 'sharedDictionaryError',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Audits.SharedDictionaryError'
  }, {
    name: 'request',
    type: 'object',
    optional: !1,
    description: '',
    typeRef: 'Audits.AffectedRequest'
  }]), e.registerType('Audits.GenericIssueDetails', [{
    name: 'errorType',
    type: 'string',
    optional: !1,
    description: 'Issues with the same errorType are aggregated in the frontend.',
    typeRef: 'Audits.GenericIssueErrorType'
  }, {
    name: 'frameId',
    type: 'string',
    optional: !0,
    ...
    description: '',
    typeRef: 'Audits.AffectedRequest'
  }]), e.registerType('Audits.DeprecationIssueDetails', [{
    name: 'affectedFrame',
    type: 'object',
    optional: !0,
    description: '',
    ...
    description: '',
    typeRef: 'string'
  }]), e.registerType('Audits.CookieDeprecationMetadataIssueDetails', [{
    name: 'allowedSites',
    type: 'array',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }, { name: 'isOptOutTopLevel', type: 'boolean', optional: !1, description: '', typeRef: null }, {
    name: 'operation',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Audits.CookieOperation'
  }]), e.registerType('Audits.FederatedAuthRequestIssueDetails', [{
    name: 'federatedAuthRequestIssueReason',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Audits.FederatedAuthRequestIssueReason'
  }]), e.registerType('Audits.FederatedAuthUserInfoRequestIssueDetails', [{
    name: 'federatedAuthUserInfoRequestIssueReason',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Audits.FederatedAuthUserInfoRequestIssueReason'
  }]), e.registerType('Audits.ClientHintIssueDetails', [{
    name: 'sourceCodeLocation',
    type: 'object',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'Audits.ClientHintIssueReason'
  }]), e.registerType('Audits.FailedRequestInfo', [{
    name: 'url',
    type: 'string',
    optional: !1,
    ...
    description: '',
    typeRef: 'Network.RequestId'
  }]), e.registerType('Audits.StylesheetLoadingIssueDetails', [{
    name: 'sourceCodeLocation',
    type: 'object',
    optional: !1,
    ...
    typeRef: 'Audits.StyleSheetLoadingIssueReason'
  }, {
    name: 'failedRequestInfo',
    type: 'object',
    optional: !0,
    description: 'Contains additional info when the failure was due to a request.',
    typeRef: 'Audits.FailedRequestInfo'
  }]), e.registerType('Audits.PropertyRuleIssueDetails', [{
    name: 'sourceCodeLocation',
    type: 'object',
    optional: !1,
    ...
    typeRef: 'Audits.PropertyRuleIssueReason'
  }, {
    name: 'propertyValue',
    type: 'string',
    optional: !0,
    ...
    typeRef: null
  }]), e.registerType('Audits.InspectorIssueDetails', [{
    name: 'cookieIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.CookieIssueDetails'
  }, {
    name: 'mixedContentIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.MixedContentIssueDetails'
  }, {
    name: 'blockedByResponseIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.BlockedByResponseIssueDetails'
  }, {
    name: 'heavyAdIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.HeavyAdIssueDetails'
  }, {
    name: 'contentSecurityPolicyIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.ContentSecurityPolicyIssueDetails'
  }, {
    name: 'sharedArrayBufferIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.SharedArrayBufferIssueDetails'
  }, {
    name: 'lowTextContrastIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.LowTextContrastIssueDetails'
  }, {
    name: 'corsIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.CorsIssueDetails'
  }, {
    name: 'attributionReportingIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.AttributionReportingIssueDetails'
  }, {
    name: 'quirksModeIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.QuirksModeIssueDetails'
  }, {
    name: 'navigatorUserAgentIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.NavigatorUserAgentIssueDetails'
  }, {
    name: 'genericIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.GenericIssueDetails'
  }, {
    name: 'deprecationIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.DeprecationIssueDetails'
  }, {
    name: 'clientHintIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.ClientHintIssueDetails'
  }, {
    name: 'federatedAuthRequestIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.FederatedAuthRequestIssueDetails'
  }, {
    name: 'bounceTrackingIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.BounceTrackingIssueDetails'
  }, {
    name: 'cookieDeprecationMetadataIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.CookieDeprecationMetadataIssueDetails'
  }, {
    name: 'stylesheetLoadingIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.StylesheetLoadingIssueDetails'
  }, {
    name: 'propertyRuleIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.PropertyRuleIssueDetails'
  }, {
    name: 'federatedAuthUserInfoRequestIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.FederatedAuthUserInfoRequestIssueDetails'
  }, {
    name: 'sharedDictionaryIssueDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Audits.SharedDictionaryIssueDetails'
  }]), e.registerType('Audits.InspectorIssue', [{
    name: 'code',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Audits.InspectorIssueCode'
  }, {
    name: 'details',
    type: 'object',
    optional: !1,
    description: '',
    typeRef: 'Audits.InspectorIssueDetails'
  }, {
    name: 'issueId',
    type: 'string',
    optional: !0,
    ...
    typeRef: 'Audits.IssueId'
  }]), e.registerEnum('Extensions.StorageArea', {
    Session: 'session',
    Local: 'local',
    Sync: 'sync',
    Managed: 'managed'
  }), e.registerCommand('Extensions.loadUnpacked', [{
    name: 'path',
    type: 'string',
    optional: !1,
    description: 'Absolute file path.',
    typeRef: null
  }], ['id'], 'Installs an unpacked extension from the filesystem similar to --load-extension CLI flags. Returns extension ID once the extension has been installed. Available if the client is connected using the --remote-debugging-pipe flag and the --enable-unsafe-extension-debugging flag is set.'), e.registerCommand('Extensions.getStorageItems', [{
    name: 'id',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Extensions.StorageArea'
  }, {
    name: 'keys',
    type: 'array',
    optional: !0,
    ...
    typeRef: 'string'
  }], ['data'], 'Gets data from extension storage in the given `storageArea`. If `keys` is specified, these are used to filter the result.'), e.registerCommand('Extensions.removeStorageItems', [{
    name: 'id',
    type: 'string',
    optional: !1,
    description: 'ID of extension.',
    ...
    typeRef: 'string'
  }], [], 'Removes `keys` from extension storage in the given `storageArea`.'), e.registerCommand('Extensions.clearStorageItems', [{
    name: 'id',
    type: 'string',
    optional: !1,
    description: 'ID of extension.',
    ...
    description: 'StorageArea to remove data from.',
    typeRef: 'Extensions.StorageArea'
  }], [], 'Clears extension storage in the given `storageArea`.'), e.registerCommand('Extensions.setStorageItems', [{
    name: 'id',
    type: 'string',
    optional: !1,
    description: 'ID of extension.',
    ...
    typeRef: null
  }], [], 'Sets `values` in extension storage in the given `storageArea`. The provided `values` will be merged with existing values in the storage area.'), e.registerEnum('Autofill.FillingStrategy', {
    AutocompleteAttribute: 'autocompleteAttribute',
    AutofillInferred: 'autofillInferred'
  }), e.registerEvent('Autofill.addressFormFilled', ['filledFields', 'addressUi']),e.registerCommand('Autofill.trigger', [{
    name: 'fieldId',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'Autofill.CreditCard'
  }], [], 'Trigger autofill on a form identified by the fieldId. If the field and related form cannot be autofilled, returns an error.'),e.registerCommand('Autofill.setAddresses', [{
    name: 'addresses',
    type: 'array',
    optional: !1,
    description: '',
    typeRef: 'Autofill.Address'
  }], [], 'Set addresses so that developers can verify their forms implementation.'),e.registerCommand('Autofill.disable', [], [], 'Disables autofill domain notifications.'),e.registerCommand('Autofill.enable', [], [], 'Enables autofill domain notifications.'),e.registerType('Autofill.CreditCard', [{
    name: 'number',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Autofill.AddressField', [{
    name: 'name',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Autofill.AddressFields', [{
    name: 'fields',
    type: 'array',
    optional: !1,
    description: '',
    typeRef: 'Autofill.AddressField'
  }]),e.registerType('Autofill.Address', [{
    name: 'fields',
    type: 'array',
    optional: !1,
    description: 'fields and values defining an address.',
    typeRef: 'Autofill.AddressField'
  }]),e.registerType('Autofill.AddressUI', [{
    name: 'addressFields',
    type: 'array',
    optional: !1,
    description: 'A two dimension array containing the representation of values from an address profile.',
    typeRef: 'Autofill.AddressFields'
  }]),e.registerType('Autofill.FilledField', [{
    name: 'htmlType',
    type: 'string',
    optional: !1,
    description: 'The type of the field, e.g text, password etc.',
    typeRef: null
  }, { name: 'id', type: 'string', optional: !1, description: 'the html id', typeRef: null }, {
    name: 'name',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Autofill.FillingStrategy'
  }, {
    name: 'frameId',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'DOM.BackendNodeId'
  }]),e.registerEnum('BackgroundService.ServiceName', {
  ...
  }),e.registerEvent('BackgroundService.recordingStateChanged', ['isRecording', 'service']),e.registerEvent('BackgroundService.backgroundServiceEventReceived', ['backgroundServiceEvent']),e.registerCommand('BackgroundService.startObserving', [{
    name: 'service',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'BackgroundService.ServiceName'
  }], [], 'Enables event updates for the service.'),e.registerCommand('BackgroundService.stopObserving', [{
    name: 'service',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'BackgroundService.ServiceName'
  }], [], 'Disables event updates for the service.'),e.registerCommand('BackgroundService.setRecording', [{
    name: 'shouldRecord',
    type: 'boolean',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: 'BackgroundService.ServiceName'
  }], [], 'Set the recording state for the service.'),e.registerCommand('BackgroundService.clearEvents', [{
    name: 'service',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'BackgroundService.ServiceName'
  }], [], 'Clears all stored data for the service.'),e.registerType('BackgroundService.EventMetadata', [{
    name: 'key',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }]),e.registerType('BackgroundService.BackgroundServiceEvent', [{
    name: 'timestamp',
    type: 'number',
    optional: !1,
    description: 'Timestamp of the event (in seconds).',
    typeRef: 'Network.TimeSinceEpoch'
  }, {
    name: 'origin',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'ServiceWorker.RegistrationID'
  }, {
    name: 'service',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'BackgroundService.EventMetadata'
  }, {
    name: 'storageKey',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerEnum('Browser.WindowState', {
    Normal: 'normal',
    Minimized: 'minimized',
    Maximized: 'maximized',
    Fullscreen: 'fullscreen'
  }),e.registerEnum('Browser.PermissionType', {
  ...
  }),e.registerEnum('Browser.PermissionSetting', {
    Granted: 'granted',
    Denied: 'denied',
    Prompt: 'prompt'
  }),e.registerEnum('Browser.BrowserCommandId', {
    OpenTabSearch: 'openTabSearch',
    CloseTabSearch: 'closeTabSearch'
  }),e.registerEvent('Browser.downloadWillBegin', ['frameId', 'guid', 'url', 'suggestedFilename']),e.registerEnum('Browser.DownloadProgressEventState', {
    InProgress: 'inProgress',
    Completed: 'completed',
    Canceled: 'canceled'
  }),e.registerEvent('Browser.downloadProgress', ['guid', 'totalBytes', 'receivedBytes', 'state']),e.registerCommand('Browser.setPermission', [{
    name: 'permission',
    type: 'object',
    optional: !1,
    description: 'Descriptor of permission to override.',
    typeRef: 'Browser.PermissionDescriptor'
  }, {
    name: 'setting',
    type: 'string',
    optional: !1,
    description: 'Setting of the permission.',
    typeRef: 'Browser.PermissionSetting'
  }, {
    name: 'origin',
    type: 'string',
    optional: !0,
    ...
    typeRef: 'Browser.BrowserContextID'
  }], [], 'Set permission settings for given origin.'),e.registerCommand('Browser.grantPermissions', [{
    name: 'permissions',
    type: 'array',
    optional: !1,
    description: '',
    typeRef: 'Browser.PermissionType'
  }, {
    name: 'origin',
    type: 'string',
    optional: !0,
    ...
    typeRef: 'Browser.BrowserContextID'
  }], [], 'Grant specific permissions to the given origin and reject all others.'),e.registerCommand('Browser.resetPermissions', [{
    name: 'browserContextId',
    type: 'string',
    optional: !0,
    description: 'BrowserContext to reset permissions. When omitted, default browser context is used.',
    typeRef: 'Browser.BrowserContextID'
  }], [], 'Reset all permission management for all origins.'),e.registerEnum('Browser.SetDownloadBehaviorRequestBehavior', {
    Deny: 'deny',
    Allow: 'allow',
    AllowAndName: 'allowAndName',
    Default: 'default'
  }),e.registerCommand('Browser.setDownloadBehavior', [{
    name: 'behavior',
    type: 'string',
    optional: !1,
    description: 'Whether to allow all or deny all download requests, or use default Chrome behavior if available (otherwise deny). |allowAndName| allows download and names files according to their download guids.',
    typeRef: 'Browser.SetDownloadBehaviorRequestBehavior'
  }, {
    name: 'browserContextId',
    type: 'string',
    optional: !0,
    ...
    type: 'string',
    optional: !0,
    description: 'The default path to save downloaded files to. This is required if behavior is set to \'allow\' or \'allowAndName\'.',
    typeRef: null
  }, {
    name: 'eventsEnabled',
    type: 'boolean',
    ...
    typeRef: null
  }], [], 'Set the behavior when downloading a file.'),e.registerCommand('Browser.cancelDownload', [{
    name: 'guid',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Browser.BrowserContextID'
  }], [], 'Cancel a download if in progress'),e.registerCommand('Browser.close', [], [], 'Close browser gracefully.'),e.registerCommand('Browser.crash', [], [], 'Crashes browser on the main thread.'),e.registerCommand('Browser.crashGpuProcess', [], [], 'Crashes GPU process.'),e.registerCommand('Browser.getVersion', [], ['protocolVersion', 'product', 'revision', 'userAgent', 'jsVersion'], 'Returns version information.'),e.registerCommand('Browser.getBrowserCommandLine', [], ['arguments'], 'Returns the command line switches for the browser process if, and only if --enable-automation is on the commandline.'),e.registerCommand('Browser.getHistograms', [{
    name: 'query',
    type: 'string',
    optional: !0,
    description: 'Requested substring in name. Only histograms which have query as a substring in their name are extracted. An empty or absent query returns all histograms.',
    typeRef: null
  }, {
    name: 'delta',
    type: 'boolean',
    ...
    typeRef: null
  }], ['histograms'], 'Get Chrome histograms.'),e.registerCommand('Browser.getHistogram', [{
    name: 'name',
    type: 'string',
    optional: !1,
    ...
    description: 'If true, retrieve delta since last delta call.',
    typeRef: null
  }], ['histogram'], 'Get a Chrome histogram by name.'),e.registerCommand('Browser.getWindowBounds', [{
    name: 'windowId',
    type: 'number',
    optional: !1,
    description: 'Browser window id.',
    typeRef: 'Browser.WindowID'
  }], ['bounds'], 'Get position and size of the browser window.'),e.registerCommand('Browser.getWindowForTarget', [{
    name: 'targetId',
    type: 'string',
    optional: !0,
    description: 'Devtools agent host id. If called as a part of the session, associated targetId is used.',
    typeRef: 'Target.TargetID'
  }], ['windowId', 'bounds'], 'Get the browser window that contains the devtools target.'),e.registerCommand('Browser.setWindowBounds', [{
    name: 'windowId',
    type: 'number',
    optional: !1,
    description: 'Browser window id.',
    ...
    typeRef: 'Browser.Bounds'
  }], [], 'Set position and/or size of the browser window.'),e.registerCommand('Browser.setDockTile', [{
    name: 'badgeLabel',
    type: 'string',
    optional: !0,
    description: '',
    ...
    typeRef: null
  }], [], 'Set dock tile details, platform-specific.'),e.registerCommand('Browser.executeBrowserCommand', [{
    name: 'commandId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Browser.BrowserCommandId'
  }], [], 'Invoke custom browser commands used by telemetry.'),e.registerCommand('Browser.addPrivacySandboxEnrollmentOverride', [{
    name: 'url',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], [], 'Allows a site to use privacy sandbox features that require enrollment without the site actually being enrolled. Only supported on page targets.'),e.registerType('Browser.Bounds', [{
    name: 'left',
    type: 'number',
    optional: !0,
    ...
    typeRef: 'Browser.WindowState'
  }]),e.registerType('Browser.PermissionDescriptor', [{
    name: 'name',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Browser.Histogram', [{
    name: 'name',
    type: 'string',
    optional: !1,
    description: 'Name.',
    ...
    optional: !1,
    description: 'Buckets.',
    typeRef: 'Browser.Bucket'
  }]),e.registerEnum('CSS.StyleSheetOrigin', {
    Injected: 'injected',
    UserAgent: 'user-agent',
    Inspector: 'inspector',
    Regular: 'regular'
  }),e.registerEnum('CSS.CSSRuleType', {
    MediaRule: 'MediaRule',
    ...
    ScopeRule: 'ScopeRule',
    StyleRule: 'StyleRule'
  }),e.registerEnum('CSS.CSSMediaSource', {
    MediaRule: 'mediaRule',
    ImportRule: 'importRule',
    LinkedSheet: 'linkedSheet',
    InlineSheet: 'inlineSheet'
  }),e.registerEvent('CSS.fontsUpdated', ['font']),e.registerEvent('CSS.mediaQueryResultChanged', []),e.registerEvent('CSS.styleSheetAdded', ['header']),e.registerEvent('CSS.styleSheetChanged', ['styleSheetId']),e.registerEvent('CSS.styleSheetRemoved', ['styleSheetId']),e.registerCommand('CSS.addRule', [{
    name: 'styleSheetId',
    type: 'string',
    optional: !1,
    description: 'The css style sheet identifier where a new rule should be inserted.',
    typeRef: 'CSS.StyleSheetId'
  }, {
    name: 'ruleText',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'CSS.SourceRange'
  }, {
    name: 'nodeForPropertySyntaxValidation',
    type: 'number',
    optional: !0,
    description: 'NodeId for the DOM node in whose context custom property declarations for registered properties should be validated. If omitted, declarations in the new rule text can only be validated statically, which may produce incorrect results if the declaration contains a var() for example.',
    typeRef: 'DOM.NodeId'
  }], ['rule'], 'Inserts a new rule with the given `ruleText` in a stylesheet with given `styleSheetId`, at the position specified by `location`.'),e.registerCommand('CSS.collectClassNames', [{
    name: 'styleSheetId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'CSS.StyleSheetId'
  }], ['classNames'], 'Returns all class names from specified stylesheet.'),e.registerCommand('CSS.createStyleSheet', [{
    name: 'frameId',
    type: 'string',
    optional: !1,
    description: 'Identifier of the frame where \\"via-inspector\\" stylesheet should be created.',
    typeRef: 'Page.FrameId'
  }], ['styleSheetId'], 'Creates a new special "via-inspector" stylesheet in the frame with given `frameId`.'),e.registerCommand('CSS.disable', [], [], 'Disables the CSS agent for the given page.'),e.registerCommand('CSS.enable', [], [], 'Enables the CSS agent for the given page. Clients should not assume that the CSS agent has been enabled until the result of this command is received.'),e.registerCommand('CSS.forcePseudoState', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'string'
  }], [], 'Ensures that the given node will have specified pseudo-classes whenever its style is computed by the browser.'),e.registerCommand('CSS.getBackgroundColors', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    description: 'Id of the node to get background colors for.',
    typeRef: 'DOM.NodeId'
  }], ['backgroundColors', 'computedFontSize', 'computedFontWeight'], ''),e.registerCommand('CSS.getComputedStyleForNode', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    description: '',
    typeRef: 'DOM.NodeId'
  }], ['computedStyle'], 'Returns the computed style for a DOM node identified by `nodeId`.'),e.registerCommand('CSS.getInlineStylesForNode', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    description: '',
    typeRef: 'DOM.NodeId'
  }], ['inlineStyle', 'attributesStyle'], 'Returns the styles defined inline (explicitly in the "style" attribute and implicitly, using DOM attributes) for a DOM node identified by `nodeId`.'),e.registerCommand('CSS.getMatchedStylesForNode', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    description: '',
    typeRef: 'DOM.NodeId'
  }], ['inlineStyle', 'attributesStyle', 'matchedCSSRules', 'pseudoElements', 'inherited', 'inheritedPseudoElements', 'cssKeyframesRules', 'cssPositionTryRules', 'activePositionFallbackIndex', 'cssPropertyRules', 'cssPropertyRegistrations', 'cssFontPaletteValuesRule', 'parentLayoutNodeId'], 'Returns requested styles for a DOM node identified by `nodeId`.'),e.registerCommand('CSS.getMediaQueries', [], ['medias'], 'Returns all media queries parsed by the rendering engine.'),e.registerCommand('CSS.getPlatformFontsForNode', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    description: '',
    typeRef: 'DOM.NodeId'
  }], ['fonts'], 'Requests information about platform fonts which we used to render child TextNodes in the given node.'),e.registerCommand('CSS.getStyleSheetText', [{
    name: 'styleSheetId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'CSS.StyleSheetId'
  }], ['text'], 'Returns the current textual content for a stylesheet.'),e.registerCommand('CSS.getLayersForNode', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    description: '',
    typeRef: 'DOM.NodeId'
  }], ['rootLayer'], 'Returns all layers parsed by the rendering engine for the tree scope of a node. Given a DOM element identified by nodeId, getLayersForNode returns the root layer for the nearest ancestor document or shadow root. The layer root contains the full layer tree for the tree scope and their ordering.'),e.registerCommand('CSS.getLocationForSelector', [{
    name: 'styleSheetId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], ['ranges'], 'Given a CSS selector text and a style sheet ID, getLocationForSelector returns an array of locations of the CSS selector in the style sheet.'),e.registerCommand('CSS.trackComputedStyleUpdates', [{
    name: 'propertiesToTrack',
    type: 'array',
    optional: !1,
    description: '',
    typeRef: 'CSS.CSSComputedStyleProperty'
    ...
    typeRef: 'DOM.NodeId'
  }, { name: 'propertyName', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'value',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], [], 'Find a rule with the given active property for the given node and set the new value for this property'),e.registerCommand('CSS.setPropertyRulePropertyName', [{
    name: 'styleSheetId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], ['propertyName'], 'Modifies the property rule property name.'),e.registerCommand('CSS.setKeyframeKey', [{
    name: 'styleSheetId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'CSS.StyleSheetId'
  }, { name: 'range', type: 'object', optional: !1, description: '', typeRef: 'CSS.SourceRange' }, {
    name: 'keyText',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], ['keyText'], 'Modifies the keyframe rule key text.'),e.registerCommand('CSS.setMediaText', [{
    name: 'styleSheetId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], ['media'], 'Modifies the rule selector.'),e.registerCommand('CSS.setContainerQueryText', [{
    name: 'styleSheetId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], ['containerQuery'], 'Modifies the expression of a container query.'),e.registerCommand('CSS.setSupportsText', [{
    name: 'styleSheetId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], ['supports'], 'Modifies the expression of a supports at-rule.'),e.registerCommand('CSS.setScopeText', [{
    name: 'styleSheetId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], ['scope'], 'Modifies the expression of a scope at-rule.'),e.registerCommand('CSS.setRuleSelector', [{
    name: 'styleSheetId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], ['selectorList'], 'Modifies the rule selector.'),e.registerCommand('CSS.setStyleSheetText', [{
    name: 'styleSheetId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], ['sourceMapURL'], 'Sets the new stylesheet text.'),e.registerCommand('CSS.setStyleTexts', [{
    name: 'edits',
    type: 'array',
    optional: !1,
    description: '',
    typeRef: 'CSS.StyleDeclarationEdit'
  }, {
    name: 'nodeForPropertySyntaxValidation',
    type: 'number',
    optional: !0,
    description: 'NodeId for the DOM node in whose context custom property declarations for registered properties should be validated. If omitted, declarations in the new rule text can only be validated statically, which may produce incorrect results if the declaration contains a var() for example.',
    typeRef: 'DOM.NodeId'
  }], ['styles'], 'Applies specified style edits one after another in the given order.'),e.registerCommand('CSS.startRuleUsageTracking', [], [], 'Enables the selector recording.'),e.registerCommand('CSS.stopRuleUsageTracking', [], ['ruleUsage'], 'Stop tracking rule usage and return the list of rules that were used since last call to `takeCoverageDelta` (or since start of coverage instrumentation).'),e.registerCommand('CSS.takeCoverageDelta', [], ['coverage', 'timestamp'], 'Obtain list of rules that became used since last call to this method (or since start of coverage instrumentation).'),e.registerCommand('CSS.setLocalFontsEnabled', [{
    name: 'enabled',
    type: 'boolean',
    optional: !1,
    description: 'Whether rendering of local fonts is enabled.',
    typeRef: null
  }], [], 'Enables/disables rendering of local CSS fonts (enabled by default).'),e.registerType('CSS.PseudoElementMatches', [{
    name: 'pseudoType',
    type: 'string',
    optional: !1,
    description: 'Pseudo element type.',
    typeRef: 'DOM.PseudoType'
  }, {
    ...
    typeRef: 'CSS.RuleMatch'
  }]),e.registerType('CSS.InheritedStyleEntry', [{
    name: 'inlineStyle',
    type: 'object',
    optional: !0,
    ...
    typeRef: 'CSS.RuleMatch'
  }]),e.registerType('CSS.InheritedPseudoElementMatches', [{
    name: 'pseudoElements',
    type: 'array',
    optional: !1,
    description: 'Matches of pseudo styles from the pseudos of an ancestor node.',
    typeRef: 'CSS.PseudoElementMatches'
  }]),e.registerType('CSS.RuleMatch', [{
    name: 'rule',
    type: 'object',
    optional: !1,
    ...
    typeRef: 'CSS.Specificity'
  }]),e.registerType('CSS.Specificity', [{
    name: 'a',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('CSS.CSSStyleSheetHeader', [{
    name: 'styleSheetId',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('CSS.SourceRange', [{
    name: 'startLine',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('CSS.ShorthandEntry', [{
    name: 'name',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('CSS.CSSComputedStyleProperty', [{
    name: 'name',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'CSS.SourceRange'
  }]),e.registerType('CSS.CSSProperty', [{
    name: 'name',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'CSS.MediaQuery'
  }]),e.registerType('CSS.MediaQuery', [{
    name: 'expressions',
    type: 'array',
    optional: !1,
    description: 'Array of media query expressions.',
    typeRef: 'CSS.MediaQueryExpression'
  }, {
    name: 'active',
    type: 'boolean',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('CSS.CSSContainerQuery', [{
    name: 'text',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'DOM.PhysicalAxes'
  }, {
    name: 'logicalAxes',
    type: 'string',
    optional: !0,
    description: 'Optional logical axes queried for the container.',
    typeRef: 'DOM.LogicalAxes'
  }]),e.registerType('CSS.CSSSupports', [{
    name: 'text',
    type: 'string',
    optional: !1,
    ...
    description: 'Identifier of the stylesheet containing this object (if exists).',
    typeRef: 'CSS.StyleSheetId'
  }]),e.registerType('CSS.CSSLayerData', [{
    name: 'name',
    type: 'string',
    optional: !1,
    description: 'Layer name.',
    ...
    typeRef: null
  }]),e.registerType('CSS.PlatformFontUsage', [{
    name: 'familyName',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('CSS.FontVariationAxis', [{
    name: 'tag',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'CSS.FontVariationAxis'
  }]),e.registerType('CSS.CSSTryRule', [{
    name: 'styleSheetId',
    type: 'string',
    optional: !0,
    description: 'The css style sheet identifier (absent for user agent stylesheet and user-specified stylesheet rules) this rule came from.',
    ...
    description: 'Associated style declaration.',
    typeRef: 'CSS.CSSStyle'
  }]),e.registerType('CSS.CSSPositionTryRule', [{
    name: 'name',
    type: 'object',
    optional: !1,
    ...
    description: '',
    typeRef: null
  }]),e.registerType('CSS.CSSKeyframesRule', [{
    name: 'animationName',
    type: 'object',
    optional: !1,
    ...
    typeRef: 'CSS.CSSKeyframeRule'
  }]),e.registerType('CSS.CSSPropertyRegistration', [{
    name: 'propertyName',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }, { name: 'initialValue', type: 'object', optional: !0, description: '', typeRef: 'CSS.Value' }, {
    name: 'inherits',
    type: 'boolean',
    optional: !1,
    description: '',
    ...
    description: 'Associated style declaration.',
    typeRef: 'CSS.CSSStyle'
  }]),e.registerType('CSS.CSSPropertyRule', [{
    name: 'styleSheetId',
    type: 'string',
    optional: !0,
    description: 'The css style sheet identifier (absent for user agent stylesheet and user-specified stylesheet rules) this rule came from.',
    ...
    description: 'Associated style declaration.',
    typeRef: 'CSS.CSSStyle'
  }]),e.registerType('CSS.CSSKeyframeRule', [{
    name: 'styleSheetId',
    type: 'string',
    optional: !0,
    description: 'The css style sheet identifier (absent for user agent stylesheet and user-specified stylesheet rules) this rule came from.',
    ...
    description: 'Associated style declaration.',
    typeRef: 'CSS.CSSStyle'
  }]),e.registerType('CSS.StyleDeclarationEdit', [{
    name: 'styleSheetId',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerEnum('CacheStorage.CachedResponseType', {
    Basic: 'basic',
    Cors: 'cors',
    Default: 'default',
    Error: 'error',
  ...
  }),e.registerCommand('CacheStorage.deleteCache', [{
    name: 'cacheId',
    type: 'string',
    optional: !1,
    description: 'Id of cache for deletion.',
    typeRef: 'CacheStorage.CacheId'
  }], [], 'Deletes a cache.'),e.registerCommand('CacheStorage.deleteEntry', [{
    name: 'cacheId',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }], [], 'Deletes a cache entry.'),e.registerCommand('CacheStorage.requestCacheNames', [{
    name: 'securityOrigin',
    type: 'string',
    optional: !0,
    description: 'At least and at most one of securityOrigin, storageKey, storageBucket must be specified. Security origin.',
    typeRef: null
  }, {
    name: 'storageKey',
    type: 'string',
    ...
    typeRef: 'Storage.StorageBucket'
  }], ['caches'], 'Requests cache names.'),e.registerCommand('CacheStorage.requestCachedResponse', [{
    name: 'cacheId',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'CacheStorage.Header'
  }], ['response'], 'Fetches cache entry.'),e.registerCommand('CacheStorage.requestEntries', [{
    name: 'cacheId',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }], ['cacheDataEntries', 'returnCount'], 'Requests data from cache.'),e.registerType('CacheStorage.DataEntry', [{
    name: 'requestURL',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'CacheStorage.CachedResponseType'
  }, {
    ...
    typeRef: 'CacheStorage.Header'
  }]),e.registerType('CacheStorage.Cache', [{
    name: 'cacheId',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('CacheStorage.Header', [{
    name: 'name',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }]),e.registerType('CacheStorage.CachedResponse', [{
    name: 'body',
    type: 'string',
    optional: !1,
    description: 'Entry content, base64-encoded.',
    typeRef: null
  }]),e.registerEvent('Cast.sinksUpdated', ['sinks']),e.registerEvent('Cast.issueUpdated', ['issueMessage']),e.registerCommand('Cast.enable', [{
    name: 'presentationUrl',
    type: 'string',
    optional: !0,
    description: '',
    typeRef: null
  }], [], 'Starts observing for sinks that can be used for tab mirroring, and if set, sinks compatible with |presentationUrl| as well. When sinks are found, a |sinksUpdated| event is fired. Also starts observing for issue messages. When an issue is added or removed, an |issueUpdated| event is fired.'),e.registerCommand('Cast.disable', [], [], 'Stops observing for sinks and issues.'),e.registerCommand('Cast.setSinkToUse', [{
    name: 'sinkName',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], [], 'Sets a sink to be used when the web page requests the browser to choose a sink via Presentation API, Remote Playback API, or Cast SDK.'),e.registerCommand('Cast.startDesktopMirroring', [{
    name: 'sinkName',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], [], 'Starts mirroring the tab to the sink.'),e.registerCommand('Cast.stopCasting', [{
    name: 'sinkName',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], [], 'Stops the active Cast session on the sink.'),e.registerType('Cast.Sink', [{
    name: 'name',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }, { name: 'id', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'session',
    type: 'string',
    optional: !0,
    description: 'Text describing the current session. Present only if there is an active session on the sink.',
    typeRef: null
  }]),e.registerEnum('DOM.PseudoType', {
    ...
    type: 'number',
    optional: !0,
    description: 'Drop the copy before this node (if absent, the copy becomes the last child of `targetNodeId`).',
    typeRef: 'DOM.NodeId'
  }], ['nodeId'], 'Creates a deep copy of the specified node and places it into the target container before the given anchor.'),e.registerCommand('DOM.describeNode', [{
    name: 'nodeId',
    type: 'number',
    optional: !0,
    ...
    typeRef: null
  }], ['node'], 'Describes node given its id, does not require domain to be enabled. Does not start tracking any objects, can be used for automation.'),e.registerCommand('DOM.scrollIntoViewIfNeeded', [{
    name: 'nodeId',
    type: 'number',
    optional: !0,
    description: 'Identifier of the node.',
    ...
    type: 'object',
    optional: !0,
    description: 'The rect to be scrolled into view, relative to the node\'s border box, in CSS pixels. When omitted, center of the node will be used, similar to Element.scrollIntoView.',
    typeRef: 'DOM.Rect'
  }], [], 'Scrolls the specified rect of the given node into view if not already visible. Note: exactly one between nodeId, backendNodeId and objectId should be passed to identify the node.'),e.registerCommand('DOM.disable', [], [], 'Disables DOM agent for the given page.'),e.registerCommand('DOM.discardSearchResults', [{
    name: 'searchId',
    type: 'string',
    optional: !1,
    description: 'Unique search session identifier.',
    typeRef: null
  }], [], 'Discards search results from the session with the given id. `getSearchResults` should no longer be called for that search.'),e.registerEnum('DOM.EnableRequestIncludeWhitespace', {
    None: 'none',
    All: 'all'
  }),e.registerCommand('DOM.enable', [{
    name: 'includeWhitespace',
    type: 'string',
    optional: !0,
    description: 'Whether to include whitespaces in the children array of returned Nodes.',
    typeRef: 'DOM.EnableRequestIncludeWhitespace'
  }], [], 'Enables DOM agent for the given page.'),e.registerCommand('DOM.focus', [{
    name: 'nodeId',
    type: 'number',
    optional: !0,
    description: 'Identifier of the node.',
    ...
    description: 'JavaScript object id of the node wrapper.',
    typeRef: 'Runtime.RemoteObjectId'
  }], [], 'Focuses the given element.'),e.registerCommand('DOM.getAttributes', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    description: 'Id of the node to retrieve attributes for.',
    typeRef: 'DOM.NodeId'
  }], ['attributes'], 'Returns attributes for the specified node.'),e.registerCommand('DOM.getBoxModel', [{
    name: 'nodeId',
    type: 'number',
    optional: !0,
    description: 'Identifier of the node.',
    ...
    description: 'JavaScript object id of the node wrapper.',
    typeRef: 'Runtime.RemoteObjectId'
  }], ['model'], 'Returns boxes for the given node.'),e.registerCommand('DOM.getContentQuads', [{
    name: 'nodeId',
    type: 'number',
    optional: !0,
    description: 'Identifier of the node.',
    ...
    description: 'JavaScript object id of the node wrapper.',
    typeRef: 'Runtime.RemoteObjectId'
  }], ['quads'], 'Returns quads that describe node position on the page. This method might return multiple quads for inline nodes.'),e.registerCommand('DOM.getDocument', [{
    name: 'depth',
    type: 'number',
    optional: !0,
    description: 'The maximum depth at which children should be retrieved, defaults to 1. Use -1 for the entire subtree or provide an integer larger than 0.',
    ...
    description: 'Whether or not iframes and shadow roots should be traversed when returning the subtree (default is false).',
    typeRef: null
  }], ['root'], 'Returns the root DOM node (and optionally the subtree) to the caller. Implicitly enables the DOM domain events for the current target.'),e.registerCommand('DOM.getFlattenedDocument', [{
    name: 'depth',
    type: 'number',
    optional: !0,
    description: 'The maximum depth at which children should be retrieved, defaults to 1. Use -1 for the entire subtree or provide an integer larger than 0.',
    ...
    description: 'Whether or not iframes and shadow roots should be traversed when returning the subtree (default is false).',
    typeRef: null
  }], ['nodes'], 'Returns the root DOM node (and optionally the subtree) to the caller. Deprecated, as it is not designed to work well with the rest of the DOM agent. Use DOMSnapshot.captureSnapshot instead.'),e.registerCommand('DOM.getNodesForSubtreeByStyle', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'DOM.CSSComputedStyleProperty'
  }, {
    name: 'pierce',
    type: 'boolean',
    optional: !0,
    description: 'Whether or not iframes and shadow roots in the same target should be traversed when returning the results (default is false).',
    typeRef: null
  }], ['nodeIds'], 'Finds nodes with a given computed style in a subtree.'),e.registerCommand('DOM.getNodeForLocation', [{
    name: 'x',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }], ['backendNodeId', 'frameId', 'nodeId'], 'Returns node id at given location. Depending on whether DOM domain is enabled, nodeId is either returned or not.'),e.registerCommand('DOM.getOuterHTML', [{
    name: 'nodeId',
    type: 'number',
    optional: !0,
    description: 'Identifier of the node.',
    ...
    description: 'JavaScript object id of the node wrapper.',
    typeRef: 'Runtime.RemoteObjectId'
  }], ['outerHTML'], 'Returns node\'s HTML markup.'),e.registerCommand('DOM.getRelayoutBoundary', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    description: 'Id of the node.',
    typeRef: 'DOM.NodeId'
  }], ['nodeId'], 'Returns the id of the nearest ancestor that is a relayout boundary.'),e.registerCommand('DOM.getSearchResults', [{
    name: 'searchId',
    type: 'string',
    optional: !1,
    description: 'Unique search session identifier.',
    ...
    typeRef: 'DOM.NodeId'
  }], ['nodeId'], 'Moves node into the new container, places it before the given anchor.'),e.registerCommand('DOM.performSearch', [{
    name: 'query',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }], ['searchId', 'resultCount'], 'Searches for a given string in the DOM tree. Use `getSearchResults` to access search results or `cancelSearch` to end this search session.'),e.registerCommand('DOM.pushNodeByPathToFrontend', [{
    name: 'path',
    type: 'string',
    optional: !1,
    description: 'Path to node in the proprietary format.',
    typeRef: null
  }], ['nodeId'], 'Requests that the node is sent to the caller given its path. // FIXME, use XPath'),e.registerCommand('DOM.pushNodesByBackendIdsToFrontend', [{
    name: 'backendNodeIds',
    type: 'array',
    optional: !1,
    description: 'The array of backend node ids.',
    typeRef: 'DOM.BackendNodeId'
  }], ['nodeIds'], 'Requests that a batch of nodes is sent to the caller given their backend node ids.'),e.registerCommand('DOM.querySelector', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }], ['nodeId'], 'Executes `querySelector` on a given node.'),e.registerCommand('DOM.querySelectorAll', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    description: 'Id of the node to query upon.',
    ...
    typeRef: 'DOM.GetElementByRelationRequestRelation'
  }], ['nodeId'], 'Returns the NodeId of the matched element according to certain relations.'),e.registerCommand('DOM.redo', [], [], 'Re-does the last undone action.'),e.registerCommand('DOM.removeAttribute', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }], [], 'Removes attribute with given name from an element with given id.'),e.registerCommand('DOM.removeNode', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    description: 'Id of the node to remove.',
    typeRef: 'DOM.NodeId'
  }], [], 'Removes node with given id.'),e.registerCommand('DOM.requestChildNodes', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }], [], 'Requests that children of the node with given id are returned to the caller in form of `setChildNodes` events where not only immediate children are retrieved, but all children down to the specified depth.'),e.registerCommand('DOM.requestNode', [{
    name: 'objectId',
    type: 'string',
    optional: !1,
    description: 'JavaScript object id to convert into node.',
    typeRef: 'Runtime.RemoteObjectId'
  }], ['nodeId'], 'Requests that the node is sent to the caller given the JavaScript node object reference. All nodes that form the path from the node to the root are also sent to the client as a series of `setChildNodes` notifications.'),e.registerCommand('DOM.resolveNode', [{
    name: 'nodeId',
    type: 'number',
    optional: !0,
  ...
  }], ['object'], 'Resolves the JavaScript node object for a given NodeId or BackendNodeId.'),e.registerCommand('DOM.setAttributeValue', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    description: 'Id of the element to set attribute for.',
    typeRef: 'DOM.NodeId'
  }, { name: 'name', type: 'string', optional: !1, description: 'Attribute name.', typeRef: null }, {
    name: 'value',
    type: 'string',
    optional: !1,
    ...
    description: 'JavaScript object id of the node wrapper.',
    typeRef: 'Runtime.RemoteObjectId'
  }], [], 'Sets files for the given file input element.'),e.registerCommand('DOM.setNodeStackTracesEnabled', [{
    name: 'enable',
    type: 'boolean',
    optional: !1,
    description: 'Enable or disable.',
    typeRef: null
  }], [], 'Sets if stack traces should be captured for Nodes. See `Node.getNodeStackTraces`. Default is disabled.'),e.registerCommand('DOM.getNodeStackTraces', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    description: 'Id of the node to get stack traces for.',
    typeRef: 'DOM.NodeId'
  }], ['creation'], 'Gets stack traces associated with a Node. As of now, only provides stack trace for Node creation.'),e.registerCommand('DOM.getFileInfo', [{
    name: 'objectId',
    type: 'string',
    optional: !1,
    description: 'JavaScript object id of the node wrapper.',
    typeRef: 'Runtime.RemoteObjectId'
  }], ['path'], 'Returns file information for the given File wrapper.'),e.registerCommand('DOM.getDetachedDomNodes', [], ['detachedNodes'], 'Returns list of detached nodes'),e.registerCommand('DOM.setInspectedNode', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    description: 'DOM node id to be accessible by means of $x command line API.',
    typeRef: 'DOM.NodeId'
  }], [], 'Enables console to refer to the node with given id via $x (see Command Line API for more details $x functions).'),e.registerCommand('DOM.setNodeName', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }], ['nodeId'], 'Sets node name for a node with given id.'),e.registerCommand('DOM.setNodeValue', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }], [], 'Sets node value for a node with given id.'),e.registerCommand('DOM.setOuterHTML', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }], [], 'Sets node HTML markup, returns new node id.'),e.registerCommand('DOM.undo', [], [], 'Undoes the last performed action.'),e.registerCommand('DOM.getFrameOwner', [{
    name: 'frameId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Page.FrameId'
  }], ['backendNodeId', 'nodeId'], 'Returns iframe node that owns iframe with the given domain.'),e.registerCommand('DOM.getContainerForNode', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    description: '',
    typeRef: 'DOM.NodeId'
  }, { name: 'containerName', type: 'string', optional: !0, description: '', typeRef: null }, {
    name: 'physicalAxes',
    type: 'string',
    optional: !0,
    description: '',
    ...
    typeRef: 'DOM.NodeId'
  }], ['nodeIds'], 'Returns the descendants of a container query container that have container queries against this container.'),e.registerCommand('DOM.getAnchorElement', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    ...
    type: 'string',
    optional: !0,
    description: 'An optional anchor specifier, as defined in https://www.w3.org/TR/css-anchor-position-1/#anchor-specifier. If not provided, it will return the implicit anchor element for the given positioned element.',
    typeRef: null
    ...
    typeRef: null
  }, { name: 'name', type: 'string', optional: !0, description: '`Attr`\'s name.', typeRef: null }, {
    name: 'value',
    type: 'string',
    optional: !0,
    ...
    description: '',
    typeRef: 'DOM.BackendNode'
  }]),e.registerType('DOM.DetachedElementInfo', [{
    name: 'treeNode',
    type: 'object',
    optional: !1,
    description: '',
    ...
    typeRef: null
  }]),e.registerType('DOM.Quad', [{
    name: 'Quad',
    type: 'array',
    optional: !1,
    description: 'An array of quad vertices, x immediately followed by y for each point, points clock-wise.',
    typeRef: 'number'
  }]),e.registerType('DOM.BoxModel', [{
    name: 'content',
    type: 'array',
    optional: !1,
    ...
    typeRef: 'DOM.Quad'
  }, { name: 'border', type: 'array', optional: !1, description: 'Border box', typeRef: 'DOM.Quad' }, {
    name: 'margin',
    type: 'array',
    optional: !1,
    description: 'Margin box',
    typeRef: 'DOM.Quad'
  }, { name: 'width', type: 'number', optional: !1, description: 'Node width', typeRef: null }, {
    name: 'height',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'DOM.ShapeOutsideInfo'
  }]),e.registerType('DOM.ShapeOutsideInfo', [{
    name: 'bounds',
    type: 'array',
    optional: !1,
    ...
    description: 'Computed style property value.',
    typeRef: null
  }]),e.registerEnum('DOMDebugger.DOMBreakpointType', {
    SubtreeModified: 'subtree-modified',
    AttributeModified: 'attribute-modified',
    NodeRemoved: 'node-removed'
  }),e.registerEnum('DOMDebugger.CSPViolationType', {
    TrustedtypeSinkViolation: 'trustedtype-sink-violation',
    TrustedtypePolicyViolation: 'trustedtype-policy-violation'
  }),e.registerCommand('DOMDebugger.getEventListeners', [{
    name: 'objectId',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }], ['listeners'], 'Returns event listeners of the given object.'),e.registerCommand('DOMDebugger.removeDOMBreakpoint', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'DOMDebugger.DOMBreakpointType'
  }], [], 'Removes DOM breakpoint that was set using `setDOMBreakpoint`.'),e.registerCommand('DOMDebugger.removeEventListenerBreakpoint', [{
    name: 'eventName',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }], [], 'Removes breakpoint on particular DOM event.'),e.registerCommand('DOMDebugger.removeInstrumentationBreakpoint', [{
    name: 'eventName',
    type: 'string',
    optional: !1,
    description: 'Instrumentation name to stop on.',
    typeRef: null
  }], [], 'Removes breakpoint on particular native event.'),e.registerCommand('DOMDebugger.removeXHRBreakpoint', [{
    name: 'url',
    type: 'string',
    optional: !1,
    description: 'Resource URL substring.',
    typeRef: null
  }], [], 'Removes breakpoint from XMLHttpRequest.'),e.registerCommand('DOMDebugger.setBreakOnCSPViolation', [{
    name: 'violationTypes',
    type: 'array',
    optional: !1,
    description: 'CSP Violations to stop upon.',
    typeRef: 'DOMDebugger.CSPViolationType'
  }], [], 'Sets breakpoint on particular CSP violations.'),e.registerCommand('DOMDebugger.setDOMBreakpoint', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'DOMDebugger.DOMBreakpointType'
  }], [], 'Sets breakpoint on particular operation with DOM.'),e.registerCommand('DOMDebugger.setEventListenerBreakpoint', [{
    name: 'eventName',
    type: 'string',
    optional: !1,
    ...
    type: 'string',
    optional: !0,
    description: 'EventTarget interface name to stop on. If equal to `\\"*\\"` or not provided, will stop on any EventTarget.',
    typeRef: null
  }], [], 'Sets breakpoint on particular DOM event.'),e.registerCommand('DOMDebugger.setInstrumentationBreakpoint', [{
    name: 'eventName',
    type: 'string',
    optional: !1,
    description: 'Instrumentation name to stop on.',
    typeRef: null
  }], [], 'Sets breakpoint on particular native event.'),e.registerCommand('DOMDebugger.setXHRBreakpoint', [{
    name: 'url',
    type: 'string',
    optional: !1,
    description: 'Resource URL substring. All XHRs having this substring in the URL will get stopped upon.',
    typeRef: null
  }], [], 'Sets breakpoint on XMLHttpRequest.'),e.registerType('DOMDebugger.EventListener', [{
    name: 'type',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'DOM.BackendNodeId'
  }]),e.registerCommand('EventBreakpoints.setInstrumentationBreakpoint', [{
    name: 'eventName',
    type: 'string',
    optional: !1,
    description: 'Instrumentation name to stop on.',
    typeRef: null
  }], [], 'Sets breakpoint on particular native event.'),e.registerCommand('EventBreakpoints.removeInstrumentationBreakpoint', [{
    name: 'eventName',
    type: 'string',
    optional: !1,
    description: 'Instrumentation name to stop on.',
    typeRef: null
  }], [], 'Removes breakpoint on particular native event.'),e.registerCommand('EventBreakpoints.disable', [], [], 'Removes all breakpoints'),e.registerCommand('DOMSnapshot.disable', [], [], 'Disables DOM snapshot agent for the given page.'),e.registerCommand('DOMSnapshot.enable', [], [], 'Enables DOM snapshot agent for the given page.'),e.registerCommand('DOMSnapshot.getSnapshot', [{
    ...
    typeRef: null
  }], ['domNodes', 'layoutTreeNodes', 'computedStyles'], 'Returns a document snapshot, including the full DOM tree of the root node (including iframes, template contents, and imported documents) in a flattened array, as well as layout and white-listed computed style information for the nodes. Shadow DOM in the returned DOM tree is flattened.'),e.registerCommand('DOMSnapshot.captureSnapshot', [{
    name: 'computedStyles',
    type: 'array',
    optional: !1,
    description: 'Whitelist of computed styles to return.',
    ...
    type: 'boolean',
    optional: !0,
    description: 'Whether to include blended background colors in the snapshot (default: false). Blended background color is achieved by blending background colors of all elements that overlap with the current element.',
    typeRef: null
  }, {
    name: 'includeTextColorOpacities',
    type: 'boolean',
    optional: !0,
    description: 'Whether to include text color opacity in the snapshot (default: false). An element might have the opacity property set that affects the text color of the element. The final text color opacity is computed based on the opacity of all overlapping elements.',
    typeRef: null
  }], ['documents', 'strings'], 'Returns a document snapshot, including the full DOM tree of the root node (including iframes, template contents, and imported documents) in a flattened array, as well as layout and white-listed computed style information for the nodes. Shadow DOM in the returned DOM tree is flattened.'),e.registerType('DOMSnapshot.DOMNode', [{
    name: 'nodeType',
    type: 'number',
    optional: !1,
    description: '`Node`\'s nodeType.',
    ...
    typeRef: 'DOMDebugger.EventListener'
  }, {
    ...
    description: '',
    typeRef: null
  }]),e.registerType('DOMSnapshot.InlineTextBox', [{
    name: 'boundingBox',
    type: 'object',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('DOMSnapshot.LayoutTreeNode', [{
    name: 'domNodeIndex',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'DOMSnapshot.InlineTextBox'
  }, {
    name: 'styleIndex',
    type: 'number',
    optional: !0,
    ...
    typeRef: null
  }]),e.registerType('DOMSnapshot.ComputedStyle', [{
    name: 'properties',
    type: 'array',
    optional: !1,
    description: 'Name/value pairs of computed style properties.',
    typeRef: 'DOMSnapshot.NameValue'
  }]),e.registerType('DOMSnapshot.NameValue', [{
    name: 'name',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('DOMSnapshot.ArrayOfStrings', [{
    name: 'ArrayOfStrings',
    type: 'array',
    optional: !1,
    description: 'Index of the string in the strings table.',
    typeRef: 'DOMSnapshot.StringIndex'
  }]),e.registerType('DOMSnapshot.RareStringData', [{
    name: 'index',
    type: 'array',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: 'DOMSnapshot.StringIndex'
  }]),e.registerType('DOMSnapshot.RareBooleanData', [{
    name: 'index',
    type: 'array',
    optional: !1,
    description: '',
    typeRef: 'integer'
  }]),e.registerType('DOMSnapshot.RareIntegerData', [{
    name: 'index',
    type: 'array',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: 'integer'
  }]),e.registerType('DOMSnapshot.Rectangle', [{
    name: 'Rectangle',
    type: 'array',
    optional: !1,
    description: '',
    typeRef: 'number'
  }]),e.registerType('DOMSnapshot.DocumentSnapshot', [{
    name: 'documentURL',
    type: 'number',
    optional: !1,
    description: 'Document URL that `Document` or `FrameOwner` node points to.',
    ...
    typeRef: 'DOMSnapshot.NodeTreeSnapshot'
  }, {
    name: 'layout',
    type: 'object',
    optional: !1,
    description: 'The nodes in the layout tree.',
    typeRef: 'DOMSnapshot.LayoutTreeSnapshot'
  }, {
    name: 'textBoxes',
    type: 'object',
    optional: !1,
    description: 'The post-layout inline text nodes.',
    typeRef: 'DOMSnapshot.TextBoxSnapshot'
  }, {
    name: 'scrollOffsetX',
    type: 'number',
    optional: !0,
    ...
    typeRef: 'DOMSnapshot.RareStringData'
  }, {
    name: 'nodeName',
    type: 'array',
    optional: !0,
    ...
    typeRef: 'DOMSnapshot.ArrayOfStrings'
  }, {
    name: 'textValue',
    type: 'object',
    optional: !0,
    ...
    optional: !0,
    description: 'Only set for radio and checkbox input elements, indicates if the element has been checked',
    typeRef: 'DOMSnapshot.RareBooleanData'
  }, {
    name: 'optionSelected',
    type: 'object',
    optional: !0,
    ...
    typeRef: 'DOMSnapshot.RareIntegerData'
  }, {
    name: 'pseudoType',
    type: 'object',
    optional: !0,
    ...
    description: 'The url of the script (if any) that generates this node.',
    typeRef: 'DOMSnapshot.RareStringData'
  }]),e.registerType('DOMSnapshot.LayoutTreeSnapshot', [{
    name: 'nodeIndex',
    type: 'array',
    optional: !1,
    ...
    typeRef: 'number'
  }]),e.registerType('DOMSnapshot.TextBoxSnapshot', [{
    name: 'layoutIndex',
    type: 'array',
    optional: !1,
    ...
    description: 'The number of characters in this post layout textbox substring. Characters that would be represented as a surrogate pair in UTF-16 have length 2.',
    typeRef: 'integer'
  }]),e.registerEvent('DOMStorage.domStorageItemAdded', ['storageId', 'key', 'newValue']),e.registerEvent('DOMStorage.domStorageItemRemoved', ['storageId', 'key']),e.registerEvent('DOMStorage.domStorageItemUpdated', ['storageId', 'key', 'oldValue', 'newValue']),e.registerEvent('DOMStorage.domStorageItemsCleared', ['storageId']),e.registerCommand('DOMStorage.clear', [{
    name: 'storageId',
    type: 'object',
    optional: !1,
    description: '',
    typeRef: 'DOMStorage.StorageId'
  }], [], ''),e.registerCommand('DOMStorage.disable', [], [], 'Disables storage tracking, prevents storage events from being sent to the client.'),e.registerCommand('DOMStorage.enable', [], [], 'Enables storage tracking, storage events will now be delivered to the client.'),e.registerCommand('DOMStorage.getDOMStorageItems', [{
    name: 'storageId',
    type: 'object',
    optional: !1,
    description: '',
    typeRef: 'DOMStorage.StorageId'
  }], ['entries'], ''),e.registerCommand('DOMStorage.removeDOMStorageItem', [{
    name: 'storageId',
    type: 'object',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], [], ''),e.registerCommand('DOMStorage.setDOMStorageItem', [{
    name: 'storageId',
    type: 'object',
    optional: !1,
    description: '',
    typeRef: 'DOMStorage.StorageId'
  }, { name: 'key', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'value',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], [], ''),e.registerType('DOMStorage.StorageId', [{
    name: 'securityOrigin',
    type: 'string',
    optional: !0,
    ...
    typeRef: null
  }]),e.registerType('DOMStorage.Item', [{
    name: 'Item',
    type: 'array',
    optional: !1,
    description: 'DOM Storage item.',
    typeRef: 'string'
  }]),e.registerEvent('Database.addDatabase', ['database']),e.registerCommand('Database.disable', [], [], 'Disables database tracking, prevents database events from being sent to the client.'),e.registerCommand('Database.enable', [], [], 'Enables database tracking, database events will now be delivered to the client.'),e.registerCommand('Database.executeSQL', [{
    name: 'databaseId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Database.DatabaseId'
  }, {
    name: 'query',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], ['columnNames', 'values', 'sqlError'], ''),e.registerCommand('Database.getDatabaseTableNames', [{
    name: 'databaseId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Database.DatabaseId'
  }], ['tableNames'], ''),e.registerType('Database.Database', [{
    name: 'id',
    type: 'string',
    optional: !1,
    description: 'Database ID.',
    typeRef: 'Database.DatabaseId'
  }, { name: 'domain', type: 'string', optional: !1, description: 'Database domain.', typeRef: null }, {
    name: 'name',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }, { name: 'beta', type: 'number', optional: !1, description: 'Mock beta', typeRef: null }, {
    name: 'gamma',
    type: 'number',
    optional: !1,
    description: 'Mock gamma',
    typeRef: null
  }], [], 'Overrides the Device Orientation.'),e.registerEnum('Emulation.ScreenOrientationType', {
    PortraitPrimary: 'portraitPrimary',
    PortraitSecondary: 'portraitSecondary',
    LandscapePrimary: 'landscapePrimary',
    LandscapeSecondary: 'landscapeSecondary'
  }),e.registerEnum('Emulation.DisplayFeatureOrientation', {
    Vertical: 'vertical',
    Horizontal: 'horizontal'
  }),e.registerEnum('Emulation.DevicePostureType', {
    Continuous: 'continuous',
    Folded: 'folded'
  }),e.registerEnum('Emulation.VirtualTimePolicy', {
    Advance: 'advance',
    Pause: 'pause',
    PauseIfNetworkFetchesPending: 'pauseIfNetworkFetchesPending'
  }),e.registerEnum('Emulation.SensorType', {
  ...
  }),e.registerEnum('Emulation.PressureSource', { Cpu: 'cpu' }),e.registerEnum('Emulation.PressureState', {
    Nominal: 'nominal',
    Fair: 'fair',
    Serious: 'serious',
    Critical: 'critical'
    ...
    Avif: 'avif',
    Webp: 'webp'
  }),e.registerEvent('Emulation.virtualTimeBudgetExpired', []),e.registerCommand('Emulation.canEmulate', [], ['result'], 'Tells whether emulation is supported.'),e.registerCommand('Emulation.clearDeviceMetricsOverride', [], [], 'Clears the overridden device metrics.'),e.registerCommand('Emulation.clearGeolocationOverride', [], [], 'Clears the overridden Geolocation Position and Error.'),e.registerCommand('Emulation.resetPageScaleFactor', [], [], 'Requests that page scale factor is reset to initial values.'),e.registerCommand('Emulation.setFocusEmulationEnabled', [{
    name: 'enabled',
    type: 'boolean',
    optional: !1,
    description: 'Whether to enable to disable focus emulation.',
    typeRef: null
  }], [], 'Enables or disables simulating a focused and active page.'),e.registerCommand('Emulation.setAutoDarkModeOverride', [{
    name: 'enabled',
    type: 'boolean',
    optional: !0,
    description: 'Whether to enable or disable automatic dark mode. If not specified, any existing override will be cleared.',
    typeRef: null
    ...
    typeRef: null
  }], [], 'Enables CPU throttling to emulate slow CPUs.'),e.registerCommand('Emulation.setDefaultBackgroundColorOverride', [{
    name: 'color',
    type: 'object',
    optional: !0,
    description: 'RGBA of the default background color. If not specified, any existing override will be cleared.',
    typeRef: 'DOM.RGBA'
  }], [], 'Sets or clears an override of the default background color of the frame. This override is used if the content does not specify one.'),e.registerCommand('Emulation.setDeviceMetricsOverride', [{
    name: 'width',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'Emulation.ScreenOrientation'
  }, {
    name: 'viewport',
    type: 'object',
    optional: !0,
    ...
    type: 'object',
    optional: !0,
    description: 'If set, the display feature of a multi-segment screen. If not set, multi-segment support is turned-off.',
    typeRef: 'Emulation.DisplayFeature'
  }, {
    name: 'devicePosture',
    type: 'object',
    optional: !0,
    description: 'If set, the posture of a foldable device. If not set the posture is set to continuous. Deprecated, use Emulation.setDevicePostureOverride.',
    typeRef: 'Emulation.DevicePosture'
  }], [], 'Overrides the values of device screen dimensions (window.screen.width, window.screen.height, window.innerWidth, window.innerHeight, and "device-width"/"device-height"-related CSS media query results).'),e.registerCommand('Emulation.setDevicePostureOverride', [{
    name: 'posture',
    type: 'object',
    optional: !1,
    description: '',
    typeRef: 'Emulation.DevicePosture'
  }], [], 'Start reporting the given posture value to the Device Posture API. This override can also be set in setDeviceMetricsOverride().'),e.registerCommand('Emulation.clearDevicePostureOverride', [], [], 'Clears a device posture override set with either setDeviceMetricsOverride() or setDevicePostureOverride() and starts using posture information from the platform again. Does nothing if no override is set.'),e.registerCommand('Emulation.setScrollbarsHidden', [{
    name: 'hidden',
    type: 'boolean',
    optional: !1,
    description: 'Whether scrollbars should be always hidden.',
    typeRef: null
  }], [], ''),e.registerCommand('Emulation.setDocumentCookieDisabled', [{
    name: 'disabled',
    type: 'boolean',
    optional: !1,
    ...
    Mobile: 'mobile',
    Desktop: 'desktop'
  }),e.registerCommand('Emulation.setEmitTouchEventsForMouse', [{
    name: 'enabled',
    type: 'boolean',
    optional: !1,
    ...
    typeRef: 'Emulation.SetEmitTouchEventsForMouseRequestConfiguration'
  }], [], ''),e.registerCommand('Emulation.setEmulatedMedia', [{
    name: 'media',
    type: 'string',
    optional: !0,
    ...
    typeRef: 'Emulation.MediaFeature'
  }], [], 'Emulates the given media type or media feature for CSS media queries.'),e.registerEnum('Emulation.SetEmulatedVisionDeficiencyRequestType', {
    None: 'none',
  ...
  }),e.registerCommand('Emulation.setEmulatedVisionDeficiency', [{
    name: 'type',
    type: 'string',
    optional: !1,
    description: 'Vision deficiency to emulate. Order: best-effort emulations come first, followed by any physiologically accurate emulations for medically recognized color vision deficiencies.',
    typeRef: 'Emulation.SetEmulatedVisionDeficiencyRequestType'
  }], [], 'Emulates the given vision deficiency.'),e.registerCommand('Emulation.setGeolocationOverride', [{
    name: 'latitude',
    type: 'number',
    optional: !0,
    ...
    optional: !1,
    description: '',
    typeRef: 'Emulation.SensorType'
  }], ['requestedSamplingFrequency'], ''),e.registerCommand('Emulation.setSensorOverrideEnabled', [{
    name: 'enabled',
    type: 'boolean',
    optional: !1,
    description: '',
    ...
    optional: !0,
    description: '',
    typeRef: 'Emulation.SensorMetadata'
  }], [], 'Overrides a platform sensor of a given type. If |enabled| is true, calls to Sensor.start() will use a virtual sensor as backend rather than fetching data from a real hardware sensor. Otherwise, existing virtual sensor-backend Sensor objects will fire an error event and new calls to Sensor.start() will attempt to use a real sensor instead.'),e.registerCommand('Emulation.setSensorOverrideReadings', [{
    name: 'type',
    type: 'string',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'Emulation.SensorReading'
  }], [], 'Updates the sensor readings reported by a sensor type previously overridden by setSensorOverrideEnabled.'),e.registerCommand('Emulation.setPressureSourceOverrideEnabled', [{
    name: 'enabled',
    type: 'boolean',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'Emulation.PressureSource'
  }, {
    name: 'metadata',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Emulation.PressureMetadata'
  }], [], 'Overrides a pressure source of a given type, as used by the Compute Pressure API, so that updates to PressureObserver.observe() are provided via setPressureStateOverride instead of being retrieved from platform-provided telemetry data.'),e.registerCommand('Emulation.setPressureStateOverride', [{
    name: 'source',
    type: 'string',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'Emulation.PressureState'
  }], [], 'Provides a given pressure state that will be processed and eventually be delivered to PressureObserver users. |source| must have been previously overridden by setPressureSourceOverrideEnabled.'),e.registerCommand('Emulation.setIdleOverride', [{
    name: 'isUserActive',
    type: 'boolean',
    optional: !1,
    ...
    typeRef: null
  }], [], 'Overrides value returned by the javascript navigator object.'),e.registerCommand('Emulation.setPageScaleFactor', [{
    name: 'pageScaleFactor',
    type: 'number',
    optional: !1,
    description: 'Page scale factor.',
    typeRef: null
  }], [], 'Sets a specified page scale factor.'),e.registerCommand('Emulation.setScriptExecutionDisabled', [{
    name: 'value',
    type: 'boolean',
    optional: !1,
    description: 'Whether script execution should be disabled in the page.',
    typeRef: null
  }], [], 'Switches script execution in the page.'),e.registerCommand('Emulation.setTouchEmulationEnabled', [{
    name: 'enabled',
    type: 'boolean',
    optional: !1,
    ...
    typeRef: null
  }], [], 'Enables touch on platforms which do not support them.'),e.registerCommand('Emulation.setVirtualTimePolicy', [{
    name: 'policy',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Emulation.VirtualTimePolicy'
  }, {
    name: 'budget',
    type: 'number',
    optional: !0,
    ...
    typeRef: 'Network.TimeSinceEpoch'
  }], ['virtualTimeTicksBase'], 'Turns on virtual time for all frames (replacing real-time with a synthetic time source) and sets the current virtual time policy.  Note this supersedes any previous time budget.'),e.registerCommand('Emulation.setLocaleOverride', [{
    name: 'locale',
    type: 'string',
    optional: !0,
    description: 'ICU style C locale (e.g. \\"en_US\\"). If not specified or empty, disables the override and restores default host system locale.',
    typeRef: null
  }], [], 'Overrides default host system locale with the specified one.'),e.registerCommand('Emulation.setTimezoneOverride', [{
    name: 'timezoneId',
    type: 'string',
    optional: !1,
    description: 'The timezone identifier. List of supported timezones: https://source.chromium.org/chromium/chromium/deps/icu.git/+/faee8bc70570192d82d2978a71e2a615788597d1:source/data/misc/metaZones.txt If empty, disables the override and restores default host system timezone.',
    typeRef: null
  }], [], 'Overrides default host system timezone with the specified one.'),e.registerCommand('Emulation.setVisibleSize', [{
    name: 'width',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }], [], 'Resizes the frame/viewport of the page. Note that this does not affect the frame\'s container (e.g. browser window). Can be used to produce screenshots of the specified size. Not supported on Android.'),e.registerCommand('Emulation.setDisabledImageTypes', [{
    name: 'imageTypes',
    type: 'array',
    optional: !1,
    description: 'Image types to disable.',
    typeRef: 'Emulation.DisabledImageType'
  }], [], ''),e.registerCommand('Emulation.setHardwareConcurrencyOverride', [{
    ...
    typeRef: 'Emulation.UserAgentMetadata'
  }], [], 'Allows overriding user agent with the given string. `userAgentMetadata` must be set for Client Hint headers to be sent.'),e.registerCommand('Emulation.setAutomationOverride', [{
    name: 'enabled',
    type: 'boolean',
    optional: !1,
    description: 'Whether the override should be enabled.',
    typeRef: null
  }], [], 'Allows overriding the automation flag.'),e.registerType('Emulation.ScreenOrientation', [{
    name: 'type',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Emulation.DisplayFeature', [{
    name: 'orientation',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Emulation.DevicePosture', [{
    name: 'type',
    type: 'string',
    optional: !1,
    description: 'Current posture of the device',
    typeRef: null
  }]),e.registerType('Emulation.MediaFeature', [{
    name: 'name',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }]),e.registerType('Emulation.UserAgentMetadata', [{
    name: 'brands',
    type: 'array',
    optional: !0,
    description: 'Brands appearing in Sec-CH-UA.',
    typeRef: 'Emulation.UserAgentBrandVersion'
  }, {
    ...
    typeRef: 'Emulation.UserAgentBrandVersion'
  }, { name: 'fullVersion', type: 'string', optional: !0, description: '', typeRef: null }, {
    name: 'platform',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }, { name: 'platformVersion', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'architecture',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }, { name: 'model', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'mobile',
    type: 'boolean',
    optional: !1,
    description: '',
    typeRef: null
  }, { name: 'bitness', type: 'string', optional: !0, description: '', typeRef: null }, {
    name: 'wow64',
    type: 'boolean',
    optional: !0,
    description: '',
    typeRef: null
  }]),e.registerType('Emulation.SensorMetadata', [{
    name: 'available',
    type: 'boolean',
    optional: !0,
    description: '',
    ...
    description: '',
    typeRef: null
  }]),e.registerType('Emulation.SensorReadingXYZ', [{
    name: 'x',
    type: 'number',
    optional: !1,
    description: '',
    ...
    optional: !0,
    description: '',
    typeRef: 'Emulation.SensorReadingSingle'
  }, {
    name: 'xyz',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Emulation.SensorReadingXYZ'
  }, {
    name: 'quaternion',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Emulation.SensorReadingQuaternion'
  }]),e.registerType('Emulation.PressureMetadata', [{
    name: 'available',
    type: 'boolean',
    optional: !0,
    description: '',
    typeRef: null
  }]),e.registerEnum('HeadlessExperimental.ScreenshotParamsFormat', {
    Jpeg: 'jpeg',
    Png: 'png',
    Webp: 'webp'
  }),e.registerCommand('HeadlessExperimental.beginFrame', [{
    name: 'frameTimeTicks',
    type: 'number',
    optional: !0,
    description: 'Timestamp of this BeginFrame in Renderer TimeTicks (milliseconds of uptime). If not set, the current time will be used.',
    typeRef: null
  }, {
    name: 'interval',
    type: 'number',
    ...
    type: 'boolean',
    optional: !0,
    description: 'Whether updates should not be committed and drawn onto the display. False by default. If true, only side effects of the BeginFrame will be run, such as layout and animations, but any visual updates may not be visible on the display or in screenshots.',
    typeRef: null
  }, {
    name: 'screenshot',
    type: 'object',
    optional: !0,
    description: 'If set, a screenshot of the frame will be captured and returned in the response. Otherwise, no screenshot will be captured. Note that capturing a screenshot can fail, for example, during renderer initialization. In such a case, no screenshot data will be returned.',
    typeRef: 'HeadlessExperimental.ScreenshotParams'
  }], ['hasDamage', 'screenshotData'], 'Sends a BeginFrame to the target and returns when the frame was completed. Optionally captures a screenshot from the resulting frame. Requires that the target was created with enabled BeginFrameControl. Designed for use with --run-all-compositor-stages-before-draw, see also https://goo.gle/chrome-headless-rendering for more background.'),e.registerCommand('HeadlessExperimental.disable', [], [], 'Disables headless events for the target.'),e.registerCommand('HeadlessExperimental.enable', [], [], 'Enables headless events for the target.'),e.registerType('HeadlessExperimental.ScreenshotParams', [{
    name: 'format',
    type: 'string',
    optional: !0,
    ...
    typeRef: null
  }]),e.registerCommand('IO.close', [{
    name: 'handle',
    type: 'string',
    optional: !1,
    description: 'Handle of the stream to close.',
    typeRef: 'IO.StreamHandle'
  }], [], 'Close the stream, discard any temporary backing storage.'),e.registerCommand('IO.read', [{
    name: 'handle',
    type: 'string',
    optional: !1,
    ...
    type: 'number',
    optional: !0,
    description: 'Seek to the specified offset before reading (if not specified, proceed with offset following the last read). Some types of streams may only support sequential reads.',
    typeRef: null
  }, {
    name: 'size',
    type: 'number',
    ...
    typeRef: null
  }], ['base64Encoded', 'data', 'eof'], 'Read a chunk of the stream'),e.registerCommand('IO.resolveBlob', [{
    name: 'objectId',
    type: 'string',
    optional: !1,
    description: 'Object id of a Blob object wrapper.',
    typeRef: 'Runtime.RemoteObjectId'
  }], ['uuid'], 'Return UUID of Blob object specified by a remote object id.'),e.registerCommand('FileSystem.getDirectory', [{
    name: 'bucketFileSystemLocator',
    type: 'object',
    optional: !1,
    description: '',
    typeRef: 'FileSystem.BucketFileSystemLocator'
  }], ['directory'], ''),e.registerType('FileSystem.File', [{
    name: 'name',
    type: 'string',
    optional: !1,
    description: '',
    ...
    typeRef: 'Network.TimeSinceEpoch'
  }, { name: 'size', type: 'number', optional: !1, description: 'Size in bytes', typeRef: null }, {
    name: 'type',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }]),e.registerType('FileSystem.Directory', [{
    name: 'name',
    type: 'string',
    optional: !1,
    description: '',
    ...
    typeRef: 'FileSystem.File'
  }]),e.registerType('FileSystem.BucketFileSystemLocator', [{
    name: 'storageKey',
    type: 'string',
    optional: !1,
    description: 'Storage key',
    typeRef: 'Storage.SerializedStorageKey'
  }, {
    name: 'bucketName',
    type: 'string',
    optional: !0,
    ...
    typeRef: 'string'
  }]),e.registerEnum('IndexedDB.KeyType', {
    Number: 'number',
    String: 'string',
    Date: 'date',
    Array: 'array'
  }),e.registerEnum('IndexedDB.KeyPathType', {
    Null: 'null',
    String: 'string',
    Array: 'array'
  }),e.registerCommand('IndexedDB.clearObjectStore', [{
    name: 'securityOrigin',
    type: 'string',
    optional: !0,
    description: 'At least and at most one of securityOrigin, storageKey, or storageBucket must be specified. Security origin.',
    typeRef: null
  }, {
    name: 'storageKey',
    type: 'string',
    ...
    typeRef: null
  }], [], 'Clears all entries from an object store.'),e.registerCommand('IndexedDB.deleteDatabase', [{
    name: 'securityOrigin',
    type: 'string',
    optional: !0,
    description: 'At least and at most one of securityOrigin, storageKey, or storageBucket must be specified. Security origin.',
    ...
    description: 'Storage bucket. If not specified, it uses the default bucket.',
    typeRef: 'Storage.StorageBucket'
  }, { name: 'databaseName', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'objectStoreName',
    type: 'string',
    optional: !1,
    description: '',
    ...
    typeRef: 'IndexedDB.KeyRange'
  }], [], 'Delete a range of entries from an object store'),e.registerCommand('IndexedDB.disable', [], [], 'Disables events from backend.'),e.registerCommand('IndexedDB.enable', [], [], 'Enables events from backend.'),e.registerCommand('IndexedDB.requestData', [{
    name: 'securityOrigin',
    type: 'string',
    optional: !0,
    description: 'At least and at most one of securityOrigin, storageKey, or storageBucket must be specified. Security origin.',
    ...
    typeRef: 'IndexedDB.KeyRange'
  }], ['objectStoreDataEntries', 'hasMore'], 'Requests data from object store or index.'),e.registerCommand('IndexedDB.getMetadata', [{
    name: 'securityOrigin',
    type: 'string',
    optional: !0,
    description: 'At least and at most one of securityOrigin, storageKey, or storageBucket must be specified. Security origin.',
    ...
    description: 'Object store name.',
    typeRef: null
  }], ['entriesCount', 'keyGeneratorValue'], 'Gets metadata of an object store.'),e.registerCommand('IndexedDB.requestDatabase', [{
    name: 'securityOrigin',
    type: 'string',
    optional: !0,
    description: 'At least and at most one of securityOrigin, storageKey, or storageBucket must be specified. Security origin.',
    ...
    description: 'Database name.',
    typeRef: null
  }], ['databaseWithObjectStores'], 'Requests database with given name in given frame.'),e.registerCommand('IndexedDB.requestDatabaseNames', [{
    name: 'securityOrigin',
    type: 'string',
    optional: !0,
    description: 'At least and at most one of securityOrigin, storageKey, or storageBucket must be specified. Security origin.',
    ...
    description: 'Storage bucket. If not specified, it uses the default bucket.',
    typeRef: 'Storage.StorageBucket'
  }], ['databaseNames'], 'Requests database names for given security origin.'),e.registerType('IndexedDB.DatabaseWithObjectStores', [{
    name: 'name',
    type: 'string',
    optional: !1,
    description: 'Database name.',
    ...
    typeRef: 'IndexedDB.ObjectStore'
  }]),e.registerType('IndexedDB.ObjectStore', [{
    name: 'name',
    type: 'string',
    optional: !1,
    description: 'Object store name.',
    ...
    typeRef: 'IndexedDB.ObjectStoreIndex'
  }]),e.registerType('IndexedDB.ObjectStoreIndex', [{
    name: 'name',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'IndexedDB.Key'
  }]),e.registerType('IndexedDB.KeyRange', [{
    name: 'lower',
    type: 'object',
    optional: !0,
    ...
    typeRef: null
  }]),e.registerType('IndexedDB.DataEntry', [{
    name: 'key',
    type: 'object',
    optional: !1,
    ...
    typeRef: 'Runtime.RemoteObject'
  }]),e.registerType('IndexedDB.KeyPath', [{
    name: 'type',
    type: 'string',
    optional: !1,
    description: 'Key path type.',
    typeRef: null
  }, { name: 'string', type: 'string', optional: !0, description: 'String value.', typeRef: null }, {
    name: 'array',
    type: 'array',
    optional: !0,
    description: 'Array value.',
    typeRef: 'string'
  }]),e.registerEnum('Input.GestureSourceType', {
    Default: 'default',
    Touch: 'touch',
    Mouse: 'mouse'
  }),e.registerEnum('Input.MouseButton', {
    None: 'none',
    Left: 'left',
    Middle: 'middle',
    Right: 'right',
    Back: 'back',
    Forward: 'forward'
  }),e.registerEvent('Input.dragIntercepted', ['data']),e.registerEnum('Input.DispatchDragEventRequestType', {
    DragEnter: 'dragEnter',
    DragOver: 'dragOver',
    Drop: 'drop',
    DragCancel: 'dragCancel'
  }),e.registerCommand('Input.dispatchDragEvent', [{
    name: 'type',
    type: 'string',
    optional: !1,
    description: 'Type of the drag event.',
    typeRef: 'Input.DispatchDragEventRequestType'
  }, {
    name: 'x',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }, { name: 'data', type: 'object', optional: !1, description: '', typeRef: 'Input.DragData' }, {
    name: 'modifiers',
    type: 'number',
    optional: !0,
    description: 'Bit field representing pressed modifier keys. Alt=1, Ctrl=2, Meta/Command=4, Shift=8 (default: 0).',
    typeRef: null
  }], [], 'Dispatches a drag event into the page.'),e.registerEnum('Input.DispatchKeyEventRequestType', {
    KeyDown: 'keyDown',
    KeyUp: 'keyUp',
    RawKeyDown: 'rawKeyDown',
    Char: 'char'
  }),e.registerCommand('Input.dispatchKeyEvent', [{
    name: 'type',
    type: 'string',
    optional: !1,
    description: 'Type of the key event.',
    typeRef: 'Input.DispatchKeyEventRequestType'
  }, {
    name: 'modifiers',
    type: 'number',
    optional: !0,
    ...
    typeRef: 'string'
  }], [], 'Dispatches a key event to the page.'),e.registerCommand('Input.insertText', [{
    name: 'text',
    type: 'string',
    optional: !1,
    description: 'The text to insert.',
    typeRef: null
  }], [], 'This method emulates inserting text that doesn\'t come from a key press, for example an emoji keyboard or an IME.'),e.registerCommand('Input.imeSetComposition', [{
    name: 'text',
    type: 'string',
    optional: !1,
    description: 'The text to insert',
    ...
    typeRef: null
  }], [], 'This method sets the current candidate text for IME. Use imeCommitComposition to commit the final text. Use imeSetComposition with empty string as text to cancel composition.'),e.registerEnum('Input.DispatchMouseEventRequestType', {
    MousePressed: 'mousePressed',
    MouseReleased: 'mouseReleased',
    MouseMoved: 'mouseMoved',
    MouseWheel: 'mouseWheel'
  }),e.registerEnum('Input.DispatchMouseEventRequestPointerType', {
    Mouse: 'mouse',
    Pen: 'pen'
  }),e.registerCommand('Input.dispatchMouseEvent', [{
    name: 'type',
    type: 'string',
    optional: !1,
    description: 'Type of the mouse event.',
    typeRef: 'Input.DispatchMouseEventRequestType'
  }, {
    name: 'x',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'Input.MouseButton'
  }, {
    name: 'buttons',
    type: 'number',
    optional: !0,
    description: 'A number indicating which buttons are pressed on the mouse when a mouse event is triggered. Left=1, Right=2, Middle=4, Back=8, Forward=16, None=0.',
    typeRef: null
  }, {
    name: 'clickCount',
    type: 'number',
    ...
    typeRef: 'Input.DispatchTouchEventRequestType'
  }, {
    name: 'touchPoints',
    type: 'array',
    optional: !1,
    ...
    description: 'Time at which the event occurred.',
    typeRef: 'Input.TimeSinceEpoch'
  }], [], 'Dispatches a touch event to the page.'),e.registerCommand('Input.cancelDragging', [], [], 'Cancels any active dragging in the page.'),e.registerEnum('Input.EmulateTouchFromMouseEventRequestType', {
    MousePressed: 'mousePressed',
    MouseReleased: 'mouseReleased',
    MouseMoved: 'mouseMoved',
    MouseWheel: 'mouseWheel'
  }),e.registerCommand('Input.emulateTouchFromMouseEvent', [{
    name: 'type',
    type: 'string',
    optional: !1,
    description: 'Type of the mouse event.',
    typeRef: 'Input.EmulateTouchFromMouseEventRequestType'
  }, {
    name: 'x',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }], [], 'Ignores input events (useful while auditing page).'),e.registerCommand('Input.setInterceptDrags', [{
    name: 'enabled',
    type: 'boolean',
    optional: !1,
    description: '',
    typeRef: null
  }], [], 'Prevents default drag and drop behavior and instead emits `Input.dragIntercepted` events. Drag and drop behavior can be directly controlled via `Input.dispatchDragEvent`.'),e.registerCommand('Input.synthesizePinchGesture', [{
    name: 'x',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'Input.GestureSourceType'
  }], [], 'Synthesizes a pinch gesture over a time period by issuing appropriate touch events.'),e.registerCommand('Input.synthesizeScrollGesture', [{
    name: 'x',
    type: 'number',
    optional: !1,
    description: 'X coordinate of the start of the gesture in CSS pixels.',
    ...
    typeRef: null
  }], [], 'Synthesizes a scroll gesture over a time period by issuing appropriate touch events.'),e.registerCommand('Input.synthesizeTapGesture', [{
    name: 'x',
    type: 'number',
    optional: !1,
    description: 'X coordinate of the start of the gesture in CSS pixels.',
    ...
    description: 'Which type of input events to be generated (default: \'default\', which queries the platform for the preferred input type).',
    typeRef: 'Input.GestureSourceType'
  }], [], 'Synthesizes a tap gesture over a time period by issuing appropriate touch events.'),e.registerType('Input.TouchPoint', [{
    name: 'x',
    type: 'number',
    optional: !1,
    description: 'X coordinate of the event relative to the main frame\'s viewport in CSS pixels.',
    ...
    typeRef: null
  }]),e.registerType('Input.DragDataItem', [{
    name: 'mimeType',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Input.DragData', [{
    name: 'items',
    type: 'array',
    optional: !1,
    description: '',
    typeRef: 'Input.DragDataItem'
  }, {
    name: 'files',
    type: 'array',
    optional: !0,
    ...
    typeRef: null
  }]),e.registerEvent('Inspector.detached', ['reason']),e.registerEvent('Inspector.targetCrashed', []),e.registerEvent('Inspector.targetReloadedAfterCrash', []),e.registerCommand('Inspector.disable', [], [], 'Disables inspector domain notifications.'),e.registerCommand('Inspector.enable', [], [], 'Enables inspector domain notifications.'),e.registerEnum('LayerTree.ScrollRectType', {
    RepaintsOnScroll: 'RepaintsOnScroll',
    TouchEventHandler: 'TouchEventHandler',
    WheelEventHandler: 'WheelEventHandler'
  }),e.registerEvent('LayerTree.layerPainted', ['layerId', 'clip']),e.registerEvent('LayerTree.layerTreeDidChange', ['layers']),e.registerCommand('LayerTree.compositingReasons', [{
    name: 'layerId',
    type: 'string',
    optional: !1,
    description: 'The id of the layer for which we want to get the reasons it was composited.',
    typeRef: 'LayerTree.LayerId'
  }], ['compositingReasons', 'compositingReasonIds'], 'Provides the reasons why the given layer was composited.'),e.registerCommand('LayerTree.disable', [], [], 'Disables compositing tree inspection.'),e.registerCommand('LayerTree.enable', [], [], 'Enables compositing tree inspection.'),e.registerCommand('LayerTree.loadSnapshot', [{
    name: 'tiles',
    type: 'array',
    optional: !1,
    description: 'An array of tiles composing the snapshot.',
    typeRef: 'LayerTree.PictureTile'
  }], ['snapshotId'], 'Returns the snapshot identifier.'),e.registerCommand('LayerTree.makeSnapshot', [{
    name: 'layerId',
    type: 'string',
    optional: !1,
    description: 'The id of the layer.',
    typeRef: 'LayerTree.LayerId'
  }], ['snapshotId'], 'Returns the layer snapshot identifier.'),e.registerCommand('LayerTree.profileSnapshot', [{
    name: 'snapshotId',
    type: 'string',
    optional: !1,
    description: 'The id of the layer snapshot.',
    typeRef: 'LayerTree.SnapshotId'
  }, {
    name: 'minRepeatCount',
    type: 'number',
    optional: !0,
    ...
    typeRef: 'DOM.Rect'
  }], ['timings'], ''),e.registerCommand('LayerTree.releaseSnapshot', [{
    name: 'snapshotId',
    type: 'string',
    optional: !1,
    description: 'The id of the layer snapshot.',
    typeRef: 'LayerTree.SnapshotId'
  }], [], 'Releases layer snapshot captured by the back-end.'),e.registerCommand('LayerTree.replaySnapshot', [{
    name: 'snapshotId',
    type: 'string',
    optional: !1,
    description: 'The id of the layer snapshot.',
    ...
    typeRef: null
  }], ['dataURL'], 'Replays the layer snapshot and returns the resulting bitmap.'),e.registerCommand('LayerTree.snapshotCommandLog', [{
    name: 'snapshotId',
    type: 'string',
    optional: !1,
    description: 'The id of the layer snapshot.',
    typeRef: 'LayerTree.SnapshotId'
  }], ['commandLog'], 'Replays the layer snapshot and returns canvas log.'),e.registerType('LayerTree.ScrollRect', [{
    name: 'rect',
    type: 'object',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('LayerTree.StickyPositionConstraint', [{
    name: 'stickyBoxRect',
    type: 'object',
    optional: !1,
    ...
    typeRef: 'LayerTree.LayerId'
  }]),e.registerType('LayerTree.PictureTile', [{
    name: 'x',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('LayerTree.Layer', [{
    name: 'layerId',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }, { name: 'width', type: 'number', optional: !1, description: 'Layer width.', typeRef: null }, {
    name: 'height',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'LayerTree.ScrollRect'
  }, {
    name: 'stickyPositionConstraint',
    type: 'object',
    optional: !0,
    description: 'Sticky position constraint information',
    typeRef: 'LayerTree.StickyPositionConstraint'
  }]),e.registerType('LayerTree.PaintProfile', [{
    name: 'PaintProfile',
    type: 'array',
    optional: !1,
    description: 'Array of timings, one per paint step.',
    typeRef: 'number'
  }]),e.registerEnum('Log.LogEntrySource', {
    XML: 'xml',
    ...
    Other: 'other'
  }),e.registerEnum('Log.LogEntryLevel', {
    Verbose: 'verbose',
    Info: 'info',
    Warning: 'warning',
    Error: 'error'
  }),e.registerEnum('Log.LogEntryCategory', { Cors: 'cors' }),e.registerEnum('Log.ViolationSettingName', {
    LongTask: 'longTask',
    ...
    typeRef: 'Runtime.RemoteObject'
  }]),e.registerType('Log.ViolationSetting', [{
    name: 'name',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerEnum('Memory.PressureLevel', {
    Moderate: 'moderate',
    Critical: 'critical'
  }),e.registerCommand('Memory.getDOMCounters', [], ['documents', 'nodes', 'jsEventListeners'], ''),e.registerCommand('Memory.prepareForLeakDetection', [], [], ''),e.registerCommand('Memory.forciblyPurgeJavaScriptMemory', [], [], 'Simulate OomIntervention by purging V8 memory.'),e.registerCommand('Memory.setPressureNotificationsSuppressed', [{
    name: 'suppressed',
    type: 'boolean',
    optional: !1,
    description: 'If true, memory pressure notifications will be suppressed.',
    typeRef: null
  }], [], 'Enable/disable suppressing memory pressure notifications in all processes.'),e.registerCommand('Memory.simulatePressureNotification', [{
    name: 'level',
    type: 'string',
    optional: !1,
    description: 'Memory pressure level of the notification.',
    typeRef: 'Memory.PressureLevel'
  }], [], 'Simulate a memory pressure notification in all processes.'),e.registerCommand('Memory.startSampling', [{
    ...
    typeRef: null
  }], [], 'Start collecting native memory profile.'),e.registerCommand('Memory.stopSampling', [], [], 'Stop collecting native memory profile.'),e.registerCommand('Memory.getAllTimeSamplingProfile', [], ['profile'], 'Retrieve native memory allocations profile collected since renderer process startup.'),e.registerCommand('Memory.getBrowserSamplingProfile', [], ['profile'], 'Retrieve native memory allocations profile collected since browser process startup.'),e.registerCommand('Memory.getSamplingProfile', [], ['profile'], 'Retrieve native memory allocations profile collected since last `startSampling` call.'),e.registerType('Memory.SamplingProfileNode', [{
    name: 'size',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'string'
  }]),e.registerType('Memory.SamplingProfile', [{
    name: 'samples',
    type: 'array',
    optional: !1,
    description: '',
    typeRef: 'Memory.SamplingProfileNode'
  }, {
    name: 'modules',
    type: 'array',
    optional: !1,
    description: '',
    typeRef: 'Memory.Module'
  }]),e.registerType('Memory.Module', [{
    name: 'name',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerEnum('Network.ResourceType', {
    Document: 'Document',
    Stylesheet: 'Stylesheet',
    Image: 'Image',
    Media: 'Media',
    ...
    Preflight: 'Preflight',
    Other: 'Other'
  }),e.registerEnum('Network.ErrorReason', {
    Failed: 'Failed',
    Aborted: 'Aborted',
    TimedOut: 'TimedOut',
  ...
  }),e.registerEnum('Network.ConnectionType', {
    None: 'none',
    ...
    Wimax: 'wimax',
    Other: 'other'
  }),e.registerEnum('Network.CookieSameSite', {
    Strict: 'Strict',
    Lax: 'Lax',
    None: 'None'
  }),e.registerEnum('Network.CookiePriority', {
    Low: 'Low',
    Medium: 'Medium',
    High: 'High'
  }),e.registerEnum('Network.CookieSourceScheme', {
    Unset: 'Unset',
    NonSecure: 'NonSecure',
    Secure: 'Secure'
  }),e.registerEnum('Network.ResourcePriority', {
    VeryLow: 'VeryLow',
    Low: 'Low',
    Medium: 'Medium',
    High: 'High',
    VeryHigh: 'VeryHigh'
  }),e.registerEnum('Network.RequestReferrerPolicy', {
  ...
  }),e.registerEnum('Network.CertificateTransparencyCompliance', {
    Unknown: 'unknown',
    NotCompliant: 'not-compliant',
    Compliant: 'compliant'
  }),e.registerEnum('Network.BlockedReason', {
    Other: 'other',
    Csp: 'csp',
  ...
  }),e.registerEnum('Network.CorsError', {
  ...
  }),e.registerEnum('Network.ServiceWorkerResponseSource', {
    CacheStorage: 'cache-storage',
    HttpCache: 'http-cache',
    FallbackCode: 'fallback-code',
    Network: 'network'
  }),e.registerEnum('Network.TrustTokenParamsRefreshPolicy', {
    UseCached: 'UseCached',
    Refresh: 'Refresh'
  }),e.registerEnum('Network.TrustTokenOperationType', {
    Issuance: 'Issuance',
    Redemption: 'Redemption',
    Signing: 'Signing'
  }),e.registerEnum('Network.AlternateProtocolUsage', {
  ...
  }),e.registerEnum('Network.ServiceWorkerRouterSource', {
    Network: 'network',
    Cache: 'cache',
    FetchEvent: 'fetch-event',
    RaceNetworkAndFetchHandler: 'race-network-and-fetch-handler'
  }),e.registerEnum('Network.InitiatorType', {
    Parser: 'parser',
    Script: 'script',
    Preload: 'preload',
    SignedExchange: 'SignedExchange',
    Preflight: 'preflight',
    Other: 'other'
  }),e.registerEnum('Network.SetCookieBlockedReason', {
  ...
  }),e.registerEnum('Network.CookieBlockedReason', {
    SecureOnly: 'SecureOnly',
    NotOnPath: 'NotOnPath',
    ...
    SamePartyFromCrossPartyContext: 'SamePartyFromCrossPartyContext',
    NameValuePairExceedsMaxSize: 'NameValuePairExceedsMaxSize'
  }),e.registerEnum('Network.CookieExemptionReason', {
    None: 'None',
    ...
    CorsOptIn: 'CorsOptIn',
    Scheme: 'Scheme'
  }),e.registerEnum('Network.AuthChallengeSource', {
    Server: 'Server',
    Proxy: 'Proxy'
  }),e.registerEnum('Network.AuthChallengeResponseResponse', {
    Default: 'Default',
    CancelAuth: 'CancelAuth',
    ProvideCredentials: 'ProvideCredentials'
  }),e.registerEnum('Network.InterceptionStage', {
    Request: 'Request',
    HeadersReceived: 'HeadersReceived'
  }),e.registerEnum('Network.SignedExchangeErrorField', {
  ...
  }),e.registerEnum('Network.ContentEncoding', {
    Deflate: 'deflate',
    Gzip: 'gzip',
    Br: 'br',
    Zstd: 'zstd'
  }),e.registerEnum('Network.PrivateNetworkRequestPolicy', {
    Allow: 'Allow',
    BlockFromInsecureToMorePrivate: 'BlockFromInsecureToMorePrivate',
    WarnFromInsecureToMorePrivate: 'WarnFromInsecureToMorePrivate',
    PreflightBlock: 'PreflightBlock',
    PreflightWarn: 'PreflightWarn'
  }),e.registerEnum('Network.IPAddressSpace', {
    Local: 'Local',
    Private: 'Private',
    Public: 'Public',
    Unknown: 'Unknown'
  }),e.registerEnum('Network.CrossOriginOpenerPolicyValue', {
    ...
    type: 'object',
    optional: !0,
    description: 'If specified, deletes only cookies with the the given name and partitionKey where all partition key attributes match the cookie partition key attribute.',
    typeRef: 'Network.CookiePartitionKey'
  }], [], 'Deletes browser cookies with matching name and url or domain/path/partitionKey pair.'),e.registerCommand('Network.disable', [], [], 'Disables network tracking, prevents network events from being sent to the client.'),e.registerCommand('Network.emulateNetworkConditions', [{
    name: 'offline',
    type: 'boolean',
    optional: !1,
    ...
    typeRef: 'Network.ConnectionType'
  }, {
    name: 'packetLoss',
    type: 'number',
    optional: !0,
    ...
    typeRef: null
  }], [], 'Activates emulation of network conditions.'),e.registerCommand('Network.enable', [{
    ...
    typeRef: null
  }], [], 'Enables network tracking, network events will now be delivered to the client.'),e.registerCommand('Network.getAllCookies', [], ['cookies'], 'Returns all browser cookies. Depending on the backend support, will return detailed cookie information in the `cookies` field. Deprecated. Use Storage.getCookies instead.'),e.registerCommand('Network.getCertificate', [{
    name: 'origin',
    type: 'string',
    optional: !1,
    description: 'Origin to get certificate for.',
    typeRef: null
  }], ['tableNames'], 'Returns the DER-encoded certificate.'),e.registerCommand('Network.getCookies', [{
    name: 'urls',
    type: 'array',
    optional: !0,
    description: 'The list of URLs for which applicable cookies will be fetched. If not specified, it\'s assumed to be set to the list containing the URLs of the page and all of its subframes.',
    typeRef: 'string'
  }], ['cookies'], 'Returns all browser cookies for the current URL. Depending on the backend support, will return detailed cookie information in the `cookies` field.'),e.registerCommand('Network.getResponseBody', [{
    name: 'requestId',
    type: 'string',
    optional: !1,
    description: 'Identifier of the network request to get content for.',
    typeRef: 'Network.RequestId'
  }], ['body', 'base64Encoded'], 'Returns content served for the given request.'),e.registerCommand('Network.getRequestPostData', [{
    name: 'requestId',
    type: 'string',
    optional: !1,
    description: 'Identifier of the network request to get content for.',
    typeRef: 'Network.RequestId'
  }], ['postData'], 'Returns post data sent with the request. Returns an error when no data was sent with the request.'),e.registerCommand('Network.getResponseBodyForInterception', [{
    name: 'interceptionId',
    type: 'string',
    optional: !1,
    description: 'Identifier for the intercepted request to get body for.',
    typeRef: 'Network.InterceptionId'
  }], ['body', 'base64Encoded'], 'Returns content served for the given currently intercepted request.'),e.registerCommand('Network.takeResponseBodyForInterceptionAsStream', [{
    name: 'interceptionId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Network.InterceptionId'
  }], ['stream'], 'Returns a handle to the stream representing the response body. Note that after this command, the intercepted request can\'t be continued as is -- you either need to cancel it or to provide the response body. The stream only supports sequential read, IO.read will fail if the position is specified.'),e.registerCommand('Network.replayXHR', [{
    name: 'requestId',
    type: 'string',
    optional: !1,
    description: 'Identifier of XHR to replay.',
    typeRef: 'Network.RequestId'
  }], [], 'This method sends a new XMLHttpRequest which is identical to the original one. The following parameters should be identical: method, url, async, request body, extra headers, withCredentials attribute, user, password.'),e.registerCommand('Network.searchInResponseBody', [{
    name: 'requestId',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }], ['result'], 'Searches for given string in response content.'),e.registerCommand('Network.setBlockedURLs', [{
    name: 'urls',
    type: 'array',
    optional: !1,
    description: 'URL patterns to block. Wildcards (\'*\') are allowed.',
    typeRef: 'string'
  }], [], 'Blocks URLs from loading.'),e.registerCommand('Network.setBypassServiceWorker', [{
    name: 'bypass',
    type: 'boolean',
    optional: !1,
    description: 'Bypass service worker and load from network.',
    typeRef: null
  }], [], 'Toggles ignoring of service worker for each request.'),e.registerCommand('Network.setCacheDisabled', [{
    name: 'cacheDisabled',
    type: 'boolean',
    optional: !1,
    description: 'Cache disabled state.',
    typeRef: null
  }], [], 'Toggles ignoring cache for each request. If `true`, cache will not be used.'),e.registerCommand('Network.setCookie', [{
    name: 'name',
    type: 'string',
    optional: !1,
    description: 'Cookie name.',
    typeRef: null
  }, { name: 'value', type: 'string', optional: !1, description: 'Cookie value.', typeRef: null }, {
    name: 'url',
    type: 'string',
    optional: !0,
    ...
    typeRef: null
  }, { name: 'domain', type: 'string', optional: !0, description: 'Cookie domain.', typeRef: null }, {
    name: 'path',
    type: 'string',
    optional: !0,
    ...
    typeRef: 'Network.CookieSameSite'
  }, {
    name: 'expires',
    type: 'number',
    optional: !0,
    ...
    typeRef: 'Network.CookiePriority'
  }, {
    name: 'sameParty',
    type: 'boolean',
    optional: !0,
    ...
    typeRef: 'Network.CookieSourceScheme'
  }, {
    name: 'sourcePort',
    type: 'number',
    optional: !0,
    ...
    typeRef: 'Network.CookiePartitionKey'
  }], ['success'], 'Sets a cookie with the given cookie data; may overwrite equivalent cookies if they exist.'),e.registerCommand('Network.setCookies', [{
    name: 'cookies',
    type: 'array',
    optional: !1,
    description: 'Cookies to be set.',
    typeRef: 'Network.CookieParam'
  }], [], 'Sets given cookies.'),e.registerCommand('Network.setExtraHTTPHeaders', [{
    name: 'headers',
    type: 'object',
    optional: !1,
    description: 'Map with extra HTTP headers.',
    typeRef: 'Network.Headers'
  }], [], 'Specifies whether to always send extra HTTP headers with the requests from this page.'),e.registerCommand('Network.setAttachDebugStack', [{
    name: 'enabled',
    type: 'boolean',
    optional: !1,
    description: 'Whether to attach a page script stack for debugging purpose.',
    typeRef: null
  }], [], 'Specifies whether to attach a page script stack id in requests'),e.registerCommand('Network.setRequestInterception', [{
    name: 'patterns',
    type: 'array',
    optional: !1,
    ...
    typeRef: 'Network.RequestPattern'
  }], [], 'Sets the requests to intercept that match the provided patterns and optionally resource types. Deprecated, please use Fetch.enable instead.'),e.registerCommand('Network.setUserAgentOverride', [{
    name: 'userAgent',
    type: 'string',
    optional: !1,
    description: 'User agent to use.',
    ...
    description: 'To be sent in Sec-CH-UA-* headers and returned in navigator.userAgentData',
    typeRef: 'Emulation.UserAgentMetadata'
  }], [], 'Allows overriding user agent with the given string.'),e.registerCommand('Network.streamResourceContent', [{
    name: 'requestId',
    type: 'string',
    optional: !1,
    description: 'Identifier of the request to stream.',
    typeRef: 'Network.RequestId'
  }], ['bufferedData'], 'Enables streaming of the response for the given requestId. If enabled, the dataReceived event contains the data that was received during streaming.'),e.registerCommand('Network.getSecurityIsolationStatus', [{
    name: 'frameId',
    type: 'string',
    optional: !0,
    description: 'If no frameId is provided, the status of the target is provided.',
    typeRef: 'Page.FrameId'
  }], ['status'], 'Returns information about the COEP/COOP isolation status.'),e.registerCommand('Network.enableReportingApi', [{
    name: 'enable',
    type: 'boolean',
    optional: !1,
    description: 'Whether to enable or disable events for the Reporting API',
    typeRef: null
  }], [], 'Enables tracking for the Reporting API, events generated by the Reporting API will now be delivered to the client. Enabling triggers \'reportingApiReportAdded\' for all existing reports.'),e.registerCommand('Network.loadNetworkResource', [{
    name: 'frameId',
    type: 'string',
    optional: !0,
    ...
    typeRef: 'Network.LoadNetworkResourceOptions'
  }], ['resource'], 'Fetches the resource and returns the content.'),e.registerType('Network.ResourceTiming', [{
    name: 'requestTime',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Network.PostDataEntry', [{
    name: 'bytes',
    type: 'string',
    optional: !0,
    description: '',
    typeRef: null
  }]),e.registerType('Network.Request', [{
    name: 'url',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Network.PostDataEntry'
  }, {
    name: 'mixedContentType',
    type: 'string',
    optional: !0,
    description: 'The mixed content type of the request.',
    typeRef: 'Security.MixedContentType'
  }, {
    name: 'initialPriority',
    type: 'string',
    optional: !1,
    description: 'Priority of the resource request at the time request is sent.',
    typeRef: 'Network.ResourcePriority'
  }, {
    name: 'referrerPolicy',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Network.TrustTokenParams'
  }, {
    name: 'isSameSite',
    type: 'boolean',
    optional: !0,
    ...
    typeRef: null
  }]),e.registerType('Network.SignedCertificateTimestamp', [{
    name: 'status',
    type: 'string',
    optional: !1,
    description: 'Validation status.',
    typeRef: null
  }, { name: 'origin', type: 'string', optional: !1, description: 'Origin.', typeRef: null }, {
    name: 'logDescription',
    type: 'string',
    optional: !1,
    description: 'Log name / description.',
    typeRef: null
  }, { name: 'logId', type: 'string', optional: !1, description: 'Log ID.', typeRef: null }, {
    name: 'timestamp',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Network.SecurityDetails', [{
    name: 'protocol',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }, { name: 'cipher', type: 'string', optional: !1, description: 'Cipher name.', typeRef: null }, {
    name: 'mac',
    type: 'string',
    optional: !0,
    ...
    typeRef: 'Security.CertificateId'
  }, {
    name: 'subjectName',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Network.CorsErrorStatus', [{
    name: 'corsError',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Network.CorsError'
  }, {
    ...
    description: '',
    typeRef: null
  }]),e.registerType('Network.TrustTokenParams', [{
    name: 'operation',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Network.TrustTokenOperationType'
  }, {
    name: 'refreshPolicy',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'string'
  }]),e.registerType('Network.ServiceWorkerRouterInfo', [{
    name: 'ruleIdMatched',
    type: 'number',
    optional: !0,
    ...
    typeRef: 'Network.ServiceWorkerRouterSource'
  }, {
    ...
    typeRef: 'Network.ServiceWorkerRouterSource'
  }]),e.registerType('Network.Response', [{
    name: 'url',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Network.ServiceWorkerRouterInfo'
  }, {
    ...
    typeRef: 'Network.AlternateProtocolUsage'
  }, {
    name: 'securityState',
    type: 'string',
    optional: !1,
    description: 'Security state of the request resource.',
    typeRef: 'Security.SecurityState'
  }, {
  ...
  }]),e.registerType('Network.WebSocketRequest', [{
    name: 'headers',
    type: 'object',
    optional: !1,
    description: 'HTTP request headers.',
    ...
    typeRef: null
  }]),e.registerType('Network.WebSocketFrame', [{
    name: 'opcode',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Network.CachedResource', [{
    name: 'url',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Network.ResourceType'
  }, {
    name: 'response',
    type: 'object',
    optional: !0,
    description: 'Cached response data.',
    typeRef: 'Network.Response'
  }, {
    name: 'bodySize',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Network.Initiator', [{
    name: 'type',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Network.RequestId'
  }]),e.registerType('Network.CookiePartitionKey', [{
    name: 'topLevelSite',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }, { name: 'path', type: 'string', optional: !1, description: 'Cookie path.', typeRef: null }, {
    name: 'expires',
    type: 'number',
    optional: !1,
    description: 'Cookie expiration date as the number of seconds since the UNIX epoch.',
    typeRef: null
  }, { name: 'size', type: 'number', optional: !1, description: 'Cookie size.', typeRef: null }, {
    name: 'httpOnly',
    type: 'boolean',
    optional: !1,
    description: 'True if cookie is http-only.',
    ...
    typeRef: null
  }]),e.registerType('Network.BlockedSetCookieWithReason', [{
    name: 'blockedReasons',
    type: 'array',
    optional: !1,
    description: 'The reason(s) this cookie was blocked.',
    typeRef: 'Network.SetCookieBlockedReason'
  }, {
    name: 'cookieLine',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Network.Cookie'
  }]),e.registerType('Network.ExemptedSetCookieWithReason', [{
    name: 'exemptionReason',
    type: 'string',
    optional: !1,
    description: 'The reason the cookie was exempted.',
    typeRef: 'Network.CookieExemptionReason'
  }, {
    name: 'cookieLine',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Network.Cookie'
  }]),e.registerType('Network.AssociatedCookie', [{
    name: 'cookie',
    type: 'object',
    optional: !1,
    ...
    typeRef: 'Network.CookieBlockedReason'
  }, {
    name: 'exemptionReason',
    type: 'string',
    optional: !0,
    ...
    typeRef: 'Network.CookieExemptionReason'
  }]),e.registerType('Network.CookieParam', [{
    name: 'name',
    type: 'string',
    optional: !1,
    description: 'Cookie name.',
    ...
    description: 'Cookie partition key. If not set, the cookie will be set as not partitioned.',
    typeRef: 'Network.CookiePartitionKey'
  }]),e.registerType('Network.AuthChallenge', [{
    name: 'source',
    type: 'string',
    optional: !0,
    ...
    typeRef: null
  }]),e.registerType('Network.AuthChallengeResponse', [{
    name: 'response',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Network.RequestPattern', [{
    name: 'urlPattern',
    type: 'string',
    optional: !0,
  ...
  }]),e.registerType('Network.SignedExchangeSignature', [{
    name: 'label',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'string'
  }]),e.registerType('Network.SignedExchangeHeader', [{
    name: 'requestUrl',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Network.SignedExchangeSignature'
  }, {
    ...
    typeRef: null
  }]),e.registerType('Network.SignedExchangeError', [{
    name: 'message',
    type: 'string',
    optional: !1,
    description: 'Error message.',
    ...
    typeRef: 'Network.SignedExchangeErrorField'
  }]),e.registerType('Network.SignedExchangeInfo', [{
    name: 'outerResponse',
    type: 'object',
    optional: !1,
    ...
    typeRef: 'Network.SignedExchangeHeader'
  }, {
    name: 'securityDetails',
    type: 'object',
    optional: !0,
    ...
    typeRef: 'Network.SignedExchangeError'
  }]),e.registerType('Network.ConnectTiming', [{
    name: 'requestTime',
    type: 'number',
    optional: !1,
    ...
    optional: !1,
    description: '',
    typeRef: 'Network.PrivateNetworkRequestPolicy'
  }]),e.registerType('Network.CrossOriginOpenerPolicyStatus', [{
    name: 'value',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Network.CrossOriginOpenerPolicyValue'
  }, {
    ...
    optional: !1,
    description: '',
    typeRef: 'Network.CrossOriginEmbedderPolicyValue'
  }, {
    name: 'reportOnlyValue',
    type: 'string',
    optional: !1,
    ...
    description: '',
    typeRef: null
  }]),e.registerType('Network.ContentSecurityPolicyStatus', [{
    ...
    optional: !1,
    description: '',
    typeRef: 'Network.ContentSecurityPolicySource'
  }]),e.registerType('Network.SecurityIsolationStatus', [{
    name: 'coop',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Network.CrossOriginOpenerPolicyStatus'
  }, {
    name: 'coep',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Network.CrossOriginEmbedderPolicyStatus'
  }, {
    name: 'csp',
    type: 'array',
    optional: !0,
    description: '',
    typeRef: 'Network.ContentSecurityPolicyStatus'
  }]),e.registerType('Network.ReportingApiReport', [{
    name: 'id',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Network.ReportId'
  }, {
    name: 'initiatorUrl',
    type: 'string',
    optional: !1,
    ...
    optional: !1,
    description: '',
    typeRef: 'Network.ReportStatus'
  }]),e.registerType('Network.ReportingApiEndpoint', [{
    name: 'url',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Network.LoadNetworkResourcePageResult', [{
    name: 'success',
    type: 'boolean',
    optional: !1,
    description: '',
    ...
    typeRef: null
  }, { name: 'netErrorName', type: 'string', optional: !0, description: '', typeRef: null }, {
    name: 'httpStatusCode',
    type: 'number',
    optional: !0,
    description: '',
    ...
    description: 'Response headers.',
    typeRef: 'Network.Headers'
  }]),e.registerType('Network.LoadNetworkResourceOptions', [{
    name: 'disableCache',
    type: 'boolean',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }]),e.registerEnum('Overlay.LineStylePattern', {
    Dashed: 'dashed',
    Dotted: 'dotted'
  }),e.registerEnum('Overlay.ContrastAlgorithm', {
    Aa: 'aa',
    Aaa: 'aaa',
    Apca: 'apca'
  }),e.registerEnum('Overlay.ColorFormat', {
    Rgb: 'rgb',
    Hsl: 'hsl',
    Hwb: 'hwb',
    Hex: 'hex'
  }),e.registerEnum('Overlay.InspectMode', {
    SearchForNode: 'searchForNode',
    SearchForUAShadowDOM: 'searchForUAShadowDOM',
    CaptureAreaScreenshot: 'captureAreaScreenshot',
    ShowDistances: 'showDistances',
    None: 'none'
  }),e.registerEvent('Overlay.inspectNodeRequested', ['backendNodeId']),e.registerEvent('Overlay.nodeHighlightRequested', ['nodeId']),e.registerEvent('Overlay.screenshotRequested', ['viewport']),e.registerEvent('Overlay.inspectModeCanceled', []),e.registerCommand('Overlay.disable', [], [], 'Disables domain notifications.'),e.registerCommand('Overlay.enable', [], [], 'Enables domain notifications.'),e.registerCommand('Overlay.getHighlightObjectForTest', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'DOM.NodeId'
  }], ['highlights'], 'For Persistent Grid testing.'),e.registerCommand('Overlay.getSourceOrderHighlightObjectForTest', [{
    name: 'nodeId',
    type: 'number',
    optional: !1,
    description: 'Id of the node to highlight.',
    typeRef: 'DOM.NodeId'
  }], ['highlight'], 'For Source Order Viewer testing.'),e.registerCommand('Overlay.hideHighlight', [], [], 'Hides any highlight.'),e.registerCommand('Overlay.highlightFrame', [{
    name: 'frameId',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'DOM.RGBA'
  }], [], 'Highlights owner element of the frame with given id. Deprecated: Doesn\'t work reliably and cannot be fixed due to process separation (the owner node might be in a different process). Determine the owner node in the client and use highlightNode.'),e.registerCommand('Overlay.highlightNode', [{
    name: 'highlightConfig',
    type: 'object',
    optional: !1,
    description: 'A descriptor for the highlight appearance.',
    typeRef: 'Overlay.HighlightConfig'
  }, {
    name: 'nodeId',
    type: 'number',
    optional: !0,
    ...
    typeRef: null
  }], [], 'Highlights DOM node with given id or with the given JavaScript object wrapper. Either nodeId or objectId must be specified.'),e.registerCommand('Overlay.highlightQuad', [{
    name: 'quad',
    type: 'array',
    optional: !1,
    ...
    typeRef: 'DOM.RGBA'
  }], [], 'Highlights given quad. Coordinates are absolute with respect to the main frame viewport.'),e.registerCommand('Overlay.highlightRect', [{
    name: 'x',
    type: 'number',
    optional: !1,
    description: 'X coordinate',
    ...
    description: 'The highlight outline color (default: transparent).',
    typeRef: 'DOM.RGBA'
  }], [], 'Highlights given rectangle. Coordinates are absolute with respect to the main frame viewport.'),e.registerCommand('Overlay.highlightSourceOrder', [{
    name: 'sourceOrderConfig',
    type: 'object',
    optional: !1,
    description: 'A descriptor for the appearance of the overlay drawing.',
    typeRef: 'Overlay.SourceOrderConfig'
  }, {
    name: 'nodeId',
    type: 'number',
    optional: !0,
    ...
    description: 'JavaScript object id of the node to be highlighted.',
    typeRef: 'Runtime.RemoteObjectId'
  }], [], 'Highlights the source order of the children of the DOM node with given id or with the given JavaScript object wrapper. Either nodeId or objectId must be specified.'),e.registerCommand('Overlay.setInspectMode', [{
    name: 'mode',
    type: 'string',
    optional: !1,
    description: 'Set an inspection mode.',
    typeRef: 'Overlay.InspectMode'
  }, {
    name: 'highlightConfig',
    type: 'object',
    optional: !0,
    description: 'A descriptor for the highlight appearance of hovered-over nodes. May be omitted if `enabled == false`.',
    typeRef: 'Overlay.HighlightConfig'
  }], [], 'Enters the \'inspect\' mode. In this mode, elements that user is hovering over are highlighted. Backend then generates \'inspectNodeRequested\' event upon element selection.'),e.registerCommand('Overlay.setShowAdHighlights', [{
    name: 'show',
    type: 'boolean',
    optional: !1,
    description: 'True for showing ad highlights',
    typeRef: null
  }], [], 'Highlights owner element of all frames detected to be ads.'),e.registerCommand('Overlay.setPausedInDebuggerMessage', [{
    name: 'message',
    type: 'string',
    optional: !0,
    ...
    typeRef: null
  }], [], 'Requests that backend shows debug borders on layers'),e.registerCommand('Overlay.setShowFPSCounter', [{
    name: 'show',
    type: 'boolean',
    optional: !1,
    description: 'True for showing the FPS counter',
    typeRef: null
  }], [], 'Requests that backend shows the FPS counter'),e.registerCommand('Overlay.setShowGridOverlays', [{
    name: 'gridNodeHighlightConfigs',
    type: 'array',
    optional: !1,
    description: 'An array of node identifiers and descriptors for the highlight appearance.',
    typeRef: 'Overlay.GridNodeHighlightConfig'
  }], [], 'Highlight multiple elements with the CSS Grid overlay.'),e.registerCommand('Overlay.setShowFlexOverlays', [{
    name: 'flexNodeHighlightConfigs',
    type: 'array',
    optional: !1,
    description: 'An array of node identifiers and descriptors for the highlight appearance.',
    typeRef: 'Overlay.FlexNodeHighlightConfig'
  }], [], ''),e.registerCommand('Overlay.setShowScrollSnapOverlays', [{
    name: 'scrollSnapHighlightConfigs',
    type: 'array',
    optional: !1,
    description: 'An array of node identifiers and descriptors for the highlight appearance.',
    typeRef: 'Overlay.ScrollSnapHighlightConfig'
  }], [], ''),e.registerCommand('Overlay.setShowContainerQueryOverlays', [{
    name: 'containerQueryHighlightConfigs',
    type: 'array',
    optional: !1,
    description: 'An array of node identifiers and descriptors for the highlight appearance.',
    typeRef: 'Overlay.ContainerQueryHighlightConfig'
    ...
    typeRef: null
  }], [], 'Requests that backend shows paint rectangles'),e.registerCommand('Overlay.setShowLayoutShiftRegions', [{
    name: 'result',
    type: 'boolean',
    optional: !1,
    ...
    typeRef: null
  }], [], 'Requests that backend shows scroll bottleneck rects'),e.registerCommand('Overlay.setShowHitTestBorders', [{
    name: 'show',
    type: 'boolean',
    optional: !1,
    description: 'True for showing hit-test borders',
    typeRef: null
  }], [], 'Deprecated, no longer has any effect.'),e.registerCommand('Overlay.setShowWebVitals', [{
    name: 'show',
    type: 'boolean',
    optional: !1,
    description: '',
    typeRef: null
  }], [], 'Request that backend shows an overlay with web vital metrics.'),e.registerCommand('Overlay.setShowViewportSizeOnResize', [{
    name: 'show',
    type: 'boolean',
    optional: !1,
    description: 'Whether to paint size or not.',
    typeRef: null
  }], [], 'Paints viewport size upon main frame resize.'),e.registerCommand('Overlay.setShowHinge', [{
    name: 'hingeConfig',
    type: 'object',
    optional: !0,
    description: 'hinge data, null means hideHinge',
    typeRef: 'Overlay.HingeConfig'
  }], [], 'Add a dual screen device hinge'),e.registerCommand('Overlay.setShowIsolatedElements', [{
    name: 'isolatedElementHighlightConfigs',
    type: 'array',
    optional: !1,
    description: 'An array of node identifiers and descriptors for the highlight appearance.',
    typeRef: 'Overlay.IsolatedElementHighlightConfig'
  }], [], 'Show elements in isolation mode with overlays.'),e.registerCommand('Overlay.setShowWindowControlsOverlay', [{
    name: 'windowControlsOverlayConfig',
    type: 'object',
    optional: !0,
    description: 'Window Controls Overlay data, null means hide Window Controls Overlay',
    typeRef: 'Overlay.WindowControlsOverlayConfig'
  }], [], 'Show Window Controls Overlay for PWA'),e.registerType('Overlay.SourceOrderConfig', [{
    ...
    typeRef: 'DOM.RGBA'
  }]),e.registerType('Overlay.GridHighlightConfig', [{
    ...
    typeRef: 'DOM.RGBA'
  }]),e.registerType('Overlay.FlexContainerHighlightConfig', [{
    name: 'containerBorder',
    type: 'object',
    optional: !0,
    description: 'The style of the container border',
    typeRef: 'Overlay.LineStyle'
  }, {
    name: 'lineSeparator',
    type: 'object',
    optional: !0,
    ...
    typeRef: 'Overlay.LineStyle'
  }]),e.registerType('Overlay.FlexItemHighlightConfig', [{
    name: 'baseSizeBox',
    type: 'object',
    optional: !0,
    ...
    typeRef: 'Overlay.LineStyle'
  }]),e.registerType('Overlay.LineStyle', [{
    name: 'color',
    type: 'object',
    optional: !0,
    ...
    typeRef: null
  }]),e.registerType('Overlay.BoxStyle', [{
    name: 'fillColor',
    type: 'object',
    optional: !0,
    ...
    typeRef: 'DOM.RGBA'
  }]),e.registerType('Overlay.HighlightConfig', [{
    name: 'showInfo',
    type: 'boolean',
    optional: !0,
    ...
    typeRef: 'Overlay.ContainerQueryContainerHighlightConfig'
  }]),e.registerType('Overlay.GridNodeHighlightConfig', [{
    name: 'gridHighlightConfig',
    type: 'object',
    optional: !1,
    description: 'A descriptor for the highlight appearance.',
    ...
    description: 'Identifier of the node to highlight.',
    typeRef: 'DOM.NodeId'
  }]),e.registerType('Overlay.FlexNodeHighlightConfig', [{
    name: 'flexContainerHighlightConfig',
    type: 'object',
    optional: !1,
    ...
    description: 'Identifier of the node to highlight.',
    typeRef: 'DOM.NodeId'
  }]),e.registerType('Overlay.ScrollSnapContainerHighlightConfig', [{
    name: 'snapportBorder',
    type: 'object',
    optional: !0,
    ...
    description: 'Identifier of the node to highlight.',
    typeRef: 'DOM.NodeId'
  }]),e.registerType('Overlay.HingeConfig', [{
    name: 'rect',
    type: 'object',
    optional: !1,
    ...
    description: 'The content box highlight outline color (default: transparent).',
    typeRef: 'DOM.RGBA'
  }]),e.registerType('Overlay.WindowControlsOverlayConfig', [{
    name: 'showCSS',
    type: 'boolean',
    optional: !1,
    ...
    typeRef: 'DOM.NodeId'
  }]),e.registerType('Overlay.ContainerQueryContainerHighlightConfig', [{
    name: 'containerBorder',
    type: 'object',
    optional: !0,
    description: 'The style of the container border.',
    ...
    typeRef: 'DOM.NodeId'
  }]),e.registerType('Overlay.IsolationModeHighlightConfig', [{
    name: 'resizerColor',
    type: 'object',
    optional: !0,
  ...
  }),e.registerEnum('Page.PermissionsPolicyFeature', {
    Accelerometer: 'accelerometer',
  ...
  }),e.registerEnum('Page.OriginTrialStatus', {
    Enabled: 'Enabled',
    ValidTokenNotProvided: 'ValidTokenNotProvided',
    OSNotSupported: 'OSNotSupported',
    TrialNotAllowed: 'TrialNotAllowed'
  }),e.registerEnum('Page.OriginTrialUsageRestriction', {
    None: 'None',
    Subset: 'Subset'
  }),e.registerEnum('Page.TransitionType', {
    Link: 'link',
    Typed: 'typed',
    ...
    Other: 'other'
  }),e.registerEnum('Page.DialogType', {
    Alert: 'alert',
    Confirm: 'confirm',
    Prompt: 'prompt',
    Beforeunload: 'beforeunload'
  }),e.registerEnum('Page.ClientNavigationReason', {
  ...
  }),e.registerEnum('Page.ClientNavigationDisposition', {
    CurrentTab: 'currentTab',
    NewTab: 'newTab',
    NewWindow: 'newWindow',
    Download: 'download'
  }),e.registerEnum('Page.ReferrerPolicy', {
  ...
  }),e.registerEnum('Page.NavigationType', {
    Navigation: 'Navigation',
    BackForwardCacheRestore: 'BackForwardCacheRestore'
  }),e.registerEnum('Page.BackForwardCacheNotRestoredReason', {
  ...
  }),e.registerEnum('Page.BackForwardCacheNotRestoredReasonType', {
    SupportPending: 'SupportPending',
    PageSupportNeeded: 'PageSupportNeeded',
    Circumstantial: 'Circumstantial'
  }),e.registerEvent('Page.domContentEventFired', ['timestamp']),e.registerEnum('Page.FileChooserOpenedEventMode', {
    SelectSingle: 'selectSingle',
    SelectMultiple: 'selectMultiple'
  }),e.registerEvent('Page.fileChooserOpened', ['frameId', 'mode', 'backendNodeId']),e.registerEvent('Page.frameAttached', ['frameId', 'parentFrameId', 'stack']),e.registerEvent('Page.frameClearedScheduledNavigation', ['frameId']),e.registerEnum('Page.FrameDetachedEventReason', {
    Remove: 'remove',
    Swap: 'swap'
  }),e.registerEvent('Page.frameDetached', ['frameId', 'reason']),e.registerEvent('Page.frameNavigated', ['frame', 'type']),e.registerEvent('Page.documentOpened', ['frame']),e.registerEvent('Page.frameResized', []),e.registerEvent('Page.frameRequestedNavigation', ['frameId', 'reason', 'url', 'disposition']),e.registerEvent('Page.frameScheduledNavigation', ['frameId', 'delay', 'reason', 'url']),e.registerEvent('Page.frameStartedLoading', ['frameId']),e.registerEvent('Page.frameStoppedLoading', ['frameId']),e.registerEvent('Page.downloadWillBegin', ['frameId', 'guid', 'url', 'suggestedFilename']),e.registerEnum('Page.DownloadProgressEventState', {
    InProgress: 'inProgress',
    Completed: 'completed',
    Canceled: 'canceled'
  }),e.registerEvent('Page.downloadProgress', ['guid', 'totalBytes', 'receivedBytes', 'state']),e.registerEvent('Page.interstitialHidden', []),e.registerEvent('Page.interstitialShown', []),e.registerEvent('Page.javascriptDialogClosed', ['result', 'userInput']),e.registerEvent('Page.javascriptDialogOpening', ['url', 'message', 'type', 'hasBrowserHandler', 'defaultPrompt']),e.registerEvent('Page.lifecycleEvent', ['frameId', 'loaderId', 'name', 'timestamp']),e.registerEvent('Page.backForwardCacheNotUsed', ['loaderId', 'frameId', 'notRestoredExplanations', 'notRestoredExplanationsTree']),e.registerEvent('Page.loadEventFired', ['timestamp']),e.registerEnum('Page.NavigatedWithinDocumentEventNavigationType', {
    Fragment: 'fragment',
    HistoryAPI: 'historyApi',
    Other: 'other'
  }),e.registerEvent('Page.navigatedWithinDocument', ['frameId', 'url', 'navigationType']),e.registerEvent('Page.screencastFrame', ['data', 'metadata', 'sessionId']),e.registerEvent('Page.screencastVisibilityChanged', ['visible']),e.registerEvent('Page.windowOpen', ['url', 'windowName', 'windowFeatures', 'userGesture']),e.registerEvent('Page.compilationCacheProduced', ['url', 'data']),e.registerCommand('Page.addScriptToEvaluateOnLoad', [{
    name: 'scriptSource',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], ['identifier'], 'Deprecated, please use addScriptToEvaluateOnNewDocument instead.'),e.registerCommand('Page.addScriptToEvaluateOnNewDocument', [{
    name: 'source',
    type: 'string',
    optional: !1,
    description: '',
    ...
    type: 'string',
    optional: !0,
    description: 'If specified, creates an isolated world with the given name and evaluates given script in it. This world name will be used as the ExecutionContextDescription::name when the corresponding event is emitted.',
    typeRef: null
  }, {
    name: 'includeCommandLineAPI',
    type: 'boolean',
    optional: !0,
    description: 'Specifies whether command line API should be available to the script, defaults to false.',
    typeRef: null
  }, {
    name: 'runImmediately',
    type: 'boolean',
    optional: !0,
    description: 'If true, runs the script immediately on existing execution contexts or worlds. Default: false.',
    typeRef: null
  }], ['identifier'], 'Evaluates given script in every frame upon creation (before loading frame\'s scripts).'),e.registerCommand('Page.bringToFront', [], [], 'Brings page to front (activates tab).'),e.registerEnum('Page.CaptureScreenshotRequestFormat', {
    Jpeg: 'jpeg',
    Png: 'png',
    Webp: 'webp'
  }),e.registerCommand('Page.captureScreenshot', [{
    name: 'format',
    type: 'string',
    optional: !0,
    description: 'Image compression format (defaults to png).',
    typeRef: 'Page.CaptureScreenshotRequestFormat'
  }, {
    name: 'quality',
    type: 'number',
    optional: !0,
    ...
    description: 'Optimize image encoding for speed, not for resulting size (defaults to false)',
    typeRef: null
  }], ['data'], 'Capture page screenshot.'),e.registerEnum('Page.CaptureSnapshotRequestFormat', { MHTML: 'mhtml' }),e.registerCommand('Page.captureSnapshot', [{
    name: 'format',
    type: 'string',
    optional: !0,
    description: 'Format (defaults to mhtml).',
    typeRef: 'Page.CaptureSnapshotRequestFormat'
    ...
    typeRef: null
  }], ['executionContextId'], 'Creates an isolated world for the given frame.'),e.registerCommand('Page.deleteCookie', [{
    name: 'cookieName',
    type: 'string',
    optional: !1,
  ...
  e.registerCommand('Page.getFrameTree', [], ['frameTree'], 'Returns present frame tree structure.'), e.registerCommand('Page.getLayoutMetrics', [], ['layoutViewport', 'visualViewport', 'contentSize', 'cssLayoutViewport', 'cssVisualViewport', 'cssContentSize'], 'Returns metrics relating to the layouting of the page, such as viewport bounds/scale.'), e.registerCommand('Page.getNavigationHistory', [], ['currentIndex', 'entries'], 'Returns navigation history for the current page.'), e.registerCommand('Page.resetNavigationHistory', [], [], 'Resets navigation history for the current page.'), e.registerCommand('Page.getResourceContent', [{
    ...
    description: 'URL of the resource to get content for.',
    typeRef: null
  }], ['content', 'base64Encoded'], 'Returns content of the given resource.'), e.registerCommand('Page.getResourceTree', [], ['frameTree'], 'Returns present frame / resource tree structure.'), e.registerCommand('Page.handleJavaScriptDialog', [{
    name: 'accept',
    type: 'boolean',
    optional: !1,
    ...
    typeRef: null
  }], [], 'Accepts or dismisses a JavaScript initiated dialog (alert, confirm, prompt, or onbeforeunload).'), e.registerCommand('Page.navigate', [{
    name: 'url',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Page.ReferrerPolicy'
  }], ['frameId', 'loaderId', 'errorText'], 'Navigates current page to the given URL.'), e.registerCommand('Page.navigateToHistoryEntry', [{
    name: 'entryId',
    type: 'number',
    optional: !1,
    description: 'Unique id of the entry to navigate to.',
    typeRef: null
  }], [], 'Navigates current page to the given history entry.'), e.registerEnum('Page.PrintToPDFRequestTransferMode', {
    ReturnAsBase64: 'ReturnAsBase64',
    ReturnAsStream: 'ReturnAsStream'
  }), e.registerCommand('Page.printToPDF', [{
    name: 'landscape',
    type: 'boolean',
    optional: !0,
    ...
    typeRef: 'Page.PrintToPDFRequestTransferMode'
  }, {
    ...
    typeRef: null
  }], ['data', 'stream'], 'Print page as PDF.'), e.registerCommand('Page.reload', [{
    name: 'ignoreCache',
    type: 'boolean',
    optional: !0,
    ...
    type: 'string',
    optional: !0,
    description: 'If set, the script will be injected into all frames of the inspected page after reload. Argument will be ignored if reloading dataURL origin.',
    typeRef: null
  }, {
    name: 'loaderId',
    type: 'string',
    optional: !0,
    description: 'If set, an error will be thrown if the target page\'s main frame\'s loader id does not match the provided id. This prevents accidentally reloading an unintended target in case there\'s a racing navigation.',
    typeRef: 'Network.LoaderId'
  }], [], 'Reloads given page optionally ignoring the cache.'), e.registerCommand('Page.removeScriptToEvaluateOnLoad', [{
    name: 'identifier',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Page.ScriptIdentifier'
  }], [], 'Deprecated, please use removeScriptToEvaluateOnNewDocument instead.'), e.registerCommand('Page.removeScriptToEvaluateOnNewDocument', [{
    name: 'identifier',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Page.ScriptIdentifier'
  }], [], 'Removes given script from the list.'), e.registerCommand('Page.screencastFrameAck', [{
    name: 'sessionId',
    type: 'number',
    optional: !1,
    description: 'Frame number.',
    typeRef: null
  }], [], 'Acknowledges that a screencast frame has been received by the frontend.'), e.registerCommand('Page.searchInResource', [{
    name: 'frameId',
    type: 'string',
    optional: !1,
    ...
    description: 'If true, treats string parameter as regex.',
    typeRef: null
  }], ['result'], 'Searches for given string in resource content.'), e.registerCommand('Page.setAdBlockingEnabled', [{
    name: 'enabled',
    type: 'boolean',
    optional: !1,
    description: 'Whether to block ads.',
    typeRef: null
  }], [], 'Enable Chrome\'s experimental ad filter on all sites.'), e.registerCommand('Page.setBypassCSP', [{
    name: 'enabled',
    type: 'boolean',
    optional: !1,
    description: 'Whether to bypass page CSP.',
    typeRef: null
  }], [], 'Enable page Content Security Policy by-passing.'), e.registerCommand('Page.getPermissionsPolicyState', [{
    name: 'frameId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Page.FrameId'
  }], ['states'], 'Get Permissions Policy state on given frame.'), e.registerCommand('Page.getOriginTrials', [{
    name: 'frameId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Page.FrameId'
  }], ['originTrials'], 'Get Origin Trials on given frame.'), e.registerCommand('Page.setDeviceMetricsOverride', [{
    name: 'width',
    type: 'number',
    optional: !1,
    description: 'Overriding width value in pixels (minimum 0, maximum 10000000). 0 disables the override.',
    ...
    typeRef: 'Page.Viewport'
  }], [], 'Overrides the values of device screen dimensions (window.screen.width, window.screen.height, window.innerWidth, window.innerHeight, and "device-width"/"device-height"-related CSS media query results).'), e.registerCommand('Page.setDeviceOrientationOverride', [{
    name: 'alpha',
    type: 'number',
    optional: !1,
    description: 'Mock alpha',
    ...
    description: 'Mock gamma',
    typeRef: null
  }], [], 'Overrides the Device Orientation.'), e.registerCommand('Page.setFontFamilies', [{
    name: 'fontFamilies',
    type: 'object',
    optional: !1,
    description: 'Specifies font families to set. If a font family is not specified, it won\'t be changed.',
    typeRef: 'Page.FontFamilies'
  }, {
    name: 'forScripts',
    type: 'array',
    optional: !0,
    description: 'Specifies font families to set for individual scripts.',
    typeRef: 'Page.ScriptFontFamilies'
  }], [], 'Set generic font families.'), e.registerCommand('Page.setFontSizes', [{
    name: 'fontSizes',
    type: 'object',
    optional: !1,
    description: 'Specifies font sizes to set. If a font size is not specified, it won\'t be changed.',
    typeRef: 'Page.FontSizes'
  }], [], 'Set default font sizes.'), e.registerCommand('Page.setDocumentContent', [{
    name: 'frameId',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }], [], 'Sets given markup as the document\'s HTML.'), e.registerEnum('Page.SetDownloadBehaviorRequestBehavior', {
    Deny: 'deny',
    Allow: 'allow',
    Default: 'default'
  }), e.registerCommand('Page.setDownloadBehavior', [{
    name: 'behavior',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Page.SetDownloadBehaviorRequestBehavior'
  }, {
    name: 'downloadPath',
    type: 'string',
    optional: !0,
    ...
    typeRef: null
  }], [], 'Set the behavior when downloading a file.'), e.registerCommand('Page.setGeolocationOverride', [{
    name: 'latitude',
    type: 'number',
    optional: !0,
    description: 'Mock latitude',
    ...
    description: 'Mock accuracy',
    typeRef: null
  }], [], 'Overrides the Geolocation Position or Error. Omitting any of the parameters emulates position unavailable.'), e.registerCommand('Page.setLifecycleEventsEnabled', [{
    name: 'enabled',
    type: 'boolean',
    optional: !1,
    ...
    Mobile: 'mobile',
    Desktop: 'desktop'
  }), e.registerCommand('Page.setTouchEmulationEnabled', [{
    name: 'enabled',
    type: 'boolean',
    optional: !1,
    description: 'Whether the touch event emulation should be enabled.',
    ...
    optional: !0,
    description: 'Touch/gesture events configuration. Default: current platform.',
    typeRef: 'Page.SetTouchEmulationEnabledRequestConfiguration'
  }], [], 'Toggles mouse event-based touch event emulation.'), e.registerEnum('Page.StartScreencastRequestFormat', {
    Jpeg: 'jpeg',
    Png: 'png'
  }), e.registerCommand('Page.startScreencast', [{
    name: 'format',
    type: 'string',
    optional: !0,
    description: 'Image compression format.',
    typeRef: 'Page.StartScreencastRequestFormat'
  }, {
    name: 'quality',
    type: 'number',
    optional: !0,
    ...
    typeRef: null
  }], [], 'Starts sending each frame using the `screencastFrame` event.'), e.registerCommand('Page.stopLoading', [], [], 'Force the page stop all navigations and pending resource fetches.'), e.registerCommand('Page.crash', [], [], 'Crashes renderer on the IO thread, generates minidumps.'), e.registerCommand('Page.close', [], [], 'Tries to close page, running its beforeunload hooks, if any.'), e.registerEnum('Page.SetWebLifecycleStateRequestState', {
    Frozen: 'frozen',
    Active: 'active'
  }), e.registerCommand('Page.setWebLifecycleState', [{
    name: 'state',
    type: 'string',
    optional: !1,
    description: 'Target lifecycle state',
    typeRef: 'Page.SetWebLifecycleStateRequestState'
  }], [], 'Tries to update the web lifecycle state of the page. It will transition the page to the given state according to: https://github.com/WICG/web-lifecycle/'), e.registerCommand('Page.stopScreencast', [], [], 'Stops sending each frame in the `screencastFrame`.'), e.registerCommand('Page.produceCompilationCache', [{
    name: 'scripts',
    type: 'array',
    optional: !1,
    description: '',
    typeRef: 'Page.CompilationCacheParams'
  }], [], 'Requests backend to produce compilation cache for the specified scripts. `scripts` are appended to the list of scripts for which the cache would be produced. The list may be reset during page navigation. When script with a matching URL is encountered, the cache is optionally produced upon backend discretion, based on internal heuristics. See also: `Page.compilationCacheProduced`.'), e.registerCommand('Page.addCompilationCache', [{
    name: 'url',
    type: 'string',
    optional: !1,
    description: '',
    ...
    typeRef: null
  }], [], 'Seeds compilation cache for given url. Compilation cache does not survive cross-process navigation.'), e.registerCommand('Page.clearCompilationCache', [], [], 'Clears seeded compilation cache.'), e.registerCommand('Page.setSPCTransactionMode', [{
    name: 'mode',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Page.AutoResponseMode'
  }], [], 'Sets the Secure Payment Confirmation transaction mode. https://w3c.github.io/secure-payment-confirmation/#sctn-automation-set-spc-transaction-mode'), e.registerCommand('Page.setRPHRegistrationMode', [{
    name: 'mode',
    type: 'string',
    optional: !1,
    description: '',
    ...
    typeRef: null
  }], [], 'Generates a report for testing.'), e.registerCommand('Page.waitForDebugger', [], [], 'Pauses page execution. Can be resumed using generic Runtime.runIfWaitingForDebugger.'), e.registerCommand('Page.setInterceptFileChooserDialog', [{
    name: 'enabled',
    type: 'boolean',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], [], 'Enable/disable prerendering manually.  This command is a short-term solution for https://crbug.com/1440085. See https://docs.google.com/document/d/12HVmFxYj5Jc-eJr5OmWsa2bqTJsbgGLKI6ZIyx0_wpA for more details.  TODO(https://crbug.com/1440085): Remove this once Puppeteer supports tab targets.'), e.registerType('Page.AdFrameStatus', [{
    name: 'adFrameType',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Page.AdFrameType'
  }, {
    name: 'explanations',
    type: 'array',
    optional: !0,
    description: '',
    typeRef: 'Page.AdFrameExplanation'
  }]), e.registerType('Page.AdScriptId', [{
    name: 'scriptId',
    type: 'string',
    optional: !1,
    description: 'Script Id of the bottom-most script which caused the frame to be labelled as an ad.',
    typeRef: 'Runtime.ScriptId'
  }, {
    name: 'debuggerId',
    type: 'string',
    ...
    typeRef: 'Runtime.UniqueDebuggerId'
  }]), e.registerType('Page.PermissionsPolicyBlockLocator', [{
    name: 'frameId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'Page.PermissionsPolicyBlockReason'
  }]), e.registerType('Page.PermissionsPolicyFeatureState', [{
    name: 'feature',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Page.PermissionsPolicyFeature'
  }, { name: 'allowed', type: 'boolean', optional: !1, description: '', typeRef: null }, {
    name: 'locator',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Page.PermissionsPolicyBlockLocator'
  }]), e.registerType('Page.OriginTrialToken', [{
    name: 'origin',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }, { name: 'matchSubDomains', type: 'boolean', optional: !1, description: '', typeRef: null }, {
    name: 'trialName',
    type: 'string',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'Page.OriginTrialUsageRestriction'
  }]), e.registerType('Page.OriginTrialTokenWithStatus', [{
    name: 'rawTokenText',
    type: 'string',
    optional: !1,
    description: '',
    ...
    typeRef: 'Page.OriginTrialToken'
  }, {
    name: 'status',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Page.OriginTrialTokenStatus'
  }]), e.registerType('Page.OriginTrial', [{
    name: 'trialName',
    type: 'string',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'Page.OriginTrialStatus'
  }, {
    name: 'tokensWithStatus',
    type: 'array',
    optional: !1,
    description: '',
    typeRef: 'Page.OriginTrialTokenWithStatus'
  }]), e.registerType('Page.Frame', [{
    name: 'id',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]), e.registerType('Page.FrameResourceTree', [{
    name: 'frame',
    type: 'object',
    optional: !1,
    ...
    typeRef: 'Page.FrameResourceTree'
  }, {
    name: 'resources',
    type: 'array',
    optional: !1,
    description: 'Information about frame resources.',
    typeRef: 'Page.FrameResource'
  }]), e.registerType('Page.FrameTree', [{
    name: 'frame',
    type: 'object',
    optional: !1,
    description: 'Frame information for this tree item.',
    ...
    optional: !0,
    description: 'Child frames.',
    typeRef: 'Page.FrameTree'
  }]), e.registerType('Page.NavigationEntry', [{
    name: 'id',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'Page.TransitionType'
  }]), e.registerType('Page.ScreencastFrameMetadata', [{
    name: 'offsetTop',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'Network.TimeSinceEpoch'
  }]), e.registerType('Page.AppManifestError', [{
    name: 'message',
    type: 'string',
    optional: !1,
    description: 'Error message.',
    ...
    typeRef: null
  }]), e.registerType('Page.AppManifestParsedProperties', [{
    name: 'scope',
    type: 'string',
    optional: !1,
    description: 'Computed scope value',
    typeRef: null
  }]), e.registerType('Page.LayoutViewport', [{
    name: 'pageX',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }]), e.registerType('Page.VisualViewport', [{
    name: 'offsetX',
    type: 'number',
    optional: !1,
    ...
    description: 'Page scale factor.',
    typeRef: null
  }]), e.registerType('Page.FontFamilies', [{
    name: 'standard',
    type: 'string',
    optional: !0,
    ...
    typeRef: null
  }]), e.registerType('Page.ScriptFontFamilies', [{
    name: 'script',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]), e.registerType('Page.InstallabilityError', [{
    name: 'errorId',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Page.InstallabilityErrorArgument'
  }]), e.registerType('Page.CompilationCacheParams', [{
    name: 'url',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]), e.registerType('Page.FileFilter', [{
    name: 'name',
    type: 'string',
    optional: !0,
    description: '',
    ...
    description: '',
    typeRef: 'string'
  }]), e.registerType('Page.FileHandler', [{
    name: 'action',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }, { name: 'name', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'icons',
    type: 'array',
    optional: !0,
    description: '',
    typeRef: 'Page.ImageResource'
  }, {
    name: 'accepts',
    type: 'array',
    optional: !0,
    description: 'Mimic a map, name is the key, accepts is the value.',
    typeRef: 'Page.FileFilter'
  }, {
    name: 'launchType',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]), e.registerType('Page.ImageResource', [{
    name: 'url',
    type: 'string',
    optional: !1,
    description: 'The src field in the definition, but changing to url in favor of consistency.',
    typeRef: null
  }, { name: 'sizes', type: 'string', optional: !0, description: '', typeRef: null }, {
    name: 'type',
    type: 'string',
    optional: !0,
    description: '',
    typeRef: null
  }]), e.registerType('Page.LaunchHandler', [{
    name: 'clientMode',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }]), e.registerType('Page.ProtocolHandler', [{
    name: 'protocol',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }]), e.registerType('Page.RelatedApplication', [{
    name: 'id',
    type: 'string',
    optional: !0,
    description: '',
    ...
    description: '',
    typeRef: null
  }]), e.registerType('Page.Screenshot', [{
    name: 'image',
    type: 'object',
    optional: !1,
    description: '',
    typeRef: 'Page.ImageResource'
  }, { name: 'formFactor', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'label',
    type: 'string',
    optional: !0,
    description: '',
    typeRef: null
  }]), e.registerType('Page.ShareTarget', [{
    name: 'action',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }, { name: 'method', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'enctype',
    type: 'string',
    optional: !1,
    description: '',
    ...
    typeRef: null
  }, { name: 'text', type: 'string', optional: !0, description: '', typeRef: null }, {
    name: 'url',
    type: 'string',
    optional: !0,
    description: '',
    ...
    description: '',
    typeRef: null
  }]), e.registerType('Page.WebAppManifest', [{
    ...
    typeRef: null
  }, { name: 'dir', type: 'string', optional: !0, description: '', typeRef: null }, {
    name: 'display',
    type: 'string',
    optional: !0,
    description: '',
    ...
    typeRef: 'Page.FileHandler'
  }, { name: 'icons', type: 'array', optional: !0, description: '', typeRef: 'Page.ImageResource' }, {
    name: 'id',
    type: 'string',
    optional: !0,
    description: '',
    typeRef: null
  }, { name: 'lang', type: 'string', optional: !0, description: '', typeRef: null }, {
    name: 'launchHandler',
    type: 'object',
    optional: !0,
    ...
    typeRef: 'Page.LaunchHandler'
  }, { name: 'name', type: 'string', optional: !0, description: '', typeRef: null }, {
    name: 'orientation',
    type: 'string',
    optional: !0,
    description: '',
    ...
    typeRef: 'Page.ProtocolHandler'
  }, {
    name: 'relatedApplications',
    type: 'array',
    optional: !0,
    description: '',
    typeRef: 'Page.RelatedApplication'
  }, { name: 'scope', type: 'string', optional: !0, description: '', typeRef: null }, {
    ...
    typeRef: 'Page.ScopeExtension'
  }, {
    name: 'screenshots',
    type: 'array',
    optional: !0,
    description: 'The screenshots used by chromium.',
    typeRef: 'Page.Screenshot'
  }, {
    name: 'shareTarget',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Page.ShareTarget'
  }, { name: 'shortName', type: 'string', optional: !0, description: '', typeRef: null }, {
    name: 'shortcuts',
    type: 'array',
    optional: !0,
    description: '',
    typeRef: 'Page.Shortcut'
  }, { name: 'startUrl', type: 'string', optional: !0, description: '', typeRef: null }, {
    name: 'themeColor',
    type: 'string',
    optional: !0,
    description: '',
    typeRef: null
  }]), e.registerType('Page.BackForwardCacheBlockingDetails', [{
    name: 'url',
    type: 'string',
    optional: !0,
    ...
    description: 'Column number in the script (0-based).',
    typeRef: null
  }]), e.registerType('Page.BackForwardCacheNotRestoredExplanation', [{
    name: 'type',
    type: 'string',
    optional: !1,
    description: 'Type of the reason',
    typeRef: 'Page.BackForwardCacheNotRestoredReasonType'
  }, {
    name: 'reason',
    type: 'string',
    optional: !1,
    description: 'Not restored reason',
    typeRef: 'Page.BackForwardCacheNotRestoredReason'
  }, {
    name: 'context',
    type: 'string',
    optional: !0,
    ...
    optional: !0,
    description: '',
    typeRef: 'Page.BackForwardCacheBlockingDetails'
  }]), e.registerType('Page.BackForwardCacheNotRestoredExplanationTree', [{
    name: 'url',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Page.BackForwardCacheNotRestoredExplanation'
  }, {
    name: 'children',
    type: 'array',
    optional: !1,
    description: 'Array of children frame',
    typeRef: 'Page.BackForwardCacheNotRestoredExplanationTree'
  }]), e.registerEvent('Performance.metrics', ['metrics', 'title']), e.registerCommand('Performance.disable', [], [], 'Disable collecting and reporting metrics.'), e.registerEnum('Performance.EnableRequestTimeDomain', {
    TimeTicks: 'timeTicks',
    ThreadTicks: 'threadTicks'
  }), e.registerCommand('Performance.enable', [{
    name: 'timeDomain',
    type: 'string',
    optional: !0,
    description: 'Time domain to use for collecting and reporting duration metrics.',
    typeRef: 'Performance.EnableRequestTimeDomain'
  }], [], 'Enable collecting and reporting metrics.'), e.registerEnum('Performance.SetTimeDomainRequestTimeDomain', {
    TimeTicks: 'timeTicks',
    ThreadTicks: 'threadTicks'
  }), e.registerCommand('Performance.setTimeDomain', [{
    name: 'timeDomain',
    type: 'string',
    optional: !1,
    description: 'Time domain',
    typeRef: 'Performance.SetTimeDomainRequestTimeDomain'
  }], [], 'Sets time domain to use for collecting and reporting duration metrics. Note that this must be called before enabling metrics collection. Calling this method while metrics collection is enabled returns an error.'), e.registerCommand('Performance.getMetrics', [], ['metrics'], 'Retrieve current values of run-time metrics.'), e.registerType('Performance.Metric', [{
    name: 'name',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]), e.registerEvent('PerformanceTimeline.timelineEventAdded', ['event']), e.registerCommand('PerformanceTimeline.enable', [{
    name: 'eventTypes',
    type: 'array',
    optional: !1,
    description: 'The types of event to report, as specified in https://w3c.github.io/performance-timeline/#dom-performanceentry-entrytype The specified filter overrides any previous filters, passing empty filter disables recording. Note that not all types exposed to the web platform are currently supported.',
    typeRef: 'string'
  }], [], 'Previously buffered events would be reported before method returns. See also: timelineEventAdded'), e.registerType('PerformanceTimeline.LargestContentfulPaint', [{
    name: 'renderTime',
    type: 'number',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: 'DOM.BackendNodeId'
  }]), e.registerType('PerformanceTimeline.LayoutShiftAttribution', [{
    name: 'previousRect',
    type: 'object',
    optional: !1,
    description: '',
    typeRef: 'DOM.Rect'
  }, { name: 'currentRect', type: 'object', optional: !1, description: '', typeRef: 'DOM.Rect' }, {
    name: 'nodeId',
    type: 'number',
    optional: !0,
    description: '',
    typeRef: 'DOM.BackendNodeId'
  }]), e.registerType('PerformanceTimeline.LayoutShift', [{
    name: 'value',
    type: 'number',
    optional: !1,
    ...
    optional: !1,
    description: '',
    typeRef: 'PerformanceTimeline.LayoutShiftAttribution'
  }]), e.registerType('PerformanceTimeline.TimelineEvent', [{
    name: 'frameId',
    type: 'string',
    optional: !1,
    ...
    optional: !0,
    description: '',
    typeRef: 'PerformanceTimeline.LargestContentfulPaint'
  }, {
    name: 'layoutShiftDetails',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'PerformanceTimeline.LayoutShift'
  }]), e.registerEnum('Security.MixedContentType', {
    Blockable: 'blockable',
    OptionallyBlockable: 'optionally-blockable',
    None: 'none'
  }),e.registerEnum('Security.SecurityState', {
    Unknown: 'unknown',
    Neutral: 'neutral',
    Insecure: 'insecure',
    Secure: 'secure',
    ...
    typeRef: 'Security.CertificateErrorAction'
  }], [], 'Handles a certificate error that fired a certificateError event.'),e.registerCommand('Security.setOverrideCertificateErrors', [{
    name: 'override',
    type: 'boolean',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Security.SafetyTipInfo', [{
    ...
    typeRef: 'Security.SafetyTipStatus'
  }, {
    name: 'safeUrl',
    type: 'string',
    optional: !0,
    ...
    typeRef: null
  }]),e.registerType('Security.VisibleSecurityState', [{
    name: 'securityState',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Security.CertificateSecurityState'
  }, {
    name: 'safetyTipInfo',
    type: 'object',
    optional: !0,
    ...
    typeRef: 'Security.SafetyTipInfo'
  }, {
    ...
    typeRef: 'string'
  }]),e.registerType('Security.SecurityStateExplanation', [{
    name: 'securityState',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'string'
  }]),e.registerType('Security.InsecureContentStatus', [{
    ...
    description: 'Always set to unknown.',
    typeRef: 'Security.SecurityState'
  }]),e.registerEnum('ServiceWorker.ServiceWorkerVersionRunningStatus', {
    Stopped: 'stopped',
    Starting: 'starting',
    Running: 'running',
    Stopping: 'stopping'
  }),e.registerEnum('ServiceWorker.ServiceWorkerVersionStatus', {
    New: 'new',
    ...
    Activated: 'activated',
    Redundant: 'redundant'
  }),e.registerEvent('ServiceWorker.workerErrorReported', ['errorMessage']),e.registerEvent('ServiceWorker.workerRegistrationUpdated', ['registrations']),e.registerEvent('ServiceWorker.workerVersionUpdated', ['versions']),e.registerCommand('ServiceWorker.deliverPushMessage', [{
    name: 'origin',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], [], ''),e.registerCommand('ServiceWorker.disable', [], [], ''),e.registerCommand('ServiceWorker.dispatchSyncEvent', [{
    name: 'origin',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: 'ServiceWorker.RegistrationID'
  }, { name: 'tag', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'lastChance',
    type: 'boolean',
    optional: !1,
    description: '',
    typeRef: null
  }], [], ''),e.registerCommand('ServiceWorker.dispatchPeriodicSyncEvent', [{
    name: 'origin',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], [], ''),e.registerCommand('ServiceWorker.setForceUpdateOnPageLoad', [{
    name: 'forceUpdateOnPageLoad',
    type: 'boolean',
    optional: !1,
    description: '',
    typeRef: null
  }], [], ''),e.registerCommand('ServiceWorker.skipWaiting', [{
    name: 'scopeURL',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], [], ''),e.registerCommand('ServiceWorker.startWorker', [{
    name: 'scopeURL',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], [], ''),e.registerCommand('ServiceWorker.stopAllWorkers', [], [], ''),e.registerCommand('ServiceWorker.stopWorker', [{
    name: 'versionId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], [], ''),e.registerCommand('ServiceWorker.unregister', [{
    name: 'scopeURL',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], [], ''),e.registerCommand('ServiceWorker.updateRegistration', [{
    name: 'scopeURL',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], [], ''),e.registerType('ServiceWorker.ServiceWorkerRegistration', [{
    name: 'registrationId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'ServiceWorker.RegistrationID'
  }, { name: 'scopeURL', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'isDeleted',
    type: 'boolean',
    optional: !1,
    description: '',
    typeRef: null
  }]),e.registerType('ServiceWorker.ServiceWorkerVersion', [{
    name: 'versionId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: 'ServiceWorker.RegistrationID'
  }, { name: 'scriptURL', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'runningStatus',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'ServiceWorker.ServiceWorkerVersionRunningStatus'
  }, {
    name: 'status',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'ServiceWorker.ServiceWorkerVersionStatus'
  }, {
    ...
    description: '',
    typeRef: null
  }]),e.registerType('ServiceWorker.ServiceWorkerErrorMessage', [{
    name: 'errorMessage',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: 'ServiceWorker.RegistrationID'
  }, { name: 'versionId', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'sourceURL',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }]),e.registerEnum('Storage.StorageType', {
    Appcache: 'appcache',
    Cookies: 'cookies',
    ...
    All: 'all',
    Other: 'other'
  }),e.registerEnum('Storage.InterestGroupAccessType', {
    Join: 'join',
    Leave: 'leave',
    Update: 'update',
    Loaded: 'loaded',
    ...
    Clear: 'clear'
  }),e.registerEnum('Storage.InterestGroupAuctionEventType', {
    Started: 'started',
    ConfigResolved: 'configResolved'
  }),e.registerEnum('Storage.InterestGroupAuctionFetchType', {
    BidderJs: 'bidderJs',
    BidderWasm: 'bidderWasm',
    SellerJs: 'sellerJs',
    BidderTrustedSignals: 'bidderTrustedSignals',
    SellerTrustedSignals: 'sellerTrustedSignals'
  }),e.registerEnum('Storage.SharedStorageAccessType', {
  ...
  }),e.registerEnum('Storage.StorageBucketsDurability', {
    Relaxed: 'relaxed',
    Strict: 'strict'
  }),e.registerEnum('Storage.AttributionReportingSourceType', {
    Navigation: 'navigation',
    Event: 'event'
  }),e.registerEnum('Storage.AttributionReportingTriggerDataMatching', {
    Exact: 'exact',
    Modulus: 'modulus'
  }),e.registerEnum('Storage.AttributionReportingSourceRegistrationResult', {
    Success: 'success',
    InternalError: 'internalError',
  ...
  }),e.registerEnum('Storage.AttributionReportingSourceRegistrationTimeConfig', {
    Include: 'include',
    Exclude: 'exclude'
  }),e.registerEnum('Storage.AttributionReportingEventLevelResult', {
    Success: 'success',
  ...
  }),e.registerEnum('Storage.AttributionReportingAggregatableResult', {
    Success: 'success',
    InternalError: 'internalError',
    NoCapacityForAttributionDestination: 'noCapacityForAttributionDestination',
    NoMatchingSources: 'noMatchingSources',
    ...
    ReportWindowPassed: 'reportWindowPassed',
    ExcessiveReports: 'excessiveReports'
  }),e.registerEvent('Storage.cacheStorageContentUpdated', ['origin', 'storageKey', 'bucketId', 'cacheName']),e.registerEvent('Storage.cacheStorageListUpdated', ['origin', 'storageKey', 'bucketId']),e.registerEvent('Storage.indexedDBContentUpdated', ['origin', 'storageKey', 'bucketId', 'databaseName', 'objectStoreName']),e.registerEvent('Storage.indexedDBListUpdated', ['origin', 'storageKey', 'bucketId']),e.registerEvent('Storage.interestGroupAccessed', ['accessTime', 'type', 'ownerOrigin', 'name', 'componentSellerOrigin', 'bid', 'bidCurrency', 'uniqueAuctionId']),e.registerEvent('Storage.interestGroupAuctionEventOccurred', ['eventTime', 'type', 'uniqueAuctionId', 'parentAuctionId', 'auctionConfig']),e.registerEvent('Storage.interestGroupAuctionNetworkRequestCreated', ['type', 'requestId', 'auctions']),e.registerEvent('Storage.sharedStorageAccessed', ['accessTime', 'type', 'mainFrameId', 'ownerOrigin', 'params']),e.registerEvent('Storage.storageBucketCreatedOrUpdated', ['bucketInfo']),e.registerEvent('Storage.storageBucketDeleted', ['bucketId']),e.registerEvent('Storage.attributionReportingSourceRegistered', ['registration', 'result']),e.registerEvent('Storage.attributionReportingTriggerRegistered', ['registration', 'eventLevel', 'aggregatable']),e.registerCommand('Storage.getStorageKeyForFrame', [{
    name: 'frameId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Page.FrameId'
  }], ['storageKey'], 'Returns a storage key given a frame id.'),e.registerCommand('Storage.clearDataForOrigin', [{
    name: 'origin',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }], [], 'Clears storage for origin.'),e.registerCommand('Storage.clearDataForStorageKey', [{
    name: 'storageKey',
    type: 'string',
    optional: !1,
    description: 'Storage key.',
    ...
    description: 'Comma separated list of StorageType to clear.',
    typeRef: null
  }], [], 'Clears storage for storage key.'),e.registerCommand('Storage.getCookies', [{
    name: 'browserContextId',
    type: 'string',
    optional: !0,
    description: 'Browser context to use when called on the browser endpoint.',
    typeRef: 'Browser.BrowserContextID'
  }], ['cookies'], 'Returns all browser cookies.'),e.registerCommand('Storage.setCookies', [{
    name: 'cookies',
    type: 'array',
    optional: !1,
    description: 'Cookies to be set.',
    ...
    description: 'Browser context to use when called on the browser endpoint.',
    typeRef: 'Browser.BrowserContextID'
  }], [], 'Sets given cookies.'),e.registerCommand('Storage.clearCookies', [{
    name: 'browserContextId',
    type: 'string',
    optional: !0,
    description: 'Browser context to use when called on the browser endpoint.',
    typeRef: 'Browser.BrowserContextID'
  }], [], 'Clears cookies.'),e.registerCommand('Storage.getUsageAndQuota', [{
    name: 'origin',
    type: 'string',
    optional: !1,
    description: 'Security origin.',
    ...
    typeRef: null
  }], [], 'Override quota for the specified origin'),e.registerCommand('Storage.trackCacheStorageForOrigin', [{
    name: 'origin',
    type: 'string',
    optional: !1,
    description: 'Security origin.',
    typeRef: null
  }], [], 'Registers origin to be notified when an update occurs to its cache storage list.'),e.registerCommand('Storage.trackCacheStorageForStorageKey', [{
    name: 'storageKey',
    type: 'string',
    optional: !1,
    description: 'Storage key.',
    typeRef: null
  }], [], 'Registers storage key to be notified when an update occurs to its cache storage list.'),e.registerCommand('Storage.trackIndexedDBForOrigin', [{
    name: 'origin',
    type: 'string',
    optional: !1,
    description: 'Security origin.',
    typeRef: null
  }], [], 'Registers origin to be notified when an update occurs to its IndexedDB.'),e.registerCommand('Storage.trackIndexedDBForStorageKey', [{
    name: 'storageKey',
    type: 'string',
    optional: !1,
    description: 'Storage key.',
    typeRef: null
  }], [], 'Registers storage key to be notified when an update occurs to its IndexedDB.'),e.registerCommand('Storage.untrackCacheStorageForOrigin', [{
    name: 'origin',
    type: 'string',
    optional: !1,
    description: 'Security origin.',
    typeRef: null
  }], [], 'Unregisters origin from receiving notifications for cache storage.'),e.registerCommand('Storage.untrackCacheStorageForStorageKey', [{
    name: 'storageKey',
    type: 'string',
    optional: !1,
    description: 'Storage key.',
    typeRef: null
  }], [], 'Unregisters storage key from receiving notifications for cache storage.'),e.registerCommand('Storage.untrackIndexedDBForOrigin', [{
    name: 'origin',
    type: 'string',
    optional: !1,
    description: 'Security origin.',
    typeRef: null
  }], [], 'Unregisters origin from receiving notifications for IndexedDB.'),e.registerCommand('Storage.untrackIndexedDBForStorageKey', [{
    name: 'storageKey',
    type: 'string',
    optional: !1,
    description: 'Storage key.',
    typeRef: null
  }], [], 'Unregisters storage key from receiving notifications for IndexedDB.'),e.registerCommand('Storage.getTrustTokens', [], ['tokens'], 'Returns the number of stored Trust Tokens per issuer for the current browsing context.'),e.registerCommand('Storage.clearTrustTokens', [{
    name: 'issuerOrigin',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], ['didDeleteTokens'], 'Removes all Trust Tokens issued by the provided issuerOrigin. Leaves other stored data, including the issuer\'s Redemption Records, intact.'),e.registerCommand('Storage.getInterestGroupDetails', [{
    name: 'ownerOrigin',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], ['details'], 'Gets details for a named interest group.'),e.registerCommand('Storage.setInterestGroupTracking', [{
    name: 'enable',
    type: 'boolean',
    optional: !1,
    description: '',
    typeRef: null
  }], [], 'Enables/Disables issuing of interestGroupAccessed events.'),e.registerCommand('Storage.setInterestGroupAuctionTracking', [{
    name: 'enable',
    type: 'boolean',
    optional: !1,
    description: '',
    typeRef: null
  }], [], 'Enables/Disables issuing of interestGroupAuctionEventOccurred and interestGroupAuctionNetworkRequestCreated.'),e.registerCommand('Storage.getSharedStorageMetadata', [{
    name: 'ownerOrigin',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], ['metadata'], 'Gets metadata for an origin\'s shared storage.'),e.registerCommand('Storage.getSharedStorageEntries', [{
    name: 'ownerOrigin',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], ['entries'], 'Gets the entries in an given origin\'s shared storage.'),e.registerCommand('Storage.setSharedStorageEntry', [{
    name: 'ownerOrigin',
    type: 'string',
    optional: !1,
    description: '',
    ...
    type: 'boolean',
    optional: !0,
    description: 'If `ignoreIfPresent` is included and true, then only sets the entry if `key` doesn\'t already exist.',
    typeRef: null
  }], [], 'Sets entry with `key` and `value` for a given origin\'s shared storage.'),e.registerCommand('Storage.deleteSharedStorageEntry', [{
    name: 'ownerOrigin',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], [], 'Deletes entry for `key` (if it exists) for a given origin\'s shared storage.'),e.registerCommand('Storage.clearSharedStorageEntries', [{
    name: 'ownerOrigin',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], [], 'Clears all entries for a given origin\'s shared storage.'),e.registerCommand('Storage.resetSharedStorageBudget', [{
    name: 'ownerOrigin',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], [], 'Resets the budget for `ownerOrigin` by clearing all budget withdrawals.'),e.registerCommand('Storage.setSharedStorageTracking', [{
    name: 'enable',
    type: 'boolean',
    optional: !1,
    description: '',
    typeRef: null
  }], [], 'Enables/disables issuing of sharedStorageAccessed events.'),e.registerCommand('Storage.setStorageBucketTracking', [{
    name: 'storageKey',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], [], 'Set tracking for a storage key\'s buckets.'),e.registerCommand('Storage.deleteStorageBucket', [{
    name: 'bucket',
    type: 'object',
    optional: !1,
    description: '',
    typeRef: 'Storage.StorageBucket'
  }], [], 'Deletes the Storage Bucket with the given storage key and bucket name.'),e.registerCommand('Storage.runBounceTrackingMitigations', [], ['deletedSites'], 'Deletes state for sites identified as potential bounce trackers, immediately.'),e.registerCommand('Storage.setAttributionReportingLocalTestingMode', [{
    name: 'enabled',
    type: 'boolean',
    optional: !1,
    description: 'If enabled, noise is suppressed and reports are sent immediately.',
    typeRef: null
  }], [], 'https://wicg.github.io/attribution-reporting-api/'),e.registerCommand('Storage.setAttributionReportingTracking', [{
    name: 'enable',
    type: 'boolean',
    optional: !1,
    description: '',
    typeRef: null
  }], [], 'Enables/disables issuing of Attribution Reporting events.'),e.registerCommand('Storage.sendPendingAttributionReports', [], ['numSent'], 'Sends all pending Attribution Reports immediately, regardless of their scheduled report time.'),e.registerCommand('Storage.getRelatedWebsiteSets', [], ['sets'], 'Returns the effective Related Website Sets in use by this profile for the browser session. The effective Related Website Sets will not change during a browser session.'),e.registerType('Storage.UsageForType', [{
    name: 'storageType',
    type: 'string',
    optional: !1,
    description: 'Name of storage type.',
    typeRef: 'Storage.StorageType'
  }, {
    name: 'usage',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Storage.TrustTokens', [{
    name: 'issuerOrigin',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }]),e.registerType('Storage.SharedStorageEntry', [{
    name: 'key',
    type: 'string',
    optional: !1,
    description: '',
    ...
    typeRef: null
  }]),e.registerType('Storage.SharedStorageReportingMetadata', [{
    name: 'eventType',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }]),e.registerType('Storage.SharedStorageUrlWithMetadata', [{
    name: 'url',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Storage.SharedStorageReportingMetadata'
  }]),e.registerType('Storage.SharedStorageAccessParams', [{
    name: 'scriptSourceUrl',
    type: 'string',
    optional: !0,
    description: 'Spec of the module script URL. Present only for SharedStorageAccessType.documentAddModule.',
    typeRef: null
  }, {
    name: 'operationName',
    type: 'string',
    optional: !0,
    description: 'Name of the registered operation to be run. Present only for SharedStorageAccessType.documentRun and SharedStorageAccessType.documentSelectURL.',
    typeRef: null
  }, {
    name: 'serializedData',
    type: 'string',
    optional: !0,
    description: 'The operation\'s serialized data in bytes (converted to a string). Present only for SharedStorageAccessType.documentRun and SharedStorageAccessType.documentSelectURL.',
    typeRef: null
  }, {
    name: 'urlsWithMetadata',
    type: 'array',
    optional: !0,
    description: 'Array of candidate URLs\' specs, along with any associated metadata. Present only for SharedStorageAccessType.documentSelectURL.',
    typeRef: 'Storage.SharedStorageUrlWithMetadata'
  }, {
    name: 'key',
    type: 'string',
    optional: !0,
    ...
    type: 'boolean',
    optional: !0,
    description: 'Whether or not to set an entry for a key if that key is already present. Present only for SharedStorageAccessType.documentSet, SharedStorageAccessType.workletSet, and SharedStorageAccessType.headerSet.',
    typeRef: null
  }]),e.registerType('Storage.StorageBucket', [{
    name: 'storageKey',
    type: 'string',
    optional: !1,
    description: '',
    ...
    typeRef: null
  }]),e.registerType('Storage.StorageBucketInfo', [{
    name: 'bucket',
    type: 'object',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'Storage.StorageBucketsDurability'
  }]),e.registerType('Storage.AttributionReportingFilterDataEntry', [{
    name: 'key',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: 'string'
  }]),e.registerType('Storage.AttributionReportingFilterConfig', [{
    name: 'filterValues',
    type: 'array',
    optional: !1,
    description: '',
    typeRef: 'Storage.AttributionReportingFilterDataEntry'
  }, {
    name: 'lookbackWindow',
    type: 'number',
    optional: !0,
    ...
    typeRef: null
  }]),e.registerType('Storage.AttributionReportingFilterPair', [{
    name: 'filters',
    type: 'array',
    optional: !1,
    description: '',
    typeRef: 'Storage.AttributionReportingFilterConfig'
  }, {
    name: 'notFilters',
    type: 'array',
    optional: !1,
    description: '',
    typeRef: 'Storage.AttributionReportingFilterConfig'
  }]),e.registerType('Storage.AttributionReportingAggregationKeysEntry', [{
    name: 'key',
    type: 'string',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'Storage.UnsignedInt128AsBase16'
  }]),e.registerType('Storage.AttributionReportingEventReportWindows', [{
    name: 'start',
    type: 'number',
    optional: !1,
    description: 'duration in seconds',
    ...
    description: 'duration in seconds',
    typeRef: 'integer'
  }]),e.registerType('Storage.AttributionReportingTriggerSpec', [{
    name: 'triggerData',
    type: 'array',
    optional: !1,
    ...
    optional: !1,
    description: '',
    typeRef: 'Storage.AttributionReportingEventReportWindows'
  }]),e.registerType('Storage.AttributionReportingAggregatableDebugReportingData', [{
    name: 'keyPiece',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: 'string'
  }]),e.registerType('Storage.AttributionReportingAggregatableDebugReportingConfig', [{
    name: 'budget',
    type: 'number',
    optional: !0,
    ...
    optional: !1,
    description: '',
    typeRef: 'Storage.AttributionReportingAggregatableDebugReportingData'
  }, {
    ...
    optional: !1,
    description: '',
    typeRef: 'Storage.AttributionReportingTriggerSpec'
  }, {
    ...
    optional: !1,
    description: '',
    typeRef: 'Storage.AttributionReportingSourceType'
  }, { name: 'sourceOrigin', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'reportingOrigin',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }, { name: 'destinationSites', type: 'array', optional: !1, description: '', typeRef: 'string' }, {
    name: 'eventId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Storage.UnsignedInt64AsBase10'
  }, {
    name: 'priority',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Storage.SignedInt64AsBase10'
  }, {
    name: 'filterData',
    type: 'array',
    optional: !1,
    ...
    optional: !1,
    description: '',
    typeRef: 'Storage.AttributionReportingAggregationKeysEntry'
  }, {
    name: 'debugKey',
    type: 'string',
    optional: !0,
    ...
    optional: !1,
    description: '',
    typeRef: 'Storage.AttributionReportingTriggerDataMatching'
  }, {
    ...
    optional: !1,
    description: '',
    typeRef: 'Storage.AttributionReportingAggregatableDebugReportingConfig'
  }]),e.registerType('Storage.AttributionReportingAggregatableValueDictEntry', [{
    name: 'key',
    type: 'string',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'Storage.AttributionReportingAggregatableValueDictEntry'
  }, {
    name: 'filters',
    type: 'object',
    optional: !1,
    description: '',
    typeRef: 'Storage.AttributionReportingFilterPair'
  }]),e.registerType('Storage.AttributionReportingEventTriggerData', [{
    name: 'data',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: 'Storage.AttributionReportingFilterPair'
  }]),e.registerType('Storage.AttributionReportingAggregatableTriggerData', [{
    name: 'keyPiece',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Storage.UnsignedInt128AsBase16'
  }, { name: 'sourceKeys', type: 'array', optional: !1, description: '', typeRef: 'string' }, {
    name: 'filters',
    type: 'object',
    optional: !1,
    description: '',
    typeRef: 'Storage.AttributionReportingFilterPair'
  }]),e.registerType('Storage.AttributionReportingAggregatableDedupKey', [{
    name: 'dedupKey',
    type: 'string',
    optional: !0,
    description: '',
    ...
    description: '',
    typeRef: 'Storage.AttributionReportingFilterPair'
  }]),e.registerType('Storage.AttributionReportingTriggerRegistration', [{
    name: 'filters',
    type: 'object',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'Storage.AttributionReportingAggregatableDedupKey'
  }, {
    name: 'eventTriggerData',
    type: 'array',
    optional: !1,
    description: '',
    typeRef: 'Storage.AttributionReportingEventTriggerData'
  }, {
    name: 'aggregatableTriggerData',
    type: 'array',
    optional: !1,
    description: '',
    typeRef: 'Storage.AttributionReportingAggregatableTriggerData'
  }, {
    name: 'aggregatableValues',
    type: 'array',
    optional: !1,
    description: '',
    typeRef: 'Storage.AttributionReportingAggregatableValueEntry'
  }, {
    ...
    optional: !1,
    description: '',
    typeRef: 'Storage.AttributionReportingSourceRegistrationTimeConfig'
  }, {
    ...
    description: '',
    typeRef: 'Storage.AttributionReportingAggregatableDebugReportingConfig'
  }]),e.registerType('Storage.RelatedWebsiteSet', [{
    name: 'primarySites',
    type: 'array',
    optional: !1,
    ...
    typeRef: 'string'
  }]),e.registerEnum('SystemInfo.SubsamplingFormat', {
    Yuv420: 'yuv420',
    Yuv422: 'yuv422',
    Yuv444: 'yuv444'
  }),e.registerEnum('SystemInfo.ImageType', {
    Jpeg: 'jpeg',
    Webp: 'webp',
    Unknown: 'unknown'
  }),e.registerCommand('SystemInfo.getInfo', [], ['gpu', 'modelName', 'modelVersion', 'commandLine'], 'Returns information about the system.'),e.registerCommand('SystemInfo.getFeatureState', [{
    name: 'featureState',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], ['featureEnabled'], 'Returns information about the feature state.'),e.registerCommand('SystemInfo.getProcessInfo', [], ['processInfo'], 'Returns information about all running processes.'),e.registerType('SystemInfo.GPUDevice', [{
    name: 'vendorId',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('SystemInfo.Size', [{
    name: 'width',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('SystemInfo.VideoDecodeAcceleratorCapability', [{
    name: 'profile',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'SystemInfo.Size'
  }]),e.registerType('SystemInfo.VideoEncodeAcceleratorCapability', [{
    name: 'profile',
    type: 'string',
    optional: !1,
    ...
    description: '',
    typeRef: null
  }]),e.registerType('SystemInfo.ImageDecodeAcceleratorCapability', [{
    name: 'imageType',
    type: 'string',
    optional: !1,
    description: 'Image coded, e.g. Jpeg.',
    typeRef: 'SystemInfo.ImageType'
  }, {
    name: 'maxDimensions',
    type: 'object',
    optional: !1,
    ...
    typeRef: 'SystemInfo.SubsamplingFormat'
  }]),e.registerType('SystemInfo.GPUInfo', [{
    name: 'devices',
    type: 'array',
    optional: !1,
    description: 'The graphics devices on the system. Element 0 is the primary GPU.',
    typeRef: 'SystemInfo.GPUDevice'
  }, {
    name: 'auxAttributes',
    type: 'object',
    optional: !0,
    ...
    typeRef: 'SystemInfo.VideoDecodeAcceleratorCapability'
  }, {
    name: 'videoEncoding',
    type: 'array',
    optional: !1,
    description: 'Supported accelerated video encoding capabilities.',
    typeRef: 'SystemInfo.VideoEncodeAcceleratorCapability'
  }, {
    name: 'imageDecoding',
    type: 'array',
    optional: !1,
    description: 'Supported accelerated image decoding capabilities.',
    typeRef: 'SystemInfo.ImageDecodeAcceleratorCapability'
  }]),e.registerType('SystemInfo.ProcessInfo', [{
    name: 'type',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerEvent('Target.attachedToTarget', ['sessionId', 'targetInfo', 'waitingForDebugger']),e.registerEvent('Target.detachedFromTarget', ['sessionId', 'targetId']),e.registerEvent('Target.receivedMessageFromTarget', ['sessionId', 'message', 'targetId']),e.registerEvent('Target.targetCreated', ['targetInfo']),e.registerEvent('Target.targetDestroyed', ['targetId']),e.registerEvent('Target.targetCrashed', ['targetId', 'status', 'errorCode']),e.registerEvent('Target.targetInfoChanged', ['targetInfo']),e.registerCommand('Target.activateTarget', [{
    name: 'targetId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Target.TargetID'
  }], [], 'Activates (focuses) the target.'),e.registerCommand('Target.attachToTarget', [{
    name: 'targetId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    type: 'boolean',
    optional: !0,
    description: 'Enables \\"flat\\" access to the session via specifying sessionId attribute in the commands. We plan to make this the default, deprecate non-flattened mode, and eventually retire it. See crbug.com/991325.',
    typeRef: null
  }], ['sessionId'], 'Attaches to the target with given id.'),e.registerCommand('Target.attachToBrowserTarget', [], ['sessionId'], 'Attaches to the browser target, only uses flat sessionId mode.'),e.registerCommand('Target.closeTarget', [{
    name: 'targetId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Target.TargetID'
  }], ['success'], 'Closes the target. If the target is a page that gets closed too.'),e.registerCommand('Target.exposeDevToolsProtocol', [{
    name: 'targetId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    type: 'array',
    optional: !0,
    description: 'An optional list of origins to grant unlimited cross-origin access to. Parts of the URL other than those constituting origin are ignored.',
    typeRef: 'string'
  }], ['browserContextId'], 'Creates a new empty BrowserContext. Similar to an incognito profile but you can have more than one.'),e.registerCommand('Target.getBrowserContexts', [], ['browserContextIds'], 'Returns all browser contexts created with `Target.createBrowserContext` method.'),e.registerCommand('Target.createTarget', [{
    name: 'url',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }], ['targetId'], 'Creates a new page.'),e.registerCommand('Target.detachFromTarget', [{
    name: 'sessionId',
    type: 'string',
    optional: !0,
    description: 'Session to detach.',
    typeRef: 'Target.SessionID'
  }, {
    name: 'targetId',
    type: 'string',
    optional: !0,
    ...
    typeRef: 'Target.TargetID'
  }], [], 'Detaches session with given id.'),e.registerCommand('Target.disposeBrowserContext', [{
    name: 'browserContextId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Browser.BrowserContextID'
  }], [], 'Deletes a BrowserContext. All the belonging pages will be closed without calling their beforeunload hooks.'),e.registerCommand('Target.getTargetInfo', [{
    name: 'targetId',
    type: 'string',
    optional: !0,
    description: '',
    typeRef: 'Target.TargetID'
  }], ['targetInfo'], 'Returns information about a target.'),e.registerCommand('Target.getTargets', [{
    name: 'filter',
    type: 'array',
    optional: !0,
    description: 'Only targets matching filter will be reported. If filter is not specified and target discovery is currently enabled, a filter used for target discovery is used for consistency.',
    typeRef: 'Target.TargetFilter'
  }], ['targetInfos'], 'Retrieves a list of available targets.'),e.registerCommand('Target.sendMessageToTarget', [{
    name: 'message',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: 'Deprecated.',
    typeRef: 'Target.TargetID'
  }], [], 'Sends protocol message over session with given id. Consider using flat mode instead; see commands attachToTarget, setAutoAttach, and crbug.com/991325.'),e.registerCommand('Target.setAutoAttach', [{
    name: 'autoAttach',
    type: 'boolean',
    optional: !1,
    ...
    typeRef: 'Target.TargetFilter'
  }], [], 'Controls whether to automatically attach to new targets which are considered to be related to this one. When turned on, attaches to all existing related targets as well. When turned off, automatically detaches from all currently attached targets. This also clears all targets added by `autoAttachRelated` from the list of targets to watch for creation of related targets.'),e.registerCommand('Target.autoAttachRelated', [{
    name: 'targetId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: 'Only targets matching filter will be attached.',
    typeRef: 'Target.TargetFilter'
  }], [], 'Adds the specified target to the list of targets that will be monitored for any related target creation (such as child frames, child workers and new versions of service worker) and reported through `attachedToTarget`. The specified target is also auto-attached. This cancels the effect of any previous `setAutoAttach` and is also cancelled by subsequent `setAutoAttach`. Only available at the Browser target.'),e.registerCommand('Target.setDiscoverTargets', [{
    name: 'discover',
    type: 'boolean',
    optional: !1,
    ...
    type: 'array',
    optional: !0,
    description: 'Only targets matching filter will be attached. If `discover` is false, `filter` must be omitted or empty.',
    typeRef: 'Target.TargetFilter'
  }], [], 'Controls whether to discover available targets and notify via `targetCreated/targetInfoChanged/targetDestroyed` events.'),e.registerCommand('Target.setRemoteLocations', [{
    name: 'locations',
    type: 'array',
    optional: !1,
    description: 'List of remote locations.',
    typeRef: 'Target.RemoteLocation'
  }], [], 'Enables target discovery for the specified locations, when `setDiscoverTargets` was set to `true`.'),e.registerType('Target.TargetInfo', [{
    name: 'targetId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    typeRef: null
  }, { name: 'title', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'url',
    type: 'string',
    optional: !1,
    description: '',
    ...
    typeRef: null
  }]),e.registerType('Target.FilterEntry', [{
    name: 'exclude',
    type: 'boolean',
    optional: !0,
    ...
    description: '',
    typeRef: null
  }]),e.registerEvent('Tethering.accepted', ['port', 'connectionId']),e.registerCommand('Tethering.bind', [{
    name: 'port',
    type: 'number',
    optional: !1,
    description: 'Port number to bind.',
    typeRef: null
  }], [], 'Request browser port binding.'),e.registerCommand('Tethering.unbind', [{
    name: 'port',
    type: 'number',
    optional: !1,
    description: 'Port number to unbind.',
    typeRef: null
  }], [], 'Request browser port unbinding.'),e.registerEnum('Tracing.TraceConfigRecordMode', {
    RecordUntilFull: 'recordUntilFull',
    RecordContinuously: 'recordContinuously',
    RecordAsMuchAsPossible: 'recordAsMuchAsPossible',
    EchoToConsole: 'echoToConsole'
  }),e.registerEnum('Tracing.StreamFormat', {
    Json: 'json',
    Proto: 'proto'
  }),e.registerEnum('Tracing.StreamCompression', {
    None: 'none',
    Gzip: 'gzip'
  }),e.registerEnum('Tracing.MemoryDumpLevelOfDetail', {
    Background: 'background',
    Light: 'light',
    Detailed: 'detailed'
  }),e.registerEnum('Tracing.TracingBackend', {
    Auto: 'auto',
    Chrome: 'chrome',
    System: 'system'
  }),e.registerEvent('Tracing.bufferUsage', ['percentFull', 'eventCount', 'value']),e.registerEvent('Tracing.dataCollected', ['value']),e.registerEvent('Tracing.tracingComplete', ['dataLossOccurred', 'stream', 'traceFormat', 'streamCompression']),e.registerCommand('Tracing.end', [], [], 'Stop trace events collection.'),e.registerCommand('Tracing.getCategories', [], ['categories'], 'Gets supported tracing categories.'),e.registerCommand('Tracing.recordClockSyncMarker', [{
    name: 'syncId',
    type: 'string',
    optional: !1,
    description: 'The ID of this clock sync marker',
    typeRef: null
  }], [], 'Record a clock sync marker in the trace.'),e.registerCommand('Tracing.requestMemoryDump', [{
    name: 'deterministic',
    type: 'boolean',
    optional: !0,
    ...
    typeRef: 'Tracing.MemoryDumpLevelOfDetail'
  }], ['dumpGuid', 'success'], 'Request a global memory dump.'),e.registerEnum('Tracing.StartRequestTransferMode', {
    ReportEvents: 'ReportEvents',
    ReturnAsStream: 'ReturnAsStream'
  }),e.registerCommand('Tracing.start', [{
    name: 'categories',
    type: 'string',
    optional: !0,
    ...
    typeRef: 'Tracing.StartRequestTransferMode'
  }, {
    name: 'streamFormat',
    type: 'string',
    optional: !0,
    description: 'Trace data format to use. This only applies when using `ReturnAsStream` transfer mode (defaults to `json`).',
    typeRef: 'Tracing.StreamFormat'
  }, {
    ...
    typeRef: 'Tracing.StreamCompression'
  }, {
    name: 'traceConfig',
    type: 'object',
    optional: !0,
    ...
    type: 'string',
    optional: !0,
    description: 'Base64-encoded serialized perfetto.protos.TraceConfig protobuf message When specified, the parameters `categories`, `options`, `traceConfig` are ignored.',
    typeRef: null
  }, {
    name: 'tracingBackend',
    type: 'string',
    ...
    typeRef: 'Tracing.TracingBackend'
  }], [], 'Start trace events collection.'),e.registerType('Tracing.TraceConfig', [{
    name: 'recordMode',
    type: 'string',
    optional: !0,
  ...
  }]),e.registerEnum('Fetch.RequestStage', {
    Request: 'Request',
    Response: 'Response'
  }),e.registerEnum('Fetch.AuthChallengeSource', {
    Server: 'Server',
    Proxy: 'Proxy'
  }),e.registerEnum('Fetch.AuthChallengeResponseResponse', {
    Default: 'Default',
    CancelAuth: 'CancelAuth',
    ProvideCredentials: 'ProvideCredentials'
  }),e.registerEvent('Fetch.requestPaused', ['requestId', 'request', 'frameId', 'resourceType', 'responseErrorReason', 'responseStatusCode', 'responseStatusText', 'responseHeaders', 'networkId', 'redirectedRequestId']),e.registerEvent('Fetch.authRequired', ['requestId', 'request', 'frameId', 'resourceType', 'authChallenge']),e.registerCommand('Fetch.disable', [], [], 'Disables the fetch domain.'),e.registerCommand('Fetch.enable', [{
    name: 'patterns',
    type: 'array',
    optional: !0,
    description: 'If specified, only requests matching any of these patterns will produce fetchRequested event and will be paused until clients response. If not set, all requests will be affected.',
    typeRef: 'Fetch.RequestPattern'
  }, {
    name: 'handleAuthRequests',
    type: 'boolean',
    optional: !0,
    description: 'If true, authRequired events will be issued and requests will be paused expecting a call to continueWithAuth.',
    typeRef: null
  }], [], 'Enables issuing of requestPaused events. A request will be paused until client calls one of failRequest, fulfillRequest or continueRequest/continueWithAuth.'),e.registerCommand('Fetch.failRequest', [{
    name: 'requestId',
    type: 'string',
    optional: !1,
    description: 'An id the client received in requestPaused event.',
    typeRef: 'Fetch.RequestId'
  }, {
    name: 'errorReason',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Network.ErrorReason'
  }], [], 'Causes the request to fail with specified reason.'),e.registerCommand('Fetch.fulfillRequest', [{
    name: 'requestId',
    type: 'string',
    optional: !1,
    description: 'An id the client received in requestPaused event.',
    ...
    optional: !0,
    description: 'Response headers.',
    typeRef: 'Fetch.HeaderEntry'
  }, {
    name: 'binaryResponseHeaders',
    type: 'string',
    optional: !0,
    description: 'Alternative way of specifying response headers as a \\0-separated series of name: value pairs. Prefer the above method unless you need to represent some non-UTF8 values that can\'t be transmitted over the protocol as text.',
    typeRef: null
  }, {
    name: 'body',
    type: 'string',
    optional: !0,
    description: 'A response body. If absent, original response body will be used if the request is intercepted at the response stage and empty body will be used if the request is intercepted at the request stage.',
    typeRef: null
  }, {
    name: 'responsePhrase',
    type: 'string',
    ...
    typeRef: null
  }], [], 'Provides response to the request.'),e.registerCommand('Fetch.continueRequest', [{
    name: 'requestId',
    type: 'string',
    optional: !1,
    description: 'An id the client received in requestPaused event.',
    ...
    type: 'array',
    optional: !0,
    description: 'If set, overrides the request headers. Note that the overrides do not extend to subsequent redirect hops, if a redirect happens. Another override may be applied to a different request produced by a redirect.',
    typeRef: 'Fetch.HeaderEntry'
  }, {
    ...
    typeRef: null
  }], [], 'Continues the request, optionally modifying some of its parameters.'),e.registerCommand('Fetch.continueWithAuth', [{
    name: 'requestId',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Fetch.AuthChallengeResponse'
  }], [], 'Continues a request supplying authChallengeResponse following authRequired event.'),e.registerCommand('Fetch.continueResponse', [{
    name: 'requestId',
    type: 'string',
    optional: !1,
    description: 'An id the client received in requestPaused event.',
    ...
    description: 'Alternative way of specifying response headers as a \\0-separated series of name: value pairs. Prefer the above method unless you need to represent some non-UTF8 values that can\'t be transmitted over the protocol as text.',
    typeRef: null
  }], [], 'Continues loading of the paused response, optionally modifying the response headers. If either responseCode or headers are modified, all of them must be present.'),e.registerCommand('Fetch.getResponseBody', [{
    name: 'requestId',
    type: 'string',
    optional: !1,
    description: 'Identifier for the intercepted request to get body for.',
    typeRef: 'Fetch.RequestId'
  }], ['body', 'base64Encoded'], 'Causes the body of the response to be received from the server and returned as a single string. May only be issued for a request that is paused in the Response stage and is mutually exclusive with takeResponseBodyForInterceptionAsStream. Calling other methods that affect the request or disabling fetch domain before body is received results in an undefined behavior. Note that the response body is not available for redirects. Requests paused in the _redirect received_ state may be differentiated by `responseCode` and presence of `location` response header, see comments to `requestPaused` for details.'),e.registerCommand('Fetch.takeResponseBodyAsStream', [{
    name: 'requestId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Fetch.RequestId'
  }], ['stream'], 'Returns a handle to the stream representing the response body. The request must be paused in the HeadersReceived stage. Note that after this command the request can\'t be continued as is -- client either needs to cancel it or to provide the response body. The stream only supports sequential read, IO.read will fail if the position is specified. This method is mutually exclusive with getResponseBody. Calling other methods that affect the request or disabling fetch domain before body is received results in an undefined behavior.'),e.registerType('Fetch.RequestPattern', [{
    name: 'urlPattern',
    type: 'string',
    optional: !0,
    description: 'Wildcards (`\'*\'` -> zero or more, `\'?\'` -> exactly one) are allowed. Escape character is backslash. Omitting is equivalent to `\\"*\\"`.',
  ...
  }]),e.registerType('Fetch.HeaderEntry', [{
    name: 'name',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }]),e.registerType('Fetch.AuthChallenge', [{
    name: 'source',
    type: 'string',
    optional: !0,
    description: 'Source of the authentication challenge.',
    ...
    description: 'The password to provide, possibly empty. Should only be set if response is ProvideCredentials.',
    typeRef: null
  }]),e.registerEnum('WebAudio.ContextType', {
    Realtime: 'realtime',
    Offline: 'offline'
  }),e.registerEnum('WebAudio.ContextState', {
    Suspended: 'suspended',
    Running: 'running',
    Closed: 'closed'
  }),e.registerEnum('WebAudio.ChannelCountMode', {
    ClampedMax: 'clamped-max',
    Explicit: 'explicit',
    Max: 'max'
  }),e.registerEnum('WebAudio.ChannelInterpretation', {
    Discrete: 'discrete',
    Speakers: 'speakers'
  }),e.registerEnum('WebAudio.AutomationRate', {
    ARate: 'a-rate',
    KRate: 'k-rate'
  }),e.registerEvent('WebAudio.contextCreated', ['context']),e.registerEvent('WebAudio.contextWillBeDestroyed', ['contextId']),e.registerEvent('WebAudio.contextChanged', ['context']),e.registerEvent('WebAudio.audioListenerCreated', ['listener']),e.registerEvent('WebAudio.audioListenerWillBeDestroyed', ['contextId', 'listenerId']),e.registerEvent('WebAudio.audioNodeCreated', ['node']),e.registerEvent('WebAudio.audioNodeWillBeDestroyed', ['contextId', 'nodeId']),e.registerEvent('WebAudio.audioParamCreated', ['param']),e.registerEvent('WebAudio.audioParamWillBeDestroyed', ['contextId', 'nodeId', 'paramId']),e.registerEvent('WebAudio.nodesConnected', ['contextId', 'sourceId', 'destinationId', 'sourceOutputIndex', 'destinationInputIndex']),e.registerEvent('WebAudio.nodesDisconnected', ['contextId', 'sourceId', 'destinationId', 'sourceOutputIndex', 'destinationInputIndex']),e.registerEvent('WebAudio.nodeParamConnected', ['contextId', 'sourceId', 'destinationId', 'sourceOutputIndex']),e.registerEvent('WebAudio.nodeParamDisconnected', ['contextId', 'sourceId', 'destinationId', 'sourceOutputIndex']),e.registerCommand('WebAudio.enable', [], [], 'Enables the WebAudio domain and starts sending context lifetime events.'),e.registerCommand('WebAudio.disable', [], [], 'Disables the WebAudio domain.'),e.registerCommand('WebAudio.getRealtimeData', [{
    name: 'contextId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'WebAudio.GraphObjectId'
  }], ['realtimeData'], 'Fetch the realtime data from the registered contexts.'),e.registerType('WebAudio.ContextRealtimeData', [{
    name: 'currentTime',
    type: 'number',
    optional: !1,
    ...
    optional: !1,
    description: '',
    typeRef: 'WebAudio.ContextType'
  }, {
    name: 'contextState',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'WebAudio.ContextState'
  }, {
    name: 'realtimeData',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'WebAudio.ContextRealtimeData'
  }, {
    ...
    typeRef: null
  }]),e.registerType('WebAudio.AudioListener', [{
    name: 'listenerId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: 'WebAudio.GraphObjectId'
  }]),e.registerType('WebAudio.AudioNode', [{
    name: 'nodeId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'WebAudio.ChannelCountMode'
  }, {
    name: 'channelInterpretation',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'WebAudio.ChannelInterpretation'
  }]),e.registerType('WebAudio.AudioParam', [{
    name: 'paramId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'WebAudio.ParamType'
  }, {
    name: 'rate',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'WebAudio.AutomationRate'
  }, { name: 'defaultValue', type: 'number', optional: !1, description: '', typeRef: null }, {
    name: 'minValue',
    type: 'number',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }]),e.registerEnum('WebAuthn.AuthenticatorProtocol', {
    U2f: 'u2f',
    Ctap2: 'ctap2'
  }),e.registerEnum('WebAuthn.Ctap2Version', {
    Ctap2_0: 'ctap2_0',
    Ctap2_1: 'ctap2_1'
  }),e.registerEnum('WebAuthn.AuthenticatorTransport', {
    Usb: 'usb',
    Nfc: 'nfc',
    Ble: 'ble',
    Cable: 'cable',
    Internal: 'internal'
  }),e.registerEvent('WebAuthn.credentialAdded', ['authenticatorId', 'credential']),e.registerEvent('WebAuthn.credentialAsserted', ['authenticatorId', 'credential']),e.registerCommand('WebAuthn.enable', [{
    name: 'enableUI',
    type: 'boolean',
    optional: !0,
    description: 'Whether to enable the WebAuthn user interface. Enabling the UI is recommended for debugging and demo purposes, as it is closer to the real experience. Disabling the UI is recommended for automated testing. Supported at the embedder\'s discretion if UI is available. Defaults to false.',
    typeRef: null
  }], [], 'Enable the WebAuthn domain and start intercepting credential storage and retrieval with a virtual authenticator.'),e.registerCommand('WebAuthn.disable', [], [], 'Disable the WebAuthn domain.'),e.registerCommand('WebAuthn.addVirtualAuthenticator', [{
    name: 'options',
    type: 'object',
    optional: !1,
    description: '',
    typeRef: 'WebAuthn.VirtualAuthenticatorOptions'
  }], ['authenticatorId'], 'Creates and adds a virtual authenticator.'),e.registerCommand('WebAuthn.setResponseOverrideBits', [{
    name: 'authenticatorId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'WebAuthn.AuthenticatorId'
  }, {
    name: 'isBogusSignature',
    type: 'boolean',
    optional: !0,
    description: 'If isBogusSignature is set, overrides the signature in the authenticator response to be zero. Defaults to false.',
    typeRef: null
  }, {
    name: 'isBadUV',
    type: 'boolean',
    optional: !0,
    description: 'If isBadUV is set, overrides the UV bit in the flags in the authenticator response to be zero. Defaults to false.',
    typeRef: null
  }, {
    name: 'isBadUP',
    type: 'boolean',
    optional: !0,
    description: 'If isBadUP is set, overrides the UP bit in the flags in the authenticator response to be zero. Defaults to false.',
    typeRef: null
  }], [], 'Resets parameters isBogusSignature, isBadUV, isBadUP to false if they are not present.'),e.registerCommand('WebAuthn.removeVirtualAuthenticator', [{
    name: 'authenticatorId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'WebAuthn.AuthenticatorId'
  }], [], 'Removes the given authenticator.'),e.registerCommand('WebAuthn.addCredential', [{
    name: 'authenticatorId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'WebAuthn.Credential'
  }], [], 'Adds the credential to the specified authenticator.'),e.registerCommand('WebAuthn.getCredential', [{
    name: 'authenticatorId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], ['credential'], 'Returns a single credential stored in the given virtual authenticator that matches the credential ID.'),e.registerCommand('WebAuthn.getCredentials', [{
    name: 'authenticatorId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'WebAuthn.AuthenticatorId'
  }], ['credentials'], 'Returns all the credentials stored in the given virtual authenticator.'),e.registerCommand('WebAuthn.removeCredential', [{
    name: 'authenticatorId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], [], 'Removes a credential from the authenticator.'),e.registerCommand('WebAuthn.clearCredentials', [{
    name: 'authenticatorId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'WebAuthn.AuthenticatorId'
  }], [], 'Clears all the credentials from the specified device.'),e.registerCommand('WebAuthn.setUserVerified', [{
    name: 'authenticatorId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], [], 'Sets whether User Verification succeeds or fails for an authenticator. The default is true.'),e.registerCommand('WebAuthn.setAutomaticPresenceSimulation', [{
    name: 'authenticatorId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], [], 'Sets whether tests of user presence will succeed immediately (if true) or fail to resolve (if false) for an authenticator. The default is true.'),e.registerCommand('WebAuthn.setCredentialProperties', [{
    name: 'authenticatorId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], [], 'Allows setting credential properties. https://w3c.github.io/webauthn/#sctn-automation-set-credential-properties'),e.registerType('WebAuthn.VirtualAuthenticatorOptions', [{
    name: 'protocol',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'WebAuthn.AuthenticatorProtocol'
  }, {
    name: 'ctap2Version',
    type: 'string',
    optional: !0,
    description: 'Defaults to ctap2_0. Ignored if |protocol| == u2f.',
    typeRef: 'WebAuthn.Ctap2Version'
  }, {
    name: 'transport',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'WebAuthn.AuthenticatorTransport'
  }, {
    name: 'hasResidentKey',
    type: 'boolean',
    optional: !0,
    ...
    typeRef: null
  }]),e.registerType('WebAuthn.Credential', [{
    name: 'credentialId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    typeRef: null
  }]),e.registerEnum('Media.PlayerMessageLevel', {
    Error: 'error',
    Warning: 'warning',
    Info: 'info',
    Debug: 'debug'
  }),e.registerEvent('Media.playerPropertiesChanged', ['playerId', 'properties']),e.registerEvent('Media.playerEventsAdded', ['playerId', 'events']),e.registerEvent('Media.playerMessagesLogged', ['playerId', 'messages']),e.registerEvent('Media.playerErrorsRaised', ['playerId', 'errors']),e.registerEvent('Media.playersCreated', ['players']),e.registerCommand('Media.enable', [], [], 'Enables the Media domain'),e.registerCommand('Media.disable', [], [], 'Disables the Media domain.'),e.registerType('Media.PlayerMessage', [{
    name: 'level',
    type: 'string',
    optional: !1,
    ...
    description: '',
    typeRef: null
  }]),e.registerType('Media.PlayerProperty', [{
    name: 'name',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }]),e.registerType('Media.PlayerEvent', [{
    name: 'timestamp',
    type: 'number',
    optional: !1,
    description: '',
    typeRef: 'Media.Timestamp'
  }, {
    name: 'value',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }]),e.registerType('Media.PlayerErrorSourceLocation', [{
    name: 'file',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }]),e.registerType('Media.PlayerError', [{
    name: 'errorType',
    type: 'string',
    optional: !1,
    description: '',
    ...
    typeRef: null
  }]),e.registerEvent('DeviceAccess.deviceRequestPrompted', ['id', 'devices']),e.registerCommand('DeviceAccess.enable', [], [], 'Enable events in this domain.'),e.registerCommand('DeviceAccess.disable', [], [], 'Disable events in this domain.'),e.registerCommand('DeviceAccess.selectPrompt', [{
    name: 'id',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'DeviceAccess.RequestId'
  }, {
    name: 'deviceId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'DeviceAccess.DeviceId'
  }], [], 'Select a device in response to a DeviceAccess.deviceRequestPrompted event.'),e.registerCommand('DeviceAccess.cancelPrompt', [{
    name: 'id',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'DeviceAccess.RequestId'
  }], [], 'Cancel a prompt in response to a DeviceAccess.deviceRequestPrompted event.'),e.registerType('DeviceAccess.PromptDevice', [{
    name: 'id',
    type: 'string',
    optional: !1,
    description: '',
    ...
    typeRef: null
  }]),e.registerEnum('Preload.RuleSetErrorType', {
    SourceIsNotJsonObject: 'SourceIsNotJsonObject',
    InvalidRulesSkipped: 'InvalidRulesSkipped'
  }),e.registerEnum('Preload.SpeculationAction', {
    Prefetch: 'Prefetch',
    Prerender: 'Prerender'
  }),e.registerEnum('Preload.SpeculationTargetHint', {
    Blank: 'Blank',
    Self: 'Self'
  }),e.registerEnum('Preload.PrerenderFinalStatus', {
    Activated: 'Activated',
    Destroyed: 'Destroyed',
    ...
    Failure: 'Failure',
    NotSupported: 'NotSupported'
  }),e.registerEnum('Preload.PrefetchStatus', {
  ...
  }),e.registerEvent('Preload.ruleSetUpdated', ['ruleSet']),e.registerEvent('Preload.ruleSetRemoved', ['id']),e.registerEvent('Preload.preloadEnabledStateUpdated', ['disabledByPreference', 'disabledByDataSaver', 'disabledByBatterySaver', 'disabledByHoldbackPrefetchSpeculationRules', 'disabledByHoldbackPrerenderSpeculationRules']),e.registerEvent('Preload.prefetchStatusUpdated', ['key', 'initiatingFrameId', 'prefetchUrl', 'status', 'prefetchStatus', 'requestId']),e.registerEvent('Preload.prerenderStatusUpdated', ['key', 'status', 'prerenderStatus', 'disallowedMojoInterface', 'mismatchedHeaders']),e.registerEvent('Preload.preloadingAttemptSourcesUpdated', ['loaderId', 'preloadingAttemptSources']),e.registerCommand('Preload.enable', [], [], ''),e.registerCommand('Preload.disable', [], [], ''),e.registerType('Preload.RuleSet', [{
    name: 'id',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Preload.RuleSetId'
  }, {
    name: 'loaderId',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'DOM.BackendNodeId'
  }, { name: 'url', type: 'string', optional: !0, description: '', typeRef: null }, {
    name: 'requestId',
    type: 'string',
    optional: !0,
    description: '',
    ...
    typeRef: 'Preload.RuleSetErrorType'
  }, {
    name: 'errorMessage',
    type: 'string',
    optional: !0,
    ...
    typeRef: null
  }]),e.registerType('Preload.PreloadingAttemptKey', [{
    name: 'loaderId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'Preload.SpeculationAction'
  }, { name: 'url', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'targetHint',
    type: 'string',
    optional: !0,
    description: '',
    typeRef: 'Preload.SpeculationTargetHint'
  }]),e.registerType('Preload.PreloadingAttemptSource', [{
    name: 'key',
    type: 'object',
    optional: !1,
    description: '',
    typeRef: 'Preload.PreloadingAttemptKey'
  }, {
    name: 'ruleSetIds',
    type: 'array',
    optional: !1,
    ...
    description: '',
    typeRef: 'DOM.BackendNodeId'
  }]),e.registerType('Preload.PrerenderMismatchedHeaders', [{
    name: 'headerName',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }, { name: 'initialValue', type: 'string', optional: !0, description: '', typeRef: null }, {
    name: 'activationValue',
    type: 'string',
    optional: !0,
    description: '',
    typeRef: null
  }]),e.registerEnum('FedCm.LoginState', {
    SignIn: 'SignIn',
    SignUp: 'SignUp'
  }),e.registerEnum('FedCm.DialogType', {
    AccountChooser: 'AccountChooser',
    AutoReauthn: 'AutoReauthn',
    ConfirmIdpLogin: 'ConfirmIdpLogin',
    Error: 'Error'
  }),e.registerEnum('FedCm.DialogButton', {
    ConfirmIdpLoginContinue: 'ConfirmIdpLoginContinue',
    ErrorGotIt: 'ErrorGotIt',
    ErrorMoreDetails: 'ErrorMoreDetails'
  }),e.registerEnum('FedCm.AccountUrlType', {
    TermsOfService: 'TermsOfService',
    PrivacyPolicy: 'PrivacyPolicy'
  }),e.registerEvent('FedCm.dialogShown', ['dialogId', 'dialogType', 'accounts', 'title', 'subtitle']),e.registerEvent('FedCm.dialogClosed', ['dialogId']),e.registerCommand('FedCm.enable', [{
    name: 'disableRejectionDelay',
    type: 'boolean',
    optional: !0,
    description: 'Allows callers to disable the promise rejection delay that would normally happen, if this is unimportant to what\'s being tested. (step 4 of https://fedidcg.github.io/FedCM/#browser-api-rp-sign-in)',
    typeRef: null
  }], [], ''),e.registerCommand('FedCm.disable', [], [], ''),e.registerCommand('FedCm.selectAccount', [{
    name: 'dialogId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], [], ''),e.registerCommand('FedCm.clickDialogButton', [{
    name: 'dialogId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'FedCm.DialogButton'
  }], [], ''),e.registerCommand('FedCm.openUrl', [{
    name: 'dialogId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'FedCm.AccountUrlType'
  }], [], ''),e.registerCommand('FedCm.dismissDialog', [{
    name: 'dialogId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], [], ''),e.registerCommand('FedCm.resetCooldown', [], [], 'Resets the cooldown time, if any, to allow the next FedCM call to show a dialog even if one was recently dismissed by the user.'),e.registerType('FedCm.Account', [{
    name: 'accountId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }, { name: 'email', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'name',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }, { name: 'givenName', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'pictureUrl',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }, { name: 'idpConfigUrl', type: 'string', optional: !1, description: '', typeRef: null }, {
    name: 'idpLoginUrl',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }]),e.registerEnum('PWA.DisplayMode', {
    Standalone: 'standalone',
    Browser: 'browser'
  }),e.registerCommand('PWA.getOsAppState', [{
    name: 'manifestId',
    type: 'string',
    optional: !1,
    description: 'The id from the webapp\'s manifest file, commonly it\'s the url of the site installing the webapp. See https://web.dev/learn/pwa/web-app-manifest.',
    typeRef: null
  }], ['badgeCount', 'fileHandlers'], 'Returns the following OS state for the given manifest id.'),e.registerCommand('PWA.install', [{
    name: 'manifestId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    type: 'string',
    optional: !0,
    description: 'The location of the app or bundle overriding the one derived from the manifestId.',
    typeRef: null
  }], [], 'Installs the given manifest identity, optionally using the given install_url or IWA bundle location.  TODO(crbug.com/337872319) Support IWA to meet the following specific requirement. IWA-specific install description: If the manifest_id is isolated-app://, install_url_or_bundle_url is required, and can be either an http(s) URL or file:// URL pointing to a signed web bundle (.swbn). The .swbn file\'s signing key must correspond to manifest_id. If Chrome is not in IWA dev mode, the installation will fail, regardless of the state of the allowlist.'),e.registerCommand('PWA.uninstall', [{
    name: 'manifestId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], [], 'Uninstalls the given manifest_id and closes any opened app windows.'),e.registerCommand('PWA.launch', [{
    name: 'manifestId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }], ['targetId'], 'Launches the installed web app, or an url in the same web app instead of the default start url if it is provided. Returns a page Target.TargetID which can be used to attach to via Target.attachToTarget or similar APIs.'),e.registerCommand('PWA.launchFilesInApp', [{
    name: 'manifestId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: 'string'
  }], ['targetIds'], 'Opens one or more local files from an installed web app identified by its manifestId. The web app needs to have file handlers registered to process the files. The API returns one or more page Target.TargetIDs which can be used to attach to via Target.attachToTarget or similar APIs. If some files in the parameters cannot be handled by the web app, they will be ignored. If none of the files can be handled, this API returns an error. If no files are provided as the parameter, this API also returns an error.  According to the definition of the file handlers in the manifest file, one Target.TargetID may represent a page handling one or more files. The order of the returned Target.TargetIDs is not guaranteed.  TODO(crbug.com/339454034): Check the existences of the input files.'),e.registerCommand('PWA.openCurrentPageInApp', [{
    name: 'manifestId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], [], 'Opens the current page in its web app identified by the manifest id, needs to be called on a page target. This function returns immediately without waiting for the app to finish loading.'),e.registerCommand('PWA.changeAppUserSettings', [{
    name: 'manifestId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: 'string'
  }]),e.registerType('PWA.FileHandler', [{
    name: 'action',
    type: 'string',
    optional: !1,
    description: '',
  ...
  }),e.registerCommand('BluetoothEmulation.enable', [{
    name: 'state',
    type: 'string',
    optional: !1,
    description: 'State of the simulated central.',
    typeRef: 'BluetoothEmulation.CentralState'
  }], [], 'Enable the BluetoothEmulation domain.'),e.registerCommand('BluetoothEmulation.disable', [], [], 'Disable the BluetoothEmulation domain.'),e.registerCommand('BluetoothEmulation.simulatePreconnectedPeripheral', [{
    name: 'address',
    type: 'string',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'BluetoothEmulation.ManufacturerData'
  }, {
    ...
    description: '',
    typeRef: 'string'
  }], [], 'Simulates a peripheral with |address|, |name| and |knownServiceUuids| that has already been connected to the system.'),e.registerCommand('BluetoothEmulation.simulateAdvertisement', [{
    name: 'entry',
    type: 'object',
    optional: !1,
    description: '',
    typeRef: 'BluetoothEmulation.ScanEntry'
  }], [], 'Simulates an advertisement packet described in |entry| being received by the central.'),e.registerType('BluetoothEmulation.ManufacturerData', [{
    name: 'key',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('BluetoothEmulation.ScanRecord', [{
    name: 'name',
    type: 'string',
    optional: !0,
    description: '',
    typeRef: null
  }, { name: 'uuids', type: 'array', optional: !0, description: '', typeRef: 'string' }, {
    name: 'appearance',
    type: 'number',
    optional: !0,
    ...
    typeRef: 'BluetoothEmulation.ManufacturerData'
  }]),e.registerType('BluetoothEmulation.ScanEntry', [{
    name: 'deviceAddress',
    type: 'string',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'BluetoothEmulation.ScanRecord'
  }]),e.registerEnum('Debugger.ScopeType', {
    Global: 'global',
    Local: 'local',
    With: 'with',
    Closure: 'closure',
  ...
  }),e.registerEnum('Debugger.BreakLocationType', {
    DebuggerStatement: 'debuggerStatement',
    Call: 'call',
    Return: 'return'
  }),e.registerEnum('Debugger.ScriptLanguage', {
    JavaScript: 'JavaScript',
    WebAssembly: 'WebAssembly'
  }),e.registerEnum('Debugger.DebugSymbolsType', {
    None: 'None',
    SourceMap: 'SourceMap',
    EmbeddedDWARF: 'EmbeddedDWARF',
    ExternalDWARF: 'ExternalDWARF'
  }),e.registerEvent('Debugger.breakpointResolved', ['breakpointId', 'location']),e.registerEnum('Debugger.PausedEventReason', {
    Ambiguous: 'ambiguous',
    Assert: 'assert',
    ...
    XHR: 'XHR',
    Step: 'step'
  }),e.registerEvent('Debugger.paused', ['callFrames', 'reason', 'data', 'hitBreakpoints', 'asyncStackTrace', 'asyncStackTraceId', 'asyncCallStackTraceId']),e.registerEvent('Debugger.resumed', []),e.registerEvent('Debugger.scriptFailedToParse', ['scriptId', 'url', 'startLine', 'startColumn', 'endLine', 'endColumn', 'executionContextId', 'hash', 'executionContextAuxData', 'sourceMapURL', 'hasSourceURL', 'isModule', 'length', 'stackTrace', 'codeOffset', 'scriptLanguage', 'embedderName']),e.registerEvent('Debugger.scriptParsed', ['scriptId', 'url', 'startLine', 'startColumn', 'endLine', 'endColumn', 'executionContextId', 'hash', 'executionContextAuxData', 'isLiveEdit', 'sourceMapURL', 'hasSourceURL', 'isModule', 'length', 'stackTrace', 'codeOffset', 'scriptLanguage', 'debugSymbols', 'embedderName']),e.registerEnum('Debugger.ContinueToLocationRequestTargetCallFrames', {
    Any: 'any',
    Current: 'current'
  }),e.registerCommand('Debugger.continueToLocation', [{
    name: 'location',
    type: 'object',
    optional: !1,
    description: 'Location to continue to.',
    typeRef: 'Debugger.Location'
  }, {
    name: 'targetCallFrames',
    type: 'string',
    optional: !0,
    description: '',
    typeRef: 'Debugger.ContinueToLocationRequestTargetCallFrames'
  }], [], 'Continues execution until specific location is reached.'),e.registerCommand('Debugger.disable', [], [], 'Disables debugger for given page.'),e.registerCommand('Debugger.enable', [{
    name: 'maxScriptsCacheSize',
    type: 'number',
    optional: !0,
    description: 'The maximum size in bytes of collected scripts (not referenced by other heap objects) the debugger can hold. Puts no limit if parameter is omitted.',
    typeRef: null
  }], ['debuggerId'], 'Enables debugger for the given page. Clients should not assume that the debugging has been enabled until the result for this command is received.'),e.registerCommand('Debugger.evaluateOnCallFrame', [{
    name: 'callFrameId',
    type: 'string',
    optional: !1,
    description: 'Call frame identifier to evaluate on.',
    typeRef: 'Debugger.CallFrameId'
  }, {
    name: 'expression',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Runtime.TimeDelta'
  }], ['result', 'exceptionDetails'], 'Evaluates expression on a given call frame.'),e.registerCommand('Debugger.getPossibleBreakpoints', [{
    name: 'start',
    type: 'object',
    optional: !1,
    ...
    typeRef: null
  }], ['locations'], 'Returns possible locations for breakpoint. scriptId in start and end range locations should be the same.'),e.registerCommand('Debugger.getScriptSource', [{
    name: 'scriptId',
    type: 'string',
    optional: !1,
    description: 'Id of the script to get source for.',
    typeRef: 'Runtime.ScriptId'
  }], ['scriptSource', 'bytecode'], 'Returns source for the script with given id.'),e.registerCommand('Debugger.disassembleWasmModule', [{
    name: 'scriptId',
    type: 'string',
    optional: !1,
    description: 'Id of the script to disassemble',
    typeRef: 'Runtime.ScriptId'
  }], ['streamId', 'totalNumberOfLines', 'functionBodyOffsets', 'chunk'], ''),e.registerCommand('Debugger.nextWasmDisassemblyChunk', [{
    name: 'streamId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], ['chunk'], 'Disassemble the next chunk of lines for the module corresponding to the stream. If disassembly is complete, this API will invalidate the streamId and return an empty chunk. Any subsequent calls for the now invalid stream will return errors.'),e.registerCommand('Debugger.getWasmBytecode', [{
    name: 'scriptId',
    type: 'string',
    optional: !1,
    description: 'Id of the Wasm script to get source for.',
    typeRef: 'Runtime.ScriptId'
  }], ['bytecode'], 'This command is deprecated. Use getScriptSource instead.'),e.registerCommand('Debugger.getStackTrace', [{
    name: 'stackTraceId',
    type: 'object',
    optional: !1,
    description: '',
    typeRef: 'Runtime.StackTraceId'
  }], ['stackTrace'], 'Returns stack trace with given `stackTraceId`.'),e.registerCommand('Debugger.pause', [], [], 'Stops on the next JavaScript statement.'),e.registerCommand('Debugger.pauseOnAsyncCall', [{
    name: 'parentStackTraceId',
    type: 'object',
    optional: !1,
    description: 'Debugger will pause when async call with given stack trace is started.',
    typeRef: 'Runtime.StackTraceId'
  }], [], ''),e.registerCommand('Debugger.removeBreakpoint', [{
    name: 'breakpointId',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: 'Debugger.BreakpointId'
  }], [], 'Removes JavaScript breakpoint.'),e.registerEnum('Debugger.RestartFrameRequestMode', { StepInto: 'StepInto' }),e.registerCommand('Debugger.restartFrame', [{
    name: 'callFrameId',
    type: 'string',
    optional: !1,
    description: 'Call frame identifier to evaluate on.',
    ...
    type: 'string',
    optional: !0,
    description: 'The `mode` parameter must be present and set to \'StepInto\', otherwise `restartFrame` will error out.',
    typeRef: 'Debugger.RestartFrameRequestMode'
  }], ['callFrames', 'asyncStackTrace', 'asyncStackTraceId'], 'Restarts particular call frame from the beginning. The old, deprecated behavior of `restartFrame` is to stay paused and allow further CDP commands after a restart was scheduled. This can cause problems with restarting, so we now continue execution immediatly after it has been scheduled until we reach the beginning of the restarted frame.  To stay back-wards compatible, `restartFrame` now expects a `mode` parameter to be present. If the `mode` parameter is missing, `restartFrame` errors out.  The various return values are deprecated and `callFrames` is always empty. Use the call frames from the `Debugger#paused` events instead, that fires once V8 pauses at the beginning of the restarted function.'),e.registerCommand('Debugger.resume', [{
    ...
    typeRef: null
  }], [], 'Resumes JavaScript execution.'),e.registerCommand('Debugger.searchInContent', [{
    name: 'scriptId',
    type: 'string',
    optional: !1,
    ...
    description: 'If true, treats string parameter as regex.',
    typeRef: null
  }], ['result'], 'Searches for given string in script content.'),e.registerCommand('Debugger.setAsyncCallStackDepth', [{
    name: 'maxDepth',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }], [], 'Enables or disables async call stacks tracking.'),e.registerCommand('Debugger.setBlackboxPatterns', [{
    name: 'patterns',
    type: 'array',
    optional: !1,
    description: 'Array of regexps that will be used to check script url for blackbox state.',
    typeRef: 'string'
  }], [], 'Replace previous blackbox patterns with passed ones. Forces backend to skip stepping/pausing in scripts with url matching one of the patterns. VM will try to leave blackboxed script by performing \'step in\' several times, finally resorting to \'step out\' if unsuccessful.'),e.registerCommand('Debugger.setBlackboxedRanges', [{
    name: 'scriptId',
    type: 'string',
    optional: !1,
    ...
    optional: !1,
    description: '',
    typeRef: 'Debugger.ScriptPosition'
  }], [], 'Makes backend skip steps in the script in blackboxed ranges. VM will try leave blacklisted scripts by performing \'step in\' several times, finally resorting to \'step out\' if unsuccessful. Positions array contains positions where blackbox state is changed. First interval isn\'t blackboxed. Array should be sorted.'),e.registerCommand('Debugger.setBreakpoint', [{
    name: 'location',
    type: 'object',
    optional: !1,
    ...
    typeRef: null
  }], ['breakpointId', 'actualLocation'], 'Sets JavaScript breakpoint at a given location.'),e.registerEnum('Debugger.SetInstrumentationBreakpointRequestInstrumentation', {
    BeforeScriptExecution: 'beforeScriptExecution',
    BeforeScriptWithSourceMapExecution: 'beforeScriptWithSourceMapExecution'
  }),e.registerCommand('Debugger.setInstrumentationBreakpoint', [{
    name: 'instrumentation',
    type: 'string',
    optional: !1,
    description: 'Instrumentation name.',
    typeRef: 'Debugger.SetInstrumentationBreakpointRequestInstrumentation'
  }], ['breakpointId'], 'Sets instrumentation breakpoint.'),e.registerCommand('Debugger.setBreakpointByUrl', [{
    name: 'lineNumber',
    type: 'number',
    optional: !1,
    ...
    type: 'string',
    optional: !0,
    description: 'Expression to use as a breakpoint condition. When specified, debugger will stop on the breakpoint if this expression evaluates to true.',
    typeRef: null
  }], ['breakpointId'], 'Sets JavaScript breakpoint before each call to the given function. If another function was created from the same source as a given one, calling it will also trigger the breakpoint.'),e.registerCommand('Debugger.setBreakpointsActive', [{
    name: 'active',
    type: 'boolean',
    optional: !1,
    description: 'New value for breakpoints active state.',
    typeRef: null
  }], [], 'Activates / deactivates all breakpoints on the page.'),e.registerEnum('Debugger.SetPauseOnExceptionsRequestState', {
    None: 'none',
    Caught: 'caught',
    Uncaught: 'uncaught',
    All: 'all'
  }),e.registerCommand('Debugger.setPauseOnExceptions', [{
    name: 'state',
    type: 'string',
    optional: !1,
    description: 'Pause on exceptions mode.',
    typeRef: 'Debugger.SetPauseOnExceptionsRequestState'
  }], [], 'Defines pause on exceptions state. Can be set to stop on all exceptions, uncaught exceptions, or caught exceptions, no exceptions. Initial pause on exceptions state is `none`.'),e.registerCommand('Debugger.setReturnValue', [{
    name: 'newValue',
    type: 'object',
    optional: !1,
    description: 'New return value.',
    typeRef: 'Runtime.CallArgument'
  }], [], 'Changes return value in top frame. Available only at return break position.'),e.registerCommand('Debugger.setScriptSource', [{
    name: 'scriptId',
    type: 'string',
    optional: !1,
    ...
    type: 'boolean',
    optional: !0,
    description: 'If true, then `scriptSource` is allowed to change the function on top of the stack as long as the top-most stack frame is the only activation of that function.',
    typeRef: null
  }], ['callFrames', 'stackChanged', 'asyncStackTrace', 'asyncStackTraceId', 'status', 'exceptionDetails'], 'Edits JavaScript source live.  In general, functions that are currently on the stack can not be edited with a single exception: If the edited function is the top-most stack frame and that is the only activation of that function on the stack. In this case the live edit will be successful and a `Debugger.restartFrame` for the top-most function is automatically triggered.'),e.registerCommand('Debugger.setSkipAllPauses', [{
    name: 'skip',
    type: 'boolean',
    optional: !1,
    description: 'New value for skip pauses state.',
    typeRef: null
  }], [], 'Makes page not interrupt on any pauses (breakpoint, exception, dom exception etc).'),e.registerCommand('Debugger.setVariableValue', [{
    name: 'scopeNumber',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'Debugger.CallFrameId'
  }], [], 'Changes value of variable in a callframe. Object-based scopes are not supported and must be mutated manually.'),e.registerCommand('Debugger.stepInto', [{
    name: 'breakOnAsyncCall',
    type: 'boolean',
    optional: !0,
    description: 'Debugger will pause on the execution of the first async task which was scheduled before next pause.',
    typeRef: null
  }, {
    name: 'skipList',
    type: 'array',
    ...
    typeRef: 'Debugger.LocationRange'
  }], [], 'Steps into the function call.'),e.registerCommand('Debugger.stepOut', [], [], 'Steps out of the function call.'),e.registerCommand('Debugger.stepOver', [{
    name: 'skipList',
    type: 'array',
    optional: !0,
    description: 'The skipList specifies location ranges that should be skipped on step over.',
    typeRef: 'Debugger.LocationRange'
  }], [], 'Steps over the statement.'),e.registerType('Debugger.Location', [{
    name: 'scriptId',
    type: 'string',
    optional: !1,
    ...
    description: 'Column number in the script (0-based).',
    typeRef: null
  }]),e.registerType('Debugger.ScriptPosition', [{
    name: 'lineNumber',
    type: 'number',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: null
  }]),e.registerType('Debugger.LocationRange', [{
    name: 'scriptId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: 'Debugger.ScriptPosition'
  }]),e.registerType('Debugger.CallFrame', [{
    name: 'callFrameId',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Debugger.Location'
  }]),e.registerType('Debugger.SearchMatch', [{
    name: 'lineNumber',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Debugger.BreakLocation', [{
    name: 'scriptId',
    type: 'string',
    optional: !1,
    description: 'Script identifier as reported in the `Debugger.scriptParsed`.',
    ...
    description: '',
    typeRef: null
  }]),e.registerType('Debugger.WasmDisassemblyChunk', [{
    name: 'lines',
    type: 'array',
    optional: !1,
    ...
    typeRef: 'integer'
  }]),e.registerType('Debugger.DebugSymbols', [{
    name: 'type',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'HeapProfiler.HeapSnapshotObjectId'
  }], [], 'Enables console to refer to the node with given id via $x (see Command Line API for more details $x functions).'),e.registerCommand('HeapProfiler.collectGarbage', [], [], ''),e.registerCommand('HeapProfiler.disable', [], [], ''),e.registerCommand('HeapProfiler.enable', [], [], ''),e.registerCommand('HeapProfiler.getHeapObjectId', [{
    name: 'objectId',
    type: 'string',
    optional: !1,
    description: 'Identifier of the object to get heap object id for.',
    typeRef: 'Runtime.RemoteObjectId'
  }], ['heapSnapshotObjectId'], ''),e.registerCommand('HeapProfiler.getObjectByHeapObjectId', [{
    name: 'objectId',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: 'Symbolic group name that can be used to release multiple objects.',
    typeRef: null
  }], ['result'], ''),e.registerCommand('HeapProfiler.getSamplingProfile', [], ['profile'], ''),e.registerCommand('HeapProfiler.startSampling', [{
    name: 'samplingInterval',
    type: 'number',
    optional: !0,
    ...
    typeRef: null
  }], [], ''),e.registerCommand('HeapProfiler.startTrackingHeapObjects', [{
    name: 'trackAllocations',
    type: 'boolean',
    optional: !0,
    description: '',
    typeRef: null
  }], [], ''),e.registerCommand('HeapProfiler.stopSampling', [], ['profile'], ''),e.registerCommand('HeapProfiler.stopTrackingHeapObjects', [{
    name: 'reportProgress',
    type: 'boolean',
    optional: !0,
    ...
    typeRef: null
  }], [], ''),e.registerCommand('HeapProfiler.takeHeapSnapshot', [{
    name: 'reportProgress',
    type: 'boolean',
    optional: !0,
    ...
    type: 'boolean',
    optional: !0,
    description: 'If true, a raw snapshot without artificial roots will be generated. Deprecated in favor of `exposeInternals`.',
    typeRef: null
  }, {
    name: 'captureNumericValue',
    type: 'boolean',
    ...
    description: 'If true, exposes internals of the snapshot.',
    typeRef: null
  }], [], ''),e.registerType('HeapProfiler.SamplingHeapProfileNode', [{
    name: 'callFrame',
    type: 'object',
    optional: !1,
    description: 'Function location.',
    typeRef: 'Runtime.CallFrame'
  }, {
    name: 'selfSize',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'HeapProfiler.SamplingHeapProfileNode'
  }]),e.registerType('HeapProfiler.SamplingHeapProfileSample', [{
    name: 'size',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('HeapProfiler.SamplingHeapProfile', [{
    name: 'head',
    type: 'object',
    optional: !1,
    description: '',
    ...
    optional: !1,
    description: '',
    typeRef: 'HeapProfiler.SamplingHeapProfileSample'
  }]),e.registerEvent('Profiler.consoleProfileFinished', ['id', 'location', 'profile', 'title']),e.registerEvent('Profiler.consoleProfileStarted', ['id', 'location', 'title']),e.registerEvent('Profiler.preciseCoverageDeltaUpdate', ['timestamp', 'occasion', 'result']),e.registerCommand('Profiler.disable', [], [], ''),e.registerCommand('Profiler.enable', [], [], ''),e.registerCommand('Profiler.getBestEffortCoverage', [], ['result'], 'Collect coverage data for the current isolate. The coverage data may be incomplete due to garbage collection.'),e.registerCommand('Profiler.setSamplingInterval', [{
    name: 'interval',
    type: 'number',
    optional: !1,
    description: 'New sampling interval in microseconds.',
    typeRef: null
  }], [], 'Changes CPU profiler sampling interval. Must be called before CPU profiles recording started.'),e.registerCommand('Profiler.start', [], [], ''),e.registerCommand('Profiler.startPreciseCoverage', [{
    name: 'callCount',
    type: 'boolean',
    optional: !0,
    ...
    typeRef: null
  }], ['timestamp'], 'Enable precise code coverage. Coverage data for JavaScript executed before enabling precise code coverage may be incomplete. Enabling prevents running optimized code and resets execution counters.'),e.registerCommand('Profiler.stop', [], ['profile'], ''),e.registerCommand('Profiler.stopPreciseCoverage', [], [], 'Disable precise code coverage. Disabling releases unnecessary execution count records and allows executing optimized code.'),e.registerCommand('Profiler.takePreciseCoverage', [], ['result', 'timestamp'], 'Collect coverage data for the current isolate, and resets execution counters. Precise code coverage needs to have started.'),e.registerType('Profiler.ProfileNode', [{
    name: 'id',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'Profiler.PositionTickInfo'
  }]),e.registerType('Profiler.Profile', [{
    name: 'nodes',
    type: 'array',
    optional: !1,
    description: 'The list of profile nodes. First item is the root node.',
    typeRef: 'Profiler.ProfileNode'
  }, {
    name: 'startTime',
    type: 'number',
    optional: !1,
    ...
    typeRef: 'integer'
  }]),e.registerType('Profiler.PositionTickInfo', [{
    name: 'line',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Profiler.CoverageRange', [{
    name: 'startOffset',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Profiler.FunctionCoverage', [{
    name: 'functionName',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Profiler.CoverageRange'
  }, {
    ...
    typeRef: null
  }]),e.registerType('Profiler.ScriptCoverage', [{
    name: 'scriptId',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Profiler.FunctionCoverage'
  }]),e.registerEnum('Runtime.SerializationOptionsSerialization', {
    Deep: 'deep',
    Json: 'json',
    IdOnly: 'idOnly'
  }),e.registerEnum('Runtime.DeepSerializedValueType', {
    Undefined: 'undefined',
    Null: 'null',
    String: 'string',
    Number: 'number',
    ...
    Window: 'window',
    Generator: 'generator'
  }),e.registerEnum('Runtime.RemoteObjectType', {
    Object: 'object',
    Function: 'function',
    Undefined: 'undefined',
    String: 'string',
    ...
    Symbol: 'symbol',
    Bigint: 'bigint'
  }),e.registerEnum('Runtime.RemoteObjectSubtype', {
    Array: 'array',
    Null: 'null',
    Node: 'node',
    Regexp: 'regexp',
    ...
    Wasmvalue: 'wasmvalue'
  }),e.registerEnum('Runtime.ObjectPreviewType', {
    Object: 'object',
    Function: 'function',
    Undefined: 'undefined',
    String: 'string',
    ...
    Symbol: 'symbol',
    Bigint: 'bigint'
  }),e.registerEnum('Runtime.ObjectPreviewSubtype', {
    Array: 'array',
    Null: 'null',
    Node: 'node',
    Regexp: 'regexp',
    ...
    Webassemblymemory: 'webassemblymemory',
    Wasmvalue: 'wasmvalue'
  }),e.registerEnum('Runtime.PropertyPreviewType', {
    Object: 'object',
    Function: 'function',
    Undefined: 'undefined',
    String: 'string',
    ...
    Accessor: 'accessor',
    Bigint: 'bigint'
  }),e.registerEnum('Runtime.PropertyPreviewSubtype', {
    Array: 'array',
    Null: 'null',
    Node: 'node',
    Regexp: 'regexp',
    ...
    Webassemblymemory: 'webassemblymemory',
    Wasmvalue: 'wasmvalue'
  }),e.registerEvent('Runtime.bindingCalled', ['name', 'payload', 'executionContextId']),e.registerEnum('Runtime.ConsoleAPICalledEventType', {
    Log: 'log',
    Debug: 'debug',
    Info: 'info',
    Error: 'error',
    ...
    Count: 'count',
    TimeEnd: 'timeEnd'
  }),e.registerEvent('Runtime.consoleAPICalled', ['type', 'args', 'executionContextId', 'timestamp', 'stackTrace', 'context']),e.registerEvent('Runtime.exceptionRevoked', ['reason', 'exceptionId']),e.registerEvent('Runtime.exceptionThrown', ['timestamp', 'exceptionDetails']),e.registerEvent('Runtime.executionContextCreated', ['context']),e.registerEvent('Runtime.executionContextDestroyed', ['executionContextId', 'executionContextUniqueId']),e.registerEvent('Runtime.executionContextsCleared', []),e.registerEvent('Runtime.inspectRequested', ['object', 'hints', 'executionContextId']),e.registerCommand('Runtime.awaitPromise', [{
    ...
    type: 'object',
    optional: !0,
    description: 'Specifies the result serialization. If provided, overrides `generatePreview` and `returnByValue`.',
    typeRef: 'Runtime.SerializationOptions'
  }], ['result', 'exceptionDetails'], 'Calls function with given declaration on the given object. Object group of the result is inherited from the target object.'),e.registerCommand('Runtime.compileScript', [{
    name: 'expression',
    type: 'string',
    optional: !1,
    ...
    type: 'number',
    optional: !0,
    description: 'Specifies in which execution context to perform evaluation. If the parameter is omitted the evaluation will be performed in the context of the inspected page. This is mutually exclusive with `uniqueContextId`, which offers an alternative way to identify the execution context that is more reliable in a multi-process environment.',
    typeRef: 'Runtime.ExecutionContextId'
  }, {
    name: 'returnByValue',
    type: 'boolean',
    ...
    type: 'boolean',
    optional: !0,
    description: 'Whether to throw an exception if side effect cannot be ruled out during evaluation. This implies `disableBreaks` below.',
    typeRef: null
  }, {
    name: 'timeout',
    type: 'number',
    ...
    type: 'boolean',
    optional: !0,
    description: 'Setting this flag to true enables `let` re-declaration and top-level `await`. Note that `let` variables can only be re-declared if they originate from `replMode` themselves.',
    typeRef: null
  }, {
    name: 'allowUnsafeEvalBlockedByCSP',
    type: 'boolean',
    optional: !0,
    description: 'The Content Security Policy (CSP) for the target might block \'unsafe-eval\' which includes eval(), Function(), setTimeout() and setInterval() when called with non-callable arguments. This flag bypasses CSP for this evaluation and allows unsafe-eval. Defaults to true.',
    typeRef: null
  }, {
    name: 'uniqueContextId',
    type: 'string',
    ...
    description: 'Specifies the result serialization. If provided, overrides `generatePreview` and `returnByValue`.',
    typeRef: 'Runtime.SerializationOptions'
  }], ['result', 'exceptionDetails'], 'Evaluates expression on global object.'),e.registerCommand('Runtime.getIsolateId', [], ['id'], 'Returns the isolate id.'),e.registerCommand('Runtime.getHeapUsage', [], ['usedSize', 'totalSize'], 'Returns the JavaScript heap usage. It is the total usage of the corresponding isolate not scoped to a particular Runtime.'),e.registerCommand('Runtime.getProperties', [{
    name: 'objectId',
    type: 'string',
    optional: !1,
    ...
    typeRef: null
  }], ['result', 'internalProperties', 'privateProperties', 'exceptionDetails'], 'Returns properties of a given object. Object group of the result is inherited from the target object.'),e.registerCommand('Runtime.globalLexicalScopeNames', [{
    name: 'executionContextId',
    type: 'number',
    optional: !0,
    description: 'Specifies in which execution context to lookup global scope variables.',
    typeRef: 'Runtime.ExecutionContextId'
  }], ['names'], 'Returns all let, const and class variables from global scope.'),e.registerCommand('Runtime.queryObjects', [{
    ...
    typeRef: null
  }], ['objects'], ''),e.registerCommand('Runtime.releaseObject', [{
    name: 'objectId',
    type: 'string',
    optional: !1,
    description: 'Identifier of the object to release.',
    typeRef: 'Runtime.RemoteObjectId'
  }], [], 'Releases remote object with given id.'),e.registerCommand('Runtime.releaseObjectGroup', [{
    name: 'objectGroup',
    type: 'string',
    optional: !1,
    description: 'Symbolic object group name.',
    typeRef: null
  }], [], 'Releases all remote objects that belong to a given group.'),e.registerCommand('Runtime.runIfWaitingForDebugger', [], [], 'Tells inspected instance to run if it was waiting for debugger to attach.'),e.registerCommand('Runtime.runScript', [{
    name: 'scriptId',
    type: 'string',
    optional: !1,
    ...
    description: 'Whether execution should `await` for resulting value and return once awaited promise is resolved.',
    typeRef: null
  }], ['result', 'exceptionDetails'], 'Runs script with given id in a given context.'),e.registerCommand('Runtime.setAsyncCallStackDepth', [{
    name: 'maxDepth',
    type: 'number',
    optional: !1,
    description: 'Maximum depth of async call stacks. Setting to `0` will effectively disable collecting async call stacks (default).',
    typeRef: null
  }], [], 'Enables or disables async call stacks tracking.'),e.registerCommand('Runtime.setCustomObjectFormatterEnabled', [{
    name: 'enabled',
    type: 'boolean',
    optional: !1,
    description: '',
    typeRef: null
  }], [], ''),e.registerCommand('Runtime.setMaxCallStackSizeToCapture', [{
    name: 'size',
    type: 'number',
    optional: !1,
    description: '',
    typeRef: null
  }], [], ''),e.registerCommand('Runtime.terminateExecution', [], [], 'Terminate current or next JavaScript execution. Will cancel the termination when the outer-most script execution ends.'),e.registerCommand('Runtime.addBinding', [{
    name: 'name',
    type: 'string',
    optional: !1,
    description: '',
    ...
    type: 'string',
    optional: !0,
    description: 'If specified, the binding is exposed to the executionContext with matching name, even for contexts created after the binding is added. See also `ExecutionContext.name` and `worldName` parameter to `Page.addScriptToEvaluateOnNewDocument`. This parameter is mutually exclusive with `executionContextId`.',
    typeRef: null
  }], [], 'If executionContextId is empty, adds binding with the given name on the global objects of all inspected contexts, including those created later, bindings survive reloads. Binding function takes exactly one argument, this argument should be string, in case of any other input, function throws an exception. Each binding function call produces Runtime.bindingCalled notification.'),e.registerCommand('Runtime.removeBinding', [{
    name: 'name',
    type: 'string',
    optional: !1,
    description: '',
    typeRef: null
  }], [], 'This method does not remove binding function from global object but unsubscribes current runtime agent from Runtime.bindingCalled notifications.'),e.registerCommand('Runtime.getExceptionDetails', [{
    name: 'errorObjectId',
    type: 'string',
    optional: !1,
    description: 'The error object for which to resolve the exception details.',
    typeRef: 'Runtime.RemoteObjectId'
  }], ['exceptionDetails'], 'This method tries to lookup and populate exception details for a JavaScript Error object. Note that the stackTrace portion of the resulting exceptionDetails will only be populated if the Runtime domain was enabled at the time when the Error was thrown.'),e.registerType('Runtime.SerializationOptions', [{
    name: 'serialization',
    type: 'string',
    optional: !1,
    description: '',
    ...
    typeRef: null
  }]),e.registerType('Runtime.RemoteObject', [{
    name: 'type',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Runtime.UnserializableValue'
  }, {
    name: 'description',
    type: 'string',
    optional: !0,
    ...
    typeRef: 'Runtime.DeepSerializedValue'
  }, {
    name: 'objectId',
    type: 'string',
    optional: !0,
    ...
    typeRef: 'Runtime.ObjectPreview'
  }, {
    name: 'customPreview',
    type: 'object',
    optional: !0,
    description: '',
    typeRef: 'Runtime.CustomPreview'
  }]),e.registerType('Runtime.CustomPreview', [{
    name: 'header',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Runtime.RemoteObjectId'
  }]),e.registerType('Runtime.ObjectPreview', [{
    name: 'type',
    type: 'string',
    optional: !1,
    description: 'Object type.',
    ...
    typeRef: 'Runtime.PropertyPreview'
  }, {
    name: 'entries',
    type: 'array',
    optional: !0,
    description: 'List of the entries. Specified for `map` and `set` subtype values only.',
    typeRef: 'Runtime.EntryPreview'
  }]),e.registerType('Runtime.PropertyPreview', [{
    name: 'name',
    type: 'string',
    optional: !1,
    ...
    description: 'Object subtype hint. Specified for `object` type values only.',
    typeRef: null
  }]),e.registerType('Runtime.EntryPreview', [{
    name: 'key',
    type: 'object',
    optional: !0,
    ...
    typeRef: 'Runtime.ObjectPreview'
  }]),e.registerType('Runtime.PropertyDescriptor', [{
    name: 'name',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Runtime.RemoteObject'
  }]),e.registerType('Runtime.InternalPropertyDescriptor', [{
    name: 'name',
    type: 'string',
    optional: !1,
    ...
    description: 'The value associated with the property.',
    typeRef: 'Runtime.RemoteObject'
  }]),e.registerType('Runtime.PrivatePropertyDescriptor', [{
    name: 'name',
    type: 'string',
    optional: !1,
    ...
    typeRef: 'Runtime.RemoteObject'
  }]),e.registerType('Runtime.CallArgument', [{
    name: 'value',
    type: 'any',
    optional: !0,
    ...
    typeRef: 'Runtime.RemoteObjectId'
  }]),e.registerType('Runtime.ExecutionContextDescription', [{
    name: 'id',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Runtime.ExceptionDetails', [{
    name: 'exceptionId',
    type: 'number',
    optional: !1,
    ...
    typeRef: null
  }]),e.registerType('Runtime.CallFrame', [{
    name: 'functionName',
    type: 'string',
    optional: !1,
    description: 'JavaScript function name.',
    ...
    typeRef: null
  }]),e.registerType('Runtime.StackTrace', [{
    name: 'description',
    type: 'string',
    optional: !0,
    ...
    description: 'Asynchronous JavaScript stack trace that preceded this stack, if available.',
    typeRef: 'Runtime.StackTraceId'
  }]),e.registerType('Runtime.StackTraceId', [{
    name: 'id',
    type: 'string',
    optional: !1,
    description: '',
    ...
    description: '',
    typeRef: 'Runtime.UniqueDebuggerId'
  }]),e.registerCommand('Schema.getDomains', [], ['domains'], 'Returns supported domains.'),e.registerType('Schema.Domain', [{
    name: 'name',
    type: 'string',
    optional: !1,
    description: 'Domain name.',
    typeRef: null
  }, { name: 'version', type: 'string', optional: !1, description: 'Domain version.', typeRef: null }])
}(f);
export { h as InspectorBackend, i as NodeURL };
